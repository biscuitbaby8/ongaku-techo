...
export const termArticles = {
  ...
  'bebung': {
    ...
    sections: [
      {
        heading: 'なぜクラヴィコードだけなのか',
        body: 'クラヴィコードでは、鍵を押すとタンジェントと呼ばれる金属片が弦を突き上げ、そのまま弦に接触し続けます。音が鳴っているあいだ、奏者の指と弦が機械的につながったままです。したがって鍵を押す圧力を変えると弦の張力が変わり、音の高さが動きます。この上下動がビブラートになります。ピアノやチェンバロでは、発音した瞬間に打弦機構や爪が弦から離れるため、鍵を押し続けても音に影響を与えられません。',
      },
      {
        heading: '記譜',
        body: '音符の上に点を横に並べた記号で示されます。点の数が揺れの回数の目安になることもありますが、厳密な指定ではありません。同じ楽器の奏法として、鍵の圧力を保って音を持続させる Tragen der Töne（音を運ぶ）という技法もあり、こちらは揺らさずに保ちます。',
      },
      {
        heading: '音量との関係',
        body: 'この楽器では圧力が音程だけでなく音量にも影響します。したがって bebung は音の高さと大きさが同時に揺れる現象になります。押しすぎると音程が上がりすぎて調子外れに聞こえるため、揺れの幅の制御が技術的な課題です。',
      },
      {
        heading: '楽器の位置づけ',
  ...
  'djembe': {
    lead: 'ジェンベは西アフリカの杯型の太鼓です。素手で叩き、打つ位置と手の形で明確に異なる3種類の音を出し分けます。',
    sections: [
      {
        heading: '3つの基本音',
        body: '中央を手のひら全体で叩くと低く太い音（バス）、縁に近い位置を指の付け根で叩くと中音（トーン）、縁を指先で鋭く弾くと高く抜ける音（スラップ）になります。1つの太鼓で3つの高さを出せるため、単独でも旋律的なリズムを組み立てられます。この打ち分けが奏法の中心です。',
      },
      {
        heading: '構造',
        body: '一本の木をくり抜いた杯型の胴に、動物の皮を張ります。皮はロープで締め上げて張力を調整し、これで音程を決めます。金具ではなくロープで調律するため、湿度や気温によって張り直しが必要になります。杯型で下部が開いているため、胴の中で共鳴した音が下から抜けます。',
      },
      {
        heading: 'アンサンブルの中での役割',
        body: '複数のジェンベと、ドゥンドゥンと呼ばれる円筒形の太鼓群で合奏されます。ドゥンドゥンが基本のリズムを保ち、ジェンベがその上で変化を加えたり、独奏として前に出たりします。合奏の開始や区切りを示す合図もジェンベが担うことがあります。',
      },
    ],
    confusions: [
      { term: 'Tabla', slug: 'tabla', note: '北インドの太鼓。手で打ち分けて音色を作る点が近い。' },
      { term: 'Steelpan', slug: 'steelpan', note: '旋律を奏でる打楽器。' },
    ],
  },

  'en-dehors': {
    lead: 'En dehors はフランス語で「外へ」。伴奏の中から特定の声部を浮かび上がらせることを指示します。',
    sections: [
      {
        heading: '何を求めている指示か',
        body: '複数の声部が同時に鳴っている箇所で、そのうちの一つを前に出すという指示です。多声的に書かれた鍵盤曲で、内声に旋律が隠れている場合によく置かれます。音量を上げるのが最も直接的な方法ですが、それだけではありません。',
      },
      {
        heading: '浮かび上がらせる手段',
        body: '音量を上げる以外に、その声部だけ音の立ち上がりを明確にする、わずかに長く保つ、他の声部を抑えるといった方法があります。とくに他を抑えるほうが効果的な場合が多くあります。全体の音量を上げずに差を作れるためです。ピアノでは、同じ手で複数の声部を弾くことが多く、指ごとに打鍵を変える技術が必要になります。',
      },
      {
        heading: 'フランス音楽での使用',
        body: 'フランス語で指示を書く作曲家の楽譜に現れます。多声的な織り方の中で、どの線を聴かせたいかを作曲者が明示するための語です。反対に、目立たせないことを求める en dedans（内へ）という語もあります。',
      },
    ],
    confusions: [
      { term: 'Espressivo', slug: 'espressivo', note: '表情豊かに。声部を際立たせる文脈で併記されることがある。' },
      { term: 'Marcato', slug: 'marcato', note: '際立たせる指示。en dehors は声部の選択を指す。' },
      { term: 'Divisi', slug: 'divisi', note: 'パートを分ける。声部の扱いに関わる。' },
    ],
  },

  'frappe': {
    lead: 'Frappé はフランス語で「打たれた」。フランスのリズム理論では、拍節の中で強い位置を指す語として使われます。',
    sections: [
      {
        heading: 'temps frappé と temps levé',
        body: 'フランス語のリズム理論では、小節の強い拍を temps frappé（打たれる拍）、弱い拍を temps levé（上げられる拍）と呼びます。これは指揮者の腕が下へ振り下ろされる動きと上へ上がる動きに対応しており、英語の downbeat / upbeat と同じ発想です。frappé はこの体系に属する語です。',
      },
      {
        heading: '奏法としての用法',
        body: '打つ動作そのものを指す語としても使われます。弦楽器で弓を弦に打ちつける、打楽器で鋭く叩くといった動作です。バレエ用語の frappé も、足で床を打つ動作を指しており、同じ語です。ラテン語ではなくゲルマン語系に由来する語で、英語の flap とも関連が指摘されています。',
      },
      {
        heading: '読むときの判断',
        body: 'この語が拍節上の位置を指しているのか、打つ動作を指しているのかは文脈で決まります。理論書の中なら前者、演奏指示なら後者である可能性が高くなります。',
      },
    ],
    confusions: [
      { term: 'Accento', slug: 'accento', note: 'アクセント。強調する位置を指す。' },
      { term: 'Marcato', slug: 'marcato', note: '際立たせる指示。' },
      { term: 'Martellato', slug: 'martellato', note: '槌で打つように。打つ動作を指す奏法。' },
    ],
  },

  'saltando': {
    lead: 'Saltando は「跳ねながら」。saltare（跳ぶ）の現在分詞で、弦楽器で弓を弦から跳ねさせて演奏することを指します。',
    sections: [
      {
        heading: '弓の弾力を使う',
        body: '奏者が意識的に弓を持ち上げるのではなく、弓の棒（スティック）が持つ弾力によって自然に跳ねる状態を作ります。弓を弦に軽く落とすと、弓自身の反発で跳ね返ります。この跳ね返りの周期がテンポに合うように、弓の位置と圧力を調整します。速度によって適した弓の位置が変わり、速いほど弓元寄りを使います。',
      },
      {
        heading: 'spiccato との関係',
        body: 'spiccato も弓を跳ばす奏法であり、両者は実質的に同じ技術を指します。イタリア語の語形が違うだけで、明確な区別として定まった規則はありません。フランス語では sautillé、ドイツ語では Springbogen といった語が使われ、これらのあいだの区別も文献によって異なります。',
      },
      {
        heading: '制御の難しさ',
        body: '弓の弾力に任せる奏法であるため、力を入れると跳ねが止まります。腕で跳ばそうとすると音が不揃いになり、逆に脱力しすぎると弓が制御を離れます。弓のどの位置を使うかと、腕の重さをどれだけ預けるかの組み合わせで決まります。',
      },
    ],
    confusions: [
      { term: 'Spiccato', slug: 'spiccato', note: '弓を跳ばす奏法。実質的に同じ技術。' },
      { term: 'Volante', slug: 'volante', note: '飛ぶように。跳ねる奏法の一種。' },
      { term: 'Staccato', slug: 'staccato', note: '音を切る指示。跳ばすかどうかは指定していない。' },
    ],
  },

  'volante': {
    lead: 'Volante は「飛ぶように」。volare（飛ぶ）の現在分詞で、軽やかさを求める表情の指示であると同時に、弦楽器の特定の弓の使い方も指します。',
    sections: [
      {
        heading: '表情の指示として',
        body: '重さを感じさせない軽やかな動きを求めます。音量の問題ではなく、腕や弓の重さを音に乗せないことが要点です。同じ音量でも、重さが乗っているかどうかで飛んでいるように聞こえるかが決まります。',
      },
      {
        heading: '弦楽器の奏法として',
        body: 'staccato volante（飛ぶスタッカート）という形で、弓を弦から跳ねさせながら一弓で複数の音を弾く奏法を指します。弓を一方向に動かしながら、弓の弾力で連続して跳ねさせます。跳ねる周期と弓の進む速度の両方を制御する必要があります。',
      },
      {
        heading: '語源のつながり',
        body: 'ラテン語の volare（飛ぶ）に由来し、英語の volatile（揮発性の、変わりやすい）も同じ語根です。原義の「飛び去る」から、留まらないという含みが共通しています。',
      },
    ],
    confusions: [
      { term: 'Saltando', slug: 'saltando', note: '跳ねながら。弓の弾力を使う点が近い。' },
      { term: 'Leggero', slug: 'leggero', note: '軽く。重さを抜く指示。' },
      { term: 'Con agilità', slug: 'con-agilità', note: '敏捷に。動きの速さが主体。' },
    ],
  },

  'singing-while-playing': {
    lead: '楽器を演奏しながら同時に声を出す技法です。楽器の音と声が干渉し、唸りを含む独特の響きが生まれます。',
    sections: [
      {
        heading: '干渉が音になる',
        body: '2つの音がわずかに異なる高さで鳴ると、その差の周波数でうなりが生じます。この技法では、楽器の音と声の関係を変えることで、うなりの速さを制御できます。同じ高さで歌えばうなりは消え、少しずらせば揺れが生まれます。単に2つの音が重なるのではなく、干渉そのものが目的です。',
      },
      {
        heading: '使われる楽器',
        body: 'フルートでは、息を送りながら声を出すことができます。トロンボーンやホルンなどの金管楽器でも用いられます。いずれも、演奏に使う息の流れの中に声を混ぜる形になります。奏者の声域と楽器の音域の関係によって、どの音程で重ねられるかが決まります。',
      },
      {
        heading: 'マルチフォニックスとの違い',
        body: 'マルチフォニックスは、楽器の管の中で複数の振動を同時に成立させることで和音を出す技法です。こちらは声という別の音源を加えるものであり、仕組みが違います。結果として複数の音が聞こえるという点だけが共通しています。',
      },
    ],
    confusions: [
      { term: 'Multiphonics', slug: 'multiphonics', note: '楽器単独で複数の音を出す技法。仕組みが違う。' },
      { term: 'Didgeridoo', slug: 'didgeridoo', note: '声を重ねる奏法が用いられる楽器。' },
    ],
  },

  'bassa': {
    lead: 'Bassa は「低い」。単独ではなく ottava bassa（低いオクターブ）の形で使われ、記された音より1オクターブ低く演奏することを示します。',
    sections: [
      {
        heading: '記譜',
        body: '8va bassa、8vb、あるいは 8 と点線で示されます。点線が続いているあいだ、その音域の音符を1オクターブ下げて読みます。点線の終わりに loco（元の位置で）と書かれることもあり、これで通常の読み方に戻ります。低音部で加線が増えるのを避けるために使われる記法です。',
      },
      {
        heading: 'なぜ必要か',
        body: 'ピアノやコントラバスなどの低音域では、五線の下に加線が何本も必要になります。加線が3本を超えると読む速度が落ちるため、記法を切り替えて五線内に収めます。音部記号を変える方法もありますが、短い区間ではオクターブ記号のほうが読みやすくなります。',
      },
      {
        heading: '対になる記法',
        body: '高いほうは ottava alta（8va）で、記された音より1オクターブ高く演奏します。2オクターブ動かす場合は 15ma を使います。15 という数字は、2オクターブが15度にあたるためです（8度＋8度で16ではなく、共有する音を1回数えるので15になります）。',
      },
    ],
    confusions: [
      { term: 'Octave', slug: 'octave', note: '1オクターブの音程。' },
      { term: 'Ledger line', slug: 'ledger-line', note: '加線。この記法で回避する対象。' },
      { term: "Coll'ottava", slug: "coll'ottava", note: 'オクターブを重ねる指示。移動ではなく追加。' },
    ],
  },

  'col-basso': {
    lead: 'Col basso は「低音部と一緒に」。そのパートが低音声部と同じ動きをすることを示す省略記法です。',
    sections: [
      {
        heading: '書き写す手間を省く記法',
        body: '同じ音型が複数のパートで重複する場合、すべてを書き出す代わりに col basso と記して低音パートを参照させます。手写譜の時代に、書き写す労力と紙を節約するために発達した記法です。同種の記法に colla parte（独奏パートに合わせて）、col canto（歌に合わせて）があります。',
      },
      {
        heading: '同じとは限らない',
        body: '参照先と完全に同じ音を弾くのか、オクターブ違いで弾くのかは、楽器の音域によって決まります。チェロとコントラバスが col basso で書かれている場合、コントラバスは記譜より1オクターブ低く鳴るため、実際には別の高さになります。楽器の移調の性質を踏まえて読む必要があります。',
      },
      {
        heading: '演奏上の注意',
        body: '参照先のパートを見ないと自分の音が分からないため、パート譜だけでは演奏できない箇所が生じます。現代の校訂譜では、参照ではなく実際の音符に書き起こされていることが多くなっています。原典に近い譜面を使う場合は、参照先を確認する作業が必要です。',
      },
    ],
    confusions: [
      { term: 'Colla parte', slug: 'colla-parte', note: '独奏パートに合わせる。同じ系統の記法。' },
      { term: 'Contrabbasso', slug: 'contrabbasso', note: 'コントラバス。記譜より1オクターブ低く鳴る。' },
      { term: 'Divisi', slug: 'divisi', note: 'パートを分ける指示。' },
    ],
  },

  'accento': {
    lead: 'Accento はイタリア語で「アクセント」。ラテン語の accentus に由来し、原義は「歌に添えられたもの」です。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の ad（〜へ）と cantus（歌）から成る accentus に由来します。これはギリシャ語の prosōidia（歌に添えるもの）を訳した語で、もともとは言葉の抑揚を指していました。言語学で使うアクセントと音楽のアクセントが同じ語なのは、この共通の起源によります。',
      },
      {
        heading: '際立たせる方法',
        body: '音量を上げるのが最も単純ですが、それだけではありません。音の立ち上がりを鋭くする、わずかに長く保つ、直前にほんのわずかな間を置くといった方法でも音は際立ちます。弱音の中で音量だけを上げると場を壊すことがあるため、他の手段を選ぶ判断が必要になります。',
      },
      {
        heading: '何のためのアクセントか',
        body: '拍節上は弱いはずの位置を強調してリズムを組み替えるものと、和声上の重要な音や旋律の頂点を示すものがあります。前者は鋭さ、後者は厚みが要ります。記号は同じでも扱いが変わります。',
      },
    ],
    confusions: [
      { term: 'Accent', slug: 'accent', note: 'アクセント記号。英語での呼び方。' },
      { term: 'Marcato', slug: 'marcato', note: '一連の音を際立たせる指示。' },
      { term: 'Frappe', slug: 'frappe', note: '打たれた。強い拍を指すフランス語。' },
    ],
  },

  'acciaccato': {
    lead: 'Acciaccato は「砕かれた、押しつぶされた」。acciaccare（押しつぶす）の過去分詞で、鋭く激しい打ち方を指します。',
    sections: [
      {
        heading: 'アッチャカトゥーラと同じ語根',
        body: '装飾音のアッチャカトゥーラ（acciaccatura）と同じ動詞から派生した語です。アッチャカトゥーラが、主要音のすぐ下（または上）の音を瞬間的に添えてすぐ離す装飾であるのに対して、acciaccato は演奏の質を指す語です。どちらも「押しつぶす」という動作の含みを共有しています。',
      },
      {
        heading: '求められる音',
        body: '押しつぶすような鋭いアタックの連続です。丸く整えた音ではなく、角のある打ち方が求められます。ただし音程やリズムが崩れると、鋭さではなく粗さになります。打鍵や弓の速度を上げて立ち上がりを鋭くしつつ、制御は保つことが要点です。',
      },
    ],
    confusions: [
      { term: 'Acciaccatura', slug: 'acciaccatura', note: '同じ語根の装飾音。' },
      { term: 'Martellato', slug: 'martellato', note: '槌で打つように。強い打ち方。' },
      { term: 'Feroce', slug: 'feroce', note: '荒々しく。角のある音を求める点で近い。' },
    ],
  },

  'articulato': {
    lead: 'Articulato は articolato の異表記です。イタリア語として正しい綴りは articolato で、意味に違いはありません。',
    sections: [
      {
        heading: '内容は articolato と同じ',
        body: '「はっきりと、明瞭に区切って」を意味し、一音一音が埋もれないように演奏することを求めます。切ることではなく、それぞれの音の始まりが聞き取れることが求められている点が要点です。詳しい説明は articolato のページにあります。',
      },
      {
        heading: '綴りの違いについて',
        body: 'ラテン語の articulus（節、関節）に由来する語で、イタリア語では o、ラテン語や英語では u が使われます。articulate（英語）、articulatio（ラテン語）と比べると、イタリア語だけが articolato と o になっていることが分かります。楽譜での表記が揺れるのは、この綴りの近さによるものと考えられます。',
      },
    ],
    confusions: [
      { term: 'Articolato', slug: 'articolato', note: 'イタリア語として正しい綴り。詳しい説明はこちら。' },
      { term: 'Articolazione', slug: 'articolazione', note: 'アーティキュレーション。同じ語根。' },
    ],
  },

  'ettacca': {
    lead: 'Ettacca は attacca の異表記です。正しい綴りは attacca で、次の楽章や部分へ切れ目なく続けることを示します。',
    sections: [
      {
        heading: '内容は attacca と同じ',
        body: '楽章の終わりに置かれ、間を置かずに次へ進むことを指示します。通常は楽章間に休止が入りますが、この指示があるところでは音楽が連続します。詳しい説明は attacca のページにあります。',
      },
      {
        heading: '演奏上の要点',
        body: '切れ目なく続けるということは、前の楽章の終わりを完全には閉じないということです。終止の和音を鳴らしきってしまうと、そこで音楽が完結し、続けても別の曲が始まったように聞こえます。緊張を残したまま次へ渡すことが求められます。指揮者やアンサンブルでは、腕を下ろさないなどの動作で連続を示します。',
      },
    ],
    confusions: [
      { term: 'Attacca', slug: 'attacca', note: '正しい綴り。詳しい説明はこちら。' },
      { term: 'Fine', slug: 'fine', note: '曲の終わり。attacca とは逆に区切る。' },
    ],
  },

  'ben-marcato': {
    lead: 'Ben marcato は「十分に際立たせて」。marcato に、程度を強める ben を添えた形です。',
    sections: [
      {
        heading: 'ben が加えるもの',
        body: 'ben は bene（よく）の短縮形で、後に続く指示を控えめに済ませず、はっきり実行することを求めます。marcato だけなら「際立たせて」ですが、ben が付くことで「中途半端にせず十分に」という強調が加わります。molto（非常に）が量の増大を示すのに対して、ben は完全性を示す語です。',
      },
      {
        heading: '際立たせる対象',
        body: 'marcato は一連の音を一つずつ際立たせる指示です。したがって ben marcato が書かれた区間では、その全体にわたって各音が輪郭を持つ必要があります。一部だけ強くして残りを流すと、指示に応えたことになりません。音量ではなく輪郭の問題であるため、弱音の中でも成立します。',
      },
      {
        heading: '対位法的な箇所での使用',
        body: '複数の声部が絡む箇所で、特定の声部にこの指示が置かれることがあります。この場合は、その声部の各音が他の声部に埋もれないようにするという意味になります。音量を上げるより、立ち上がりを明確にするほうが効果的です。',
      },
    ],
    confusions: [
      { term: 'Marcato', slug: 'marcato', note: '際立たせて。ben はその程度を強める。' },
      { term: 'Ben', slug: 'ben', note: '十分に。程度を強める語。' },
      { term: 'Accento', slug: 'accento', note: 'アクセント。一音ごとの強調。' },
    ],
  },

  'legato-sempre': {
    lead: 'Legato sempre は「常にレガートで」。レガートの指示に sempre（常に）を添え、その状態を継続することを求めます。',
    sections: [
      {
        heading: 'sempre が加えるもの',
        body: 'sempre がない legato は、その箇所やそのフレーズに対する指示として読まれ、範囲が曖昧になりがちです。sempre を添えることで、次に別の指示が出るまでレガートを保ち続けることが明示されます。演奏者が途中で忘れたり、難所で切れたりすることを防ぐための念押しでもあります。',
      },
      {
        heading: '保ち続けることの難しさ',
        body: '長い区間でレガートを保つには、跳躍や指の交差といった困難な箇所でも切れ目を作らないことが必要です。実際には、こうした箇所でつながりが失われやすくなります。運指をあらかじめ設計し、どこでどう手を移動させるかを決めておくことが、この指示に応える方法です。',
      },
      {
        heading: '同じ形の指示',
        body: 'sempre は他の語とも組み合わされます。sempre piano（常に弱く）、sempre staccato（常に切って）、sempre più（さらにいっそう）などです。いずれも状態の継続を示します。',
      },
    ],
    confusions: [
      { term: 'Legato', slug: 'legato', note: '音をつなぐ指示。' },
      { term: 'Sempre', slug: 'sempre', note: '常に。状態の継続を示す語。' },
      { term: 'Phrasing', slug: 'phrasing', note: 'フレーズのまとめ方。レガートとは別の概念。' },
    ],
  },

  'equivalente': {
    lead: 'Equivalente は「同等の、同じ価値の」。楽譜では、音価や強さをそろえることを求める指示として現れます。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の aequus（等しい）と valere（価値がある、力がある）から成ります。英語の equivalent、equal、value も同じ語根です。原義は「同じ価値を持つ」で、比較する2つのものが等しいことを述べる語です。',
      },
      {
        heading: '何をそろえるのか',
        body: '文脈によって対象が変わります。音符の長さをそろえる場合、音量をそろえる場合、複数の声部の扱いを対等にする場合などです。テンポの変更を指示する箇所で、変更前後の音価の対応を示す用法もあります（前の3連符1つが新しい拍の1つに等しい、といった指定）。何と何が等しいのかを読み取ることが要点になります。',
      },
    ],
    confusions: [
      { term: 'Tempo giusto', slug: 'tempo-giusto', note: '正確なテンポで。厳密さを求める点で近い。' },
      { term: 'Simile', slug: 'simile', note: '同様に。前と同じ扱いを続ける指示。' },
    ],
  },

  'becker': {
    lead: 'ドイツ語圏のスコアでシンバルを指す語として辞典に収録されています。ただしドイツ語でシンバルを表す標準的な語は Becken です。',
    sections: [
      {
        heading: '標準的な綴りは Becken',
        body: 'ドイツ語のスコアでシンバルは Becken と表記されます。単数形は Becken、複数形も Becken で同形です。1枚だけを撥で叩く場合と、2枚を合わせて打つ場合があり、それぞれ指定されることがあります。Becker はドイツ語では姓として一般的な語であり、楽器名としては用いられません。',
      },
      {
        heading: 'シンバルの奏法',
        body: '2枚を合わせて打つ場合、平行に打ちつけると空気が逃げずに音が詰まります。わずかにずらして擦り合わせるように打つことで、輪郭のある音が出ます。打った後に止める（ダンプする）タイミングも演奏のうちで、胸に押し当てて振動を止めます。1枚を吊るして撥で叩く場合は、撥の材質によって音色が大きく変わります。',
      },
      {
        heading: '各言語での呼び名',
        body: 'イタリア語では piatti または cinelli、フランス語では cymbales、英語では cymbals です。スコアの言語によって表記が変わるため、打楽器のパートを読むときは複数の呼び名を知っておく必要があります。',
      },
    ],
    confusions: [
      { term: 'Cimbali', slug: 'cimbali', note: 'イタリア語でシンバル。' },
      { term: 'Timpani', slug: 'timpan', note: '音程を持つ打楽器。' },
    ],
  },

  'cembalere': {
    lead: 'チェンバロのように弾くことを求める指示として辞典に収録されています。語根は cembalo（チェンバロ）です。',
    sections: [
      {
        heading: '何を模倣するのか',
        body: 'チェンバロは弦を爪ではじく楽器で、鍵を押す速さで音量を変えられません。したがって「チェンバロのように」という指示が求めるのは、音量の変化を抑え、粒のそろった均質な音で弾くことだと読めます。ペダルを使わず、音を長く保たず、装飾によって表情を作るという方向になります。',
      },
      {
        heading: 'ピアノで弾く場合',
        body: 'ピアノでこの指示に応えるには、打鍵の強さを一定に保ち、ダンパーペダルを控えることになります。減衰の長いピアノで短い響きを作るには、音を早めに離す必要があります。ただし、チェンバロの響きを完全に再現することはできないため、どこまで近づけるかは演奏者の判断になります。',
      },
      {
        heading: '表記について',
        body: 'イタリア語として一般的な語形ではなく、楽譜での使用例も限られます。同じ意味を表す指示としては、quasi cembalo（チェンバロのように）といった形が用いられることがあります。',
      },
    ],
    confusions: [
      { term: 'Clavicembalo', slug: 'clavicembalo', note: 'チェンバロ。この指示が模倣する楽器。' },
      { term: 'Harpsichord', slug: 'harpsichord', note: '同じ楽器の英語名。構造の説明はこちら。' },
      { term: 'Terraced dynamics', slug: 'terraced-dynamics', note: '段階的な強弱。この楽器の構造に由来する。' },
    ],
  },

  'gajo': {
    lead: 'Gajo は「陽気に、楽しく」。イタリア語として一般的な綴りは gaio で、j を使う表記は古い形にあたります。',
    sections: [
      {
        heading: 'j という文字',
        body: '現代の標準イタリア語のアルファベットに j は含まれません。かつては半母音の i を表すために j が使われ、gaio が gajo、gioioso が giojoso と綴られました。19世紀までの楽譜や文献にこの綴りが見られます。楽譜で j を含むイタリア語に出会ったら、i に置き換えて読めば現代の綴りになります。',
      },
      {
        heading: '語の意味',
        body: 'gaio は陽気な、快活なという意味で、フランス語の gai、英語の gay と同じ語源です。曇りのない明るさを指す語で、giocoso（遊び心のある）や brillante（輝かしい）とは違い、性格そのものの明るさを述べています。',
      },
    ],
    confusions: [
      { term: 'Giojoso', slug: 'giojoso', note: '同じく j を使う古い綴り。喜ばしいという意味。' },
      { term: 'Giocoso', slug: 'giocoso', note: '遊び心をもって。' },
      { term: 'Piacevole', slug: 'piacevole', note: '心地よく。' },
    ],
  },

  'giojoso': {
    lead: 'Giojoso は「喜ばしい、楽しい」。現代の標準的な綴りは gioioso で、j を使う表記は古い形です。',
    sections: [
      {
        heading: '語源',
        body: 'gioia（喜び）から派生した語です。gioia は古フランス語 joie を経てラテン語の gaudium（喜び）に遡ります。英語の joy、joyous、rejoice も同じ語根です。宝石を意味するイタリア語 gioiello も同じ語から来ており、喜びをもたらすものという含みを共有しています。',
      },
      {
        heading: 'j を使う古い綴り',
        body: '現代の標準イタリア語に j はありません。かつて半母音の i を表すために使われ、gioioso が giojoso と綴られました。19世紀までの楽譜に見られる表記です。',
      },
      {
        heading: 'giocoso との違い',
        body: 'giocoso は gioco（遊び）から派生し、遊び心やおどけを含みます。giojoso は gioia（喜び）から派生し、内から湧く喜びを指します。前者には冗談の要素がありますが、後者にはありません。字面が近いため混同されやすい2語です。',
      },
    ],
    confusions: [
      { term: 'Giocoso', slug: 'giocoso', note: '遊び心をもって。語源が違う。' },
      { term: 'Gajo', slug: 'gajo', note: '陽気に。同じく j を使う古い綴り。' },
    ],
  },

  'garbato': {
    lead: 'Garbato は「上品に、礼儀正しく」。garbo（品位、優雅さ）から派生した語です。',
    sections: [
      {
        heading: 'garbo という語',
        body: 'garbo は、立ち居振る舞いの美しさや礼儀正しさを指すイタリア語です。単なる美しさではなく、他者への配慮を含んだ洗練を意味します。con garbo（品よく）という形でも使われます。',
      },
      {
        heading: '演奏上の判断',
        body: '礼儀正しさが含まれる語であるため、自己主張を前に出すこととは方向が違います。過剰な表情、極端な音量、粗い打鍵を避け、整った形を保つことがこの指示に沿った扱いです。elegante が「選び抜かれた」という語源を持つのに対して、garbato は他者に対する態度という含みを持つ点が違います。',
      },
    ],
    confusions: [
      { term: 'Elegante', slug: 'elegante', note: '優雅に。「選び出す」が語源。' },
      { term: 'Grazioso', slug: 'grazioso', note: '優雅に。「恵み」が語源。' },
      { term: 'Affabile', slug: 'affabile', note: '親しみやすく。他者への態度を含む点で近い。' },
    ],
  },

  'affabile': {
    lead: 'Affabile は「親しみやすく、話しかけやすく」。ラテン語の affabilis に由来し、原義は「話しかけることができる」です。',
    sections: [
      {
        heading: '「話す」という語源',
        body: 'ラテン語の ad（〜へ）と fari（話す）から成る affabilis に由来します。fari は英語の fable（寓話）、fate（宣告されたもの）、infant（まだ話せない者）の語根でもあります。原義は「話しかけられる状態にある」で、そこから親しみやすいという意味が生じました。',
      },
      {
        heading: '演奏上の判断',
        body: '語源が「話す」であることから、この指示は聴き手に語りかける方向を持ちます。壁を作らず、近い距離で伝えるという性質です。音量を大きくして遠くへ届けるのではなく、抑えて近くで話すような扱いが語に合います。',
      },
    ],
    confusions: [
      { term: 'Amabile', slug: 'amabile', note: '愛らしく。好ましく感じられる状態。' },
      { term: 'Garbato', slug: 'garbato', note: '上品に。他者への配慮を含む。' },
      { term: 'Parlante', slug: 'parlante', note: '語るように。話すことを直接指す。' },
    ],
  },

  'parlante': {
    lead: 'Parlante は「語るように」。parlare（話す）の現在分詞で、旋律を歌としてではなく言葉として扱うことを求めます。',
    sections: [
      {
        heading: '歌うことと語ることの違い',
        body: '歌では音の長さと高さが旋律線を作り、それ自体が形を持ちます。語りでは、言葉の意味に応じて強弱と間が変わり、拍は均等になりません。この指示は後者を求めます。したがって、拍を正確に刻むより、重要な音に重みを置き、句の区切りで間を取る扱いになります。cantabile とは反対方向の指示です。',
      },
      {
        heading: '声楽での用法',
        body: 'オペラでは、旋律的に歌うのではなく言葉を明瞭に伝える歌い方を指します。レチタティーヴォほど自由ではなく、拍節の枠は保ちながら、言葉の運びを優先する中間的な様式です。parlando という現在分詞形も同じ意味で使われます。',
      },
      {
        heading: '器楽での読み替え',
        body: '器楽曲にこの指示がある場合、その旋律を言葉として扱うことが示唆されています。各音を音節のように独立させ、フレーズを文として区切ります。レガートでつなぐより、articolato に近い扱いになります。',
      },
    ],
    confusions: [
      { term: 'Parlando', slug: 'parlando', note: '話すように。同じ語根の現在分詞。' },
      { term: 'Cantabile', slug: 'cantabile', note: '歌うように。parlante と対になる。' },
  ...
  'giusto': {
    lead: 'Giusto は「正確な、適切な」。ラテン語の iustus（正しい）に由来し、行き過ぎを戒める語です。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の ius（法、権利）から派生した iustus に由来します。英語の just、justice、adjust も同じ語根です。原義は「法にかなった」で、そこから正確な、適切なという意味が生じました。恣意的でないこと、基準に合っていることを述べる語です。',
      },
      {
        heading: 'tempo giusto として',
        body: '最もよく見るのは tempo giusto という形です。厳格に一定のテンポを保つという意味と、その曲にふさわしい適切なテンポという意味の両方で用いられてきました。前者は rubato の反対、後者は速度の指定にあたり、内容が異なります。どちらの意味かは文脈で判断することになり、この語の解釈は一義的に定まっていません。',
      },
      {
        heading: '単独での用法',
        body: '他の語に添えて、その指示を行き過ぎない範囲に収めることを求める用法もあります。表現を抑制する方向の語であり、自由さを求める a piacere や rubato とは反対の位置にあります。',
      },
    ],
    confusions: [
  ...
  'sempre': {
    lead: 'Sempre は「常に」。単独では意味を持たず、他の指示に添えてその状態の継続を示します。',
    sections: [
      {
        heading: '範囲を明示する語',
        body: '指示は、どこまで効力を持つかが曖昧になりがちです。sempre を添えることで、次に別の指示が出るまでその状態を保つことが明示されます。sempre legato（常につないで）、sempre piano（常に弱く）、sempre staccato（常に切って）といった形で使われます。',
      },
      {
        heading: '「さらに」という用法',
        body: 'sempre più（ますます）、sempre meno（ますます少なく）という形では、継続ではなく変化の進行を示します。sempre più forte なら、強くなり続けるという意味です。この場合の sempre は「絶えず」であり、状態ではなく変化が続くことを述べています。同じ語が2つの働きを持つため、後に続く語で判断します。',
      },
      {
        heading: '語源',
        body: 'ラテン語の semper（常に）に由来します。英語の sempiternal（永遠の）も同じ語根です。',
      },
    ],
    confusions: [
      { term: 'Legato sempre', slug: 'legato-sempre', note: '常にレガートで。この語を用いた指示。' },
      { term: 'Simile', slug: 'simile', note: '同様に。前と同じ扱いを続ける。' },
      { term: 'Poco a poco', slug: 'poco-a-poco', note: '少しずつ。変化の速さを指す。' },
    ],
  },

  'sotto': {
    lead: 'Sotto は「〜の下に」。単独ではなく、他の語と組み合わせて使われる前置詞です。',
    sections: [
      {
        heading: '組み合わせの例',
        body: 'sotto voce（声の下で＝押し殺した声で）が最もよく見る形です。ほかに sotto piano（piano の下＝さらに抑えた弱音）があります。いずれも「本来の状態より下に抑える」という構造を持ちます。',
      },
      {
        heading: '語源',
        body: 'ラテン語の subtus（下に）に由来し、英語の接頭辞 sub- と同じ語根です。物理的な位置の下という原義から、程度が低い、抑えられているという意味へ広がりました。美術用語の sotto in su（下から見上げる構図）も同じ語です。',
      },
      {
        heading: '「小さく」ではない',
        body: 'sotto を使った指示は、音量の段階を示す記号とは違います。sotto voce は音量を指定しているのではなく、押し殺した声という質を指しています。したがって、音量を落としても普通の発声のままなら、この指示に応えていないことになります。',
      },
    ],
    confusions: [
      { term: 'Sotto voce', slug: 'sotto-voce', note: '押し殺した声で。最も一般的な組み合わせ。' },
      { term: 'Sotto piano', slug: 'sotto-piano', note: 'piano より抑えた弱音。' },
      { term: 'Mezzo voce', slug: 'mezzo-voce', note: '半分の声で。抑制の度合いが違う。' },
    ],
  },

  'libero': {
    lead: 'Libero は「自由に」。規則に縛られず表現することを求めますが、何をしてもよいという意味ではありません。',
    sections: [
      {
        heading: '何から自由なのか',
        body: 'この指示が解放しているのは、多くの場合テンポの厳密さです。拍を均等に刻むことから離れ、旋律の要求に応じて伸縮させます。ただし、和声の構造や書かれた音符そのものが自由になるわけではありません。何が自由で何がそうでないかを区別することが、この指示を読む要点です。',
      },
      {
        heading: '自由には設計が要る',
        body: '決めずに弾くと、自由ではなく散漫になります。どこで伸ばし、どこで詰め、どこへ向かうかを演奏者が決めることが求められているのであり、判断を放棄することではありません。作曲者が指示を手放した分、演奏者が引き受ける責任が増えます。',
      },
      {
        heading: '近い指示',
        body: 'a piacere（好きなように）、ad libitum（意のままに）、senza tempo（テンポなしで）が同じ方向の指示です。rubato はテンポの揺れを指しますが、こちらは奪った時間をどこかで返すという含みがあり、libero より枠が残ります。',
      },
    ],
    confusions: [
      { term: 'A piacere', slug: 'a-piacere', note: '奏者の自由に。近い指示。' },
      { term: 'Rubato', slug: 'rubato', note: 'テンポを揺らす。時間を返す含みがある。' },
      { term: 'Tempo giusto', slug: 'tempo-giusto', note: '正確なテンポで。libero と反対方向。' },
    ],
  },

  'lontano': {
    lead: 'Lontano は「遠くから」。音量を下げるだけでなく、距離があるように聞かせることを求めます。',
    sections: [
      {
        heading: '距離は音量だけでは作れない',
        body: '遠くの音は、小さいだけでなく、高い倍音が失われて輪郭がぼやけます。空気を長く通るあいだに高い周波数から減衰するためです。したがって単に弱く弾くだけでは、近くで小さく鳴っているように聞こえます。音の立ち上がりを鈍らせ、輪郭を柔らげることで距離が生まれます。',
      },
      {
        heading: '楽器ごとの手段',
        body: '弦楽器では弓を指板寄りで弾く（sul tasto）ことで倍音が減り、遠くの響きに近づきます。管楽器では弱音器を使う、息の速度を落とすといった方法があります。ピアノではペダルで輪郭をぼかし、打鍵の立ち上がりを穏やかにします。いずれも音量とは別の操作です。',
      },
      {
        heading: '舞台外での演奏',
        body: '実際に演奏者を舞台の外に配置する指示が書かれることもあります。この場合は物理的に距離が生じるため、演奏者は通常どおり吹く（弾く）ことになります。楽譜に「舞台裏で」といった指示があるかどうかを確認する必要があります。',
      },
    ],
    confusions: [
      { term: 'Sul tasto', slug: 'sul-tasto', note: '指板寄りで弾く。倍音が減り遠い響きになる。' },
  ...
  'patetico': {
    lead: 'Patetico は「悲愴な、感情を揺さぶる」。ギリシャ語の pathos に由来し、原義は「受けること、経験すること」です。',
    sections: [
      {
        heading: 'pathos という語',
        body: 'ギリシャ語の paskhein（受ける、被る）から派生した pathos に由来します。原義は能動的に何かをすることではなく、外から受ける経験や苦しみです。英語の pathetic、sympathy（ともに受ける）、passion も同じ語根に連なります。したがってこの語が指すのは、自ら作り出す感情ではなく、襲ってくるものに耐えている状態です。',
      },
      {
        heading: 'ベートーヴェンの《悲愴》',
        body: 'ピアノソナタ第8番 ハ短調 作品13 は、出版時に《Grande Sonate pathétique》という題が付されています。この題は作曲者自身が認めたものとして伝えられています。チャイコフスキーの交響曲第6番も《Pathétique》の副題で知られています。いずれも、悲しみというより深い苦悩と激情を伴う作品です。',
      },
      {
        heading: '演奏上の判断',
  ...
  'spianato': {
    lead: 'Spianato は「平らにされた、なめらかな」。spianare（平らにする）の過去分詞です。',
    sections: [
      {
        heading: '「平らにする」という語源',
        body: 'piano（平らな）に接頭辞 s- が付いた動詞 spianare の過去分詞です。piano は音量記号としても使われますが、原義は「平らな」であり、そこから「静かな」という意味が生じました。spianato は、その原義のほうを受け継いでいます。凹凸がなく、起伏を作らない状態を指します。',
      },
      {
        heading: 'ショパンの《アンダンテ・スピアナート》',
        body: 'ショパンの《アンダンテ・スピアナートと華麗な大ポロネーズ》作品22 は、この語を題に用いた作品として知られています。前半のアンダンテ・スピアナートは平穏で起伏の少ない性格を持ち、後半のポロネーズと対比されます。',
      },
      {
        heading: '演奏上の判断',
        body: '起伏を作らないことが求められるため、フレーズごとに音量を上下させると語の方向から外れます。同じ質を保ったまま進めることが要点です。ただし平坦であることと無表情であることは別で、変化を抑えたまま流れを保つ必要があります。',
      },
    ],
    confusions: [
  ...
  'incalzando': {
    lead: 'Incalzando は「せき立てて、追い込んで」。incalzare（追跡する、追い立てる）の現在分詞です。',
    sections: [
      {
        heading: '追われている状態',
        body: 'incalzare は、後ろから追い立てる、追跡するという意味の動詞です。calcare（踏む）に由来し、踏み込んで迫るという含みを持ちます。したがってこの指示は、単に速くなることではなく、後ろから押されている感覚を求めます。自ら進むのではなく、追われて進む状態です。',
      },
      {
        heading: 'stringendo との違い',
        body: 'stringendo は stringere（締める）に由来し、締めつけられて切迫する状態を指します。incalzando は追われる状態です。どちらもテンポの前進を伴いますが、前者は圧縮、後者は追跡という別のイメージを持ちます。実際の演奏上の差は大きくありませんが、語が示す性質が違います。',
      },
      {
        heading: '演奏上の要点',
        body: '追い立てられている感覚を作るには、テンポが上がるだけでなく、余裕が失われる必要があります。フレーズの区切りで取っていた間を詰め、息を継ぐ場所をなくしていくと、押されている印象になります。単に速度を上げるだけでは、この性質は出ません。',
      },
    ],
    confusions: [
      { term: 'Stringendo', slug: 'stringendo', note: '締めつけるように切迫して。' },
      { term: 'Affannato', slug: 'affannato', note: '息を切らして。追われた結果の状態。' },
      { term: 'Agitato', slug: 'agitato', note: '興奮して。落ち着きのなさ。' },
    ],
  },

  'raffrenando': {
    lead: 'Raffrenando は「抑えて、速度を落として」。freno（手綱、ブレーキ）を語根に持ち、意図的に制動をかけることを指します。',
    sections: [
      {
        heading: '「手綱を引く」という語源',
        body: 'ラテン語の frenum（馬の手綱、轡）に由来する freno から、raffrenare（抑制する、引き止める）という動詞が作られています。原義は走っている馬の手綱を引くことです。したがってこの指示は、自然に減速するのではなく、進もうとする力に抗して抑えることを表します。',
      },
      {
        heading: 'ritardando との違い',
        body: 'ritardando は「遅らせる」で、テンポが下がることそのものを指します。raffrenando は「抑える」で、前へ行こうとする力が存在していることが前提です。したがって、この指示のある箇所では、抑えているという緊張が残ります。単に遅くすると、抑制ではなく弛緩になります。',
      },
      {
        heading: '演奏上の要点',
        body: '高まった勢いに対してブレーキをかける場面で使われます。減速しながらも音の張りを保つことで、抑えている状態が伝わります。音量も同時に落とすと、抑制ではなく力尽きた印象になります。',
      },
    ],
    confusions: [
      { term: 'Ritardando', slug: 'ritardando', note: '遅らせる。テンポの低下そのもの。' },
      { term: 'Calando', slug: 'calando', note: '弱めながら遅く。力が抜けていく。' },
      { term: 'Incalzando', slug: 'incalzando', note: 'せき立てて。raffrenando と反対方向。' },
    ],
  },

  'inquieto': {
    lead: 'Inquieto は「落ち着かない、不安な」。ラテン語の quietus（静止した）に否定の接頭辞が付いた形です。',
    sections: [
      {
        heading: '「静止していない」',
        body: 'ラテン語の quies（休息、静けさ）から派生した quietus に、否定の in- が付いています。英語の quiet、quiescent、そして inquiet も同じ語根です。原義は「休んでいない、静止していない」で、動揺そのものより、落ち着けないという状態を指します。',
      },
      {
        heading: 'agitato との違い',
        body: 'agitato は agitare（揺り動かす）に由来し、外から揺さぶられている状態を指します。inquieto は静止できない状態であり、内側から落ち着きが失われています。前者は動きの激しさ、後者は安定しなさが主体です。楽譜では、不安定な和声や解決しない進行と組み合わされることがあります。',
      },
      {
        heading: '演奏上の判断',
  ...
  'affannato': {
    lead: 'Affannato は「息を切らして、苦しげに」。affanno（息切れ、苦悩）から派生した語です。',
    sections: [
      {
        heading: '呼吸の乱れ',
        body: 'affanno は、息が上がっている状態と、心配や苦悩の両方を指す語です。身体的な息切れと精神的な動揺が同じ語で結ばれています。したがってこの指示は、呼吸が乱れているような不安定さを求めます。',
      },
      {
        heading: '演奏で呼吸の乱れを作る',
        body: '息が上がっている状態では、フレーズが短く切れ、間が不規則になります。長い線を保てず、途中で区切らざるを得ない状態です。管楽器や声楽では実際の息の使い方が直接対応しますが、他の楽器でも、フレーズを短く区切り、間を不均等にすることで同じ性質を作れます。拍がわずかに前のめりになる扱いも有効です。',
      },
    ],
    confusions: [
      { term: 'Incalzando', slug: 'incalzando', note: 'せき立てて。追われた結果が息切れになる。' },
      { term: 'Agitato', slug: 'agitato', note: '興奮して。' },
      { term: 'Angoscioso', slug: 'angoscioso', note: '苦悶して。締めつけられる苦しさ。' },
    ],
  },

  'lagrimoso': {
    lead: 'Lagrimoso は「涙を流して」。lacrima（涙）から派生した語で、痛切な悲哀を求めます。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の lacrima（涙）に由来します。英語の lachrymose（涙もろい）も同じ語根です。lagrimoso のほかに lacrimoso という綴りも用いられ、どちらも同じ語です。',
      },
      {
        heading: '他の悲しみの語との違い',
        body: 'mesto は静かに沈んだ悲しみ、malinconico は原因の特定されない憂鬱、dolente は痛みを伴う悲しみを指します。lagrimoso は涙という身体の反応を語源に持つため、感情が外に現れている状態です。内に籠らせるのではなく、こぼれ出ていることが性質になります。',
      },
      {
        heading: '演奏上の判断',
        body: '涙という具体的な現象が語源にあるため、音楽の書法にもそれが反映されていることがあります。下降する2音の音型（溜め息の形）、途切れる旋律線、繰り返される短い音型などです。楽譜にそうした形があれば、それを生かすことがこの指示に応えることになります。',
      },
    ],
    confusions: [
  ...
  'piangendo': {
    lead: 'Piangendo は「泣きながら」。piangere（泣く）の現在分詞で、泣いている最中であることを示します。',
    sections: [
      {
        heading: '現在分詞であること',
        body: '現在分詞であるため、この語は泣いているという進行中の動作を指します。lagrimoso が「涙に満ちた」という状態の形容詞であるのに対して、こちらは動作そのものです。したがって、その区間を通して泣き続けている状態が求められます。',
      },
      {
        heading: '嗚咽の形',
        body: '泣くという動作には、途切れる呼吸と震えが伴います。音楽では、フレーズが続かずに短く切れる、同じ音型が繰り返される、音が震えるといった形で表されます。楽譜にそうした書法があれば、それがこの指示の実現手段になります。滑らかに歌い上げてしまうと、泣いているのではなく悲しみを美しく歌っている状態になります。',
      },
      {
        heading: '語源',
        body: 'ラテン語の plangere（打つ、嘆く）に由来します。原義は「打つ」で、古代には嘆きの表現として胸を打つ習慣があったことから、嘆くという意味が生じました。英語の plaint、complain も同じ語根です。',
      },
    ],
    confusions: [
      { term: 'Lagrimoso', slug: 'lagrimoso', note: '涙を流して。状態を指す形容詞。' },
      { term: 'Lamentoso', slug: 'lamentoso', note: '嘆き悲しんで。声に出した嘆き。' },
      { term: 'Flebile', slug: 'flebile', note: 'か細く。flere（泣く）が語源。' },
    ],
  },

  'languente': {
    lead: 'Languente は「衰えて、憧れに満ちて」。languire（衰弱する、思い焦がれる）の現在分詞です。',
    sections: [
      {
        heading: '2つの意味を持つ動詞',
        body: 'イタリア語の languire には、力が衰えるという意味と、何かを強く求めて思い焦がれるという意味があります。この2つは無関係ではなく、求めているものが得られずに衰えていくという状態でつながっています。したがってこの指示は、力が抜けていながら、なお何かへ向かっているという二重の性質を求めます。',
      },
      {
        heading: 'languido との違い',
        body: 'languido は形容詞で、気だるい状態そのものを指します。languente は現在分詞で、衰えていく過程を示します。前者は静止した状態、後者は進行中の変化です。ただし両者の使い分けが規則として定まっているわけではありません。',
      },
      {
        heading: '演奏上の判断',
        body: '力が抜けた状態を作るには、実際に支えを失うのではなく、支えたまま推進力を抜くという扱いになります。同時に「求めている」という要素があるため、完全に脱力すると語の半分が失われます。向かう方向を保ったまま力が足りていない、という状態が目標になります。',
      },
    ],
    confusions: [
      { term: 'Languido', slug: 'languido', note: '気だるく。状態を指す形容詞。' },
  ...
  'leggiadro': {
    lead: 'Leggiadro は「優雅な、愛らしい」。leggero（軽い）と語源を共有し、軽やかさと品格の両方を含みます。',
    sections: [
      {
        heading: '軽さと優雅さ',
        body: 'ラテン語の levis（軽い）に由来する系統の語です。leggero が重さのなさを指すのに対して、leggiadro には優美さ、洗練という含みが加わります。したがってこの指示は、単に軽く弾くことではなく、軽やかでありながら品を保つことを求めます。',
      },
      {
        heading: 'grazioso との違い',
        body: 'grazioso は grazia（恵み、優美さ）を語根とし、努力の跡が見えない自然な美しさを指します。leggiadro は軽さを語根に持つため、動きの軽快さが前提になります。優雅であっても重い動きは grazioso でありえますが、leggiadro ではありません。',
      },
      {
        heading: '演奏上の判断',
        body: '軽さを作るには腕や弓の重さを音に乗せないことが基本ですが、この語ではそれに加えて形を整える必要があります。速く弾き飛ばすと軽くはなっても優雅さが失われます。きびきびとした動きの中に整った形を保つことが要点です。',
      },
    ],
    confusions: [
      { term: 'Leggero', slug: 'leggero', note: '軽く。重さのなさが主体。' },
      { term: 'Grazioso', slug: 'grazioso', note: '優雅に。軽さは前提としない。' },
      { term: 'Leggierissimo', slug: 'leggierissimo', note: 'この上なく軽やかに。最上級。' },
    ],
  },

  'leggierissimo': {
    lead: 'Leggierissimo は leggero の最上級で「この上なく軽やかに」。曲の中の相対的な指示として読みます。',
    sections: [
      {
        heading: '最上級であることの意味',
        body: 'イタリア語の形容詞に -issimo が付くと最上級になります。leggiero（leggero の異形）→ leggierissimo という形です。したがってこの語が現れる箇所は、同じ曲の中に leggero の箇所があり、それより一段進んだ軽さを求めていると読めます。絶対的な基準ではなく、曲の中での位置づけです。',
      },
      {
        heading: '軽さの限界',
        body: '軽くするほど音は鳴りにくくなります。腕の重さを完全に抜くと、音が出ないか、輪郭を失います。この指示が求めているのは音が消えることではなく、重さを感じさせないまま鳴っていることです。指先の速度で発音を作り、重さは預けないという扱いになります。',
      },
      {
        heading: '綴りについて',
    ...
    confusions: [
      ...
      { term: 'Leggiadro', slug: 'leggiadro', note: '優雅に。軽さに品格が加わる。' },
      { term: 'Con leggerezza', slug: 'con-leggerezza', note: '軽やかに。名詞形を用いた指示。' },
    ],
  },

  'piacevole': {
    lead: 'Piacevole は「心地よく」。piacere（気に入る、喜ばせる）から派生した語です。',
    sections: [
      {
        heading: '聴き手の側に立つ語',
        body: 'piacere は「〜の気に入る」という意味の動詞です。したがって piacevole は、演奏者が感じることではなく、聴き手にとって心地よいという状態を指します。amabile が「愛されるにふさわしい」を意味するのと同じく、指示の向きが聴き手の側にあります。',
      },
      {
        heading: '演奏上の判断',
        body: '心地よさが目標であるため、強い主張や角のある音とは方向が違います。緊張を作らず、抵抗なく受け取れる響きを保つことが求められます。ただし、平坦にすると退屈になります。無理のない流れを保ちながら、音楽としての起伏は残すという調整が必要です。',
      },
      {
        heading: '同じ語根の指示',
        body: 'a piacere（好きなように）も同じ動詞から来ていますが、こちらは演奏者の裁量を指す語であり、内容がまったく違います。字面が近いため混同されやすい2語です。',
      },
    ],
    confusions: [
      { term: 'A piacere', slug: 'a-piacere', note: '奏者の自由に。同じ語根だが内容が違う。' },
      { term: 'Amabile', slug: 'amabile', note: '愛らしく。聴き手の側に立つ点で近い。' },
      { term: 'Dolce', slug: 'dolce', note: '甘く、柔らかく。' },
    ],
  },

  'agevole': {
    lead: 'Agevole は「楽に、軽快に」。難しいパッセージを、あたかも簡単であるかのように演奏することを求めます。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の agere（動かす、行う）に連なる語で、agile（敏捷な）と語根を共有します。原義は「動かしやすい」で、そこから容易であるという意味が生じました。英語の agile、agent、act も同じ語根です。',
      },
      {
        heading: '難しさを見せない',
        body: 'この指示が置かれるのは、多くの場合、技術的に困難な箇所です。困難であることを聴き手に感じさせないことが求められています。力みが音に出ると、頑張っていることが伝わってしまいます。透明で澄んだ音色を保つには、必要以上の力を使わない運指と、余裕のあるテンポ設定が前提になります。',
      },
      {
        heading: '演奏上の要点',
        body: '楽に聞こえるためには、実際に楽に弾ける状態を作るのが最も確実です。運指を工夫し、腕の動きを減らし、無理のない速度で弾けるところまで練習することになります。表面的に軽く弾こうとすると、音が浅くなるだけです。',
      },
    ],
    confusions: [
      { term: 'Con agilità', slug: 'con-agilità', note: '敏捷に。同じ語根。動きの速さが主体。' },
      { term: 'Leggero', slug: 'leggero', note: '軽く。重さを抜く。' },
      { term: 'Comodo', slug: 'comodo', note: '無理のない。同じく余裕を指す。' },
    ],
  },

  'sentito': {
    lead: 'Sentito は「深く感じ入った、心のこもった」。sentire（感じる）の過去分詞です。',
    sections: [
      {
        heading: '過去分詞であること',
        body: '過去分詞であるため、この語は「感じている」という進行中の動作ではなく、「感じ取られた」という状態を指します。すでに内面化されている、身についているという含みです。したがって、その場で感情を作り出すのではなく、すでにあるものが表れているという性質になります。',
      },
      {
        heading: 'espressivo との違い',
        body: 'espressivo は「表現すること」を求める外向きの指示です。sentito は感じ取られた状態を指す内向きの語です。ただし演奏上の区別は明確ではなく、いずれも音を並べるだけで終わらせないことを求める指示として機能します。何を感じるべきかは、和声、旋律の形、前後の文脈から読み取ることになります。',
      },
    ],
    confusions: [
      { term: 'Con sentimento', slug: 'con-sentimento', note: '感情をもって。同じ語根の名詞形。' },
  ...
  'sogno': {
    lead: 'Sogno は「夢」。come un sogno（夢のように）といった形で、輪郭のぼやけた幻想的な響きを求めます。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の somnium（夢）に由来し、somnus（眠り）と同じ語根です。英語の somnolent（眠気を誘う）、insomnia（不眠）も同じ語から来ています。フランス語の songe、スペイン語の sueño も同系統です。',
      },
      {
        heading: '名詞であること',
        body: 'この語は名詞であり、単独では指示になりません。come un sogno（夢のように）、quasi un sogno（夢のような）といった形で用いられます。楽譜で見たときは、前後の語と合わせて読む必要があります。',
      },
      {
        heading: '演奏上の判断',
        body: '夢の性質として、輪郭が定かでないこと、時間の感覚が曖昧なことが挙げられます。したがって、音の立ち上がりを鋭くせず、拍を明確に刻まない扱いが語に合います。ペダルや残響で輪郭をぼかすことも手段になります。ただし構造が失われると、夢ではなく単に不明瞭な演奏になります。',
      },
    ],
    confusions: [
  ...
  'solidamente': {
    lead: 'Solidamente は「堅固に、がっしりと」。揺るぎない土台を作ることを求めます。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の solidus（固い、密な、完全な）に由来します。英語の solid、solidify、そして通貨の soldier（ローマ帝国の金貨 solidus で雇われた兵士）も同じ語根です。原義は隙間なく詰まっていることで、そこから堅固さという意味が生じました。',
      },
      {
        heading: '何が堅固なのか',
        body: 'この指示が求めるのは、多くの場合リズムと低音の安定です。音量ではありません。テンポが揺れず、拍の重心が定まり、低音が確実に鳴っていることで堅固さが生まれます。大きな音を出しても、拍が曖昧なら堅固には聞こえません。',
      },
      {
        heading: '演奏上の要点',
        body: '建築の骨組みを示すような扱いになるため、装飾的な表情は抑えます。テンポを揺らさず、各音の長さを正確に取り、和音の低音を十分に鳴らします。ペダルで響きを混ぜると輪郭が失われるため、控えめに扱うのが基本です。',
      },
    ],
    confusions: [
      { term: 'Pesante', slug: 'pesante', note: '重々しく。重量が主体。' },
      { term: 'Risoluto', slug: 'risoluto', note: '決然と。意志の明確さ。' },
      { term: 'Tempo giusto', slug: 'tempo-giusto', note: '正確なテンポで。安定を支える。' },
    ],
  },

  'pomposo': {
    lead: 'Pomposo は「壮麗に、儀式的に」。ラテン語の pompa（行列、儀式）に由来します。',
    sections: [
      {
        heading: '「行列」という語源',
        body: 'ギリシャ語の pompē（送ること、行列）がラテン語 pompa となり、そこから派生した語です。原義は儀式の行列であり、そこから華麗さ、荘重さという意味が生じました。英語の pomp（華麗さ）、pompous（尊大な）も同じ語です。',
      },
      {
        heading: '行列としての性格',
        body: '語源が行列であることから、この指示は歩みの性質を含みます。テンポは落ち着いており、一歩一歩に重みがあります。速く駆け抜けると、行列ではなくなります。付点リズムや堂々とした和音進行と組み合わされることが多いのは、この性格に対応しています。',
      },
      {
        heading: '誇張の要素',
        body: 'イタリア語の pomposo にも英語の pompous にも、やや大げさであるという含みがあります。控えめであることとは反対の方向であり、見せることを前提とした表現です。したがって、抑制して弾くと語の方向から外れます。',
      },
    ],
    confusions: [
  ...
  'alla-marcia': {
    lead: 'Alla marcia は「行進曲風に」。alla は「〜の様式で」を意味し、marcia（行進曲）の性格を求めます。',
    sections: [
      {
        heading: 'alla という形',
        body: 'alla は前置詞 a と定冠詞 la が縮約した形で、「〜のように、〜の様式で」を意味します。alla marcia（行進曲風に）、alla turca（トルコ風に）、alla breve（2分音符を単位として）のように、後に続く語の様式で演奏することを示します。',
      },
      {
        heading: '行進曲の性格',
        body: '行進は、実際に歩くことを前提とした音楽です。したがって拍は明確で一定であり、速度は歩ける範囲に収まります。2拍子または4拍子で書かれ、強拍がはっきり示されます。付点リズムが多用されるのは、歩みに弾みを与えるためです。',
      },
      {
        heading: '演奏上の要点',
        body: '拍が明確であることが最も重要です。テンポが揺れると歩けなくなり、行進の性格が失われます。アーティキュレーションもはっきり分け、レガートで流さないのが基本です。ただし機械的になると音楽が失われるため、各拍の重みの差は保ちます。',
      },
    ],
    confusions: [
      { term: 'Pomposo', slug: 'pomposo', note: '壮麗に。行列という語源を持つ。' },
  ...
  'alla-rustica': {
    lead: 'Alla rustica は「田舎風に」。素朴で飾らない性格を求める指示です。',
    sections: [
      {
        heading: '語源',
        body: 'ラテン語の rus（田舎、田園）から派生した rusticus に由来します。英語の rustic、rural も同じ語根です。都市の洗練に対する、素朴さや粗野さを指す語です。',
      },
      {
        heading: '田舎風の音楽的な特徴',
        body: '民俗音楽を模した書法と結びついています。持続する低音（ドローン）、五度の重音、単純な反復、素朴な旋律といった要素です。バグパイプや民俗楽器の響きを模す書法が用いられることもあります。ヴィヴァルディには《Concerto alla rustica》と呼ばれる作品があります。',
      },
      {
        heading: '演奏上の判断',
        body: '洗練を排する方向の指示ですが、技術を捨てることではありません。整えすぎない、装飾を控える、音色に少し粗さを残すといった扱いになります。過度に上品に演奏すると、語の方向から外れます。',
      },
    ],
    confusions: [
  ...
  'asperamente': {
    lead: 'Asperamente は「厳しく、荒々しく」。aspro（粗い、辛辣な）の副詞形で、あえて美しさを排することを求めます。',
    sections: [
      {
        heading: '「ざらざらした」という語源',
        body: 'ラテン語の asper（粗い、でこぼこの）に由来します。英語の asperity（辛辣さ）、exasperate（いらだたせる）も同じ語根です。原義は表面がざらついていることで、そこから厳しさ、辛辣さという意味が生じました。触覚に由来する語である点が特徴です。',
      },
      {
        heading: '意図的な粗さ',
        body: 'この指示は、演奏を整えないことを求めます。丸く美しい音ではなく、角のある音、抵抗を感じさせる音です。弦楽器では弓の圧力を強めて雑音成分を残す、ピアノでは打鍵を鋭くするといった扱いになります。ただし音程やリズムが崩れると、意図した粗さではなく単なる不正確さになります。',
      },
    ],
    confusions: [
      { term: 'Feroce', slug: 'feroce', note: '荒々しく。獣のような野生。' },
      { term: 'Barbaro', slug: 'barbaro', note: '未開の。洗練を排する。' },
      { term: 'Martellato', slug: 'martellato', note: '槌で打つように。硬い音を作る奏法。' },
    ],
  },

  'avenant': {
    lead: 'Avenant はフランス語で「感じのよい、好ましい」。楽譜では、軽やかで人を惹きつける性格を求める指示として現れます。',
    sections: [
      {
        heading: '語源',
        body: '動詞 avenir（似合う、ふさわしい）の現在分詞に由来します。ラテン語の advenire（到来する、〜になる）から来ており、英語の advent、adventure も同じ語根です。原義は「ふさわしくやって来る」で、そこから場にかなった、好ましいという意味が生じました。',
      },
      {
        heading: '押しつけない魅力',
        body: 'この語が指すのは、主張の強い魅力ではなく、抵抗なく受け入れられる好ましさです。したがって演奏では、強い表情や大きな起伏を作るより、無理のない流れを保つことが語に合います。さらっと通り過ぎながら印象を残す、という扱いになります。',
      },
    ],
    confusions: [
      { term: 'Amabile', slug: 'amabile', note: '愛らしく。好ましく感じられる状態。' },
  ...
  'pasticcio': {
    lead: 'Pasticcio はイタリア語で「パイ、練り物」。そこから転じて、寄せ集めで作られた作品を指す語になりました。',
    sections: [
      {
        heading: '料理から音楽用語へ',
        body: 'pasticcio は、さまざまな具材を混ぜて焼いたパイを指す料理の語です。中身が混ざり合っていることから、複数の出所のものを寄せ集めたものという意味が生じました。フランス語の pastiche も同じ語で、こちらは他の作家の様式を模倣した作品を指す語として美術や文学で使われます。',
      },
      {
        heading: 'オペラの様式として',
        body: '18世紀には、複数の作曲家の既存の楽曲を集めて1つのオペラに仕立てる形式が広く行われ、これを pasticcio と呼びました。人気のあるアリアを寄せ集めて上演するもので、当時の劇場の実務に根ざした形式です。作曲家の個性や作品の統一性を重んじる現代の見方とは、前提が異なります。',
      },
      {
        heading: '表現の指示として',
        body: '楽譜の指示として現れる場合は、さまざまな要素が混ざり合った、変化に富んだ性格を指します。場面が次々に切り替わる箇所で、その転換の鮮やかさが求められます。',
      },
    ],
    confusions: [
  ...
  'cis': {
    lead: 'Cis はドイツ語の音名で、C の半音上（英語の C sharp）を指します。ドイツ語の音名体系は英語と規則が違い、そこを知らないと楽譜や文献が読めません。',
    sections: [
      {
        heading: '-is と -es という語尾',
        body: 'ドイツ語では、音名に -is を付けると半音上がり、-es を付けると半音下がります。C→Cis（C♯）、D→Dis（D♯）、C→Ces（C♭）、D→Des（D♭）という具合です。母音で終わる音名では綴りが縮まり、E→Es（E♭）、A→As（A♭）になります。英語のように sharp / flat という別の語を添えるのではなく、音名そのものが変化するのが特徴です。',
      },
      {
        heading: 'H と B の入れ替わり',
        body: 'ドイツ語で最も混乱するのがここです。英語の B（シ）はドイツ語では H、英語の B♭ はドイツ語では B と呼ばれます。したがってドイツ語文献の「B」は英語の「B♭」を指します。バッハの名前 B-A-C-H を音にすると B♭・A・C・B となり、この4音がそのまま主題として使えるのは、この命名法があるためです。',
      },
      {
        heading: '重変化',
        body: '半音2つ上げる場合は -isis、2つ下げる場合は -eses を付けます。Cisis（C の重嬰）、Ceses（C の重変）です。英語の double sharp / double flat に対応します。',
      },
      {
        heading: 'どこで出会うか',
        body: 'ドイツ語圏の楽譜の調性表示、作品目録、音楽学の文献でこの体系が使われます。調名では長調が Dur、短調が Moll なので、「cis-Moll」は嬰ハ短調を指します。調名の表記では長調を大文字、短調を小文字で始める慣習があります。',
      },
    ],
    confusions: [
      { term: 'Dur', slug: 'dur', note: 'ドイツ語で長調。調名は Cis-Dur のように組み合わせる。' },
  ...
  'libretto': {
    lead: 'Libretto は「小さな本」。オペラやオラトリオなど、声楽を伴う大規模作品の台本を指します。',
    sections: [
      {
        heading: '語源',
        body: 'イタリア語の libro（本）に縮小辞 -etto が付いた形で、原義は「小冊子」です。かつて劇場で観客に配られた小型の台本冊子から、この名が付きました。歌詞と筋書きが印刷されており、上演を追うための手引きとして使われました。',
      },
      {
        heading: '台本作家という職能',
        body: '作曲者とは別に台本を書く作家がいます。モーツァルトとロレンツォ・ダ・ポンテ、ヴェルディとアッリーゴ・ボーイト、リヒャルト・シュトラウスとフーゴ・フォン・ホーフマンスタールのように、特定の組み合わせで複数の作品が生まれた例が知られています。一方、ワーグナーのように自ら台本を書いた作曲家もいます。',
      },
      {
        heading: '音楽との関係',
        body: '台本は言葉の設計であると同時に、音楽の設計でもあります。どこにアリアを置き、どこをレチタティーヴォで進めるか、どの場面に重心を置くかは、台本の構成段階で決まります。言葉の韻律が旋律の形を規定することも多く、翻訳して歌うと音楽との対応が崩れるのはこのためです。',
      },
    ],
    confusions: [
      { term: 'Opera', slug: 'opera', note: '台本を伴う舞台作品。' },
      { term: 'Aria', slug: 'aria', note: '独唱曲。台本の構成の中で置かれる。' },
      { term: 'Recitative', slug: 'recitative', note: '語るように歌う部分。筋を進める。' },
    ],
  },

  'juxtaposition': {
    lead: '並置は、性格の異なる素材を移行なしに隣り合わせに置く手法です。つなぐのではなく、ぶつけることで効果を作ります。',
    sections: [
      {
        heading: '発展との対比',
        body: '古典派のソナタ形式では、素材は変形され展開されながら次の状態へ移っていきます。これに対して並置では、素材Aの直後に素材Bが何の準備もなく現れます。移行部を持たないため、切り替わりが断層として聞こえます。',
      },
      {
        heading: '20世紀の書法として',
        body: 'ストラヴィンスキーの作品にみられるブロックの積み重ねが、この手法の代表例として論じられます。異なる調性、異なる楽器群、異なるリズムの層が切り替わりながら並べられ、その断絶自体が構造になります。',
      },
      {
        heading: '演奏上の要点',
        body: '断絶が効果である以上、つなぎを滑らかにすると意図が消えます。移行を作らず、切り替わった瞬間に音色も重心も入れ替えることが求められます。演奏の習慣として自然につなごうとする力が働くため、意識して断ち切る必要があります。',
      },
    ],
    confusions: [
      { term: 'Bruscamente', slug: 'bruscamente', note: '不意に。準備なく切り替える指示。' },
      { term: 'Development', slug: 'development', note: '展開部。素材を変形して進める書法。' },
      { term: 'Attacca', slug: 'attacca', note: '切れ目なく続ける指示。' },
    ],
  },

  'isorhythm': {
    lead: 'アイソリズムは、同じリズム型を繰り返して曲の骨格を作る中世・ルネサンス期の作曲技法です。リズムの型と旋律の型を別々の長さで繰り返す点が特徴です。',
    sections: [
      {
        heading: 'タレアとコロール',
        body: '繰り返されるリズムの型をタレア（talea、ラテン語で「切ったもの」）、繰り返される音高の並びをコロール（color、「色」）と呼びます。この2つの長さを意図的に一致させないことで、同じリズムに違う音高が乗る組み合わせが次々に生まれます。たとえばタレアが6音、コロールが4音なら、両者が再び揃うまでに12音を要します。',
      },
      {
        heading: '聞き取れるとは限らない',
        body: 'この技法は多くの場合テノール声部に適用され、長い音価で書かれます。そのため聴いてすぐ分かる反復として現れるとは限りません。楽譜を分析して初めて見える構造であることも多く、聴覚的な効果より、作品を組み立てるための枠組みとして機能しています。',
      },
      {
        heading: '歴史的な位置',
        body: '14世紀のアルス・ノヴァの時代に発達し、モテットの構成原理として用いられました。定量記譜法によってリズムを正確に書き分けられるようになったことが、この技法の前提にあります。',
      },
    ],
    confusions: [
  ...
  'forniture': {
    lead: 'オルガンのストップの一種で、1つの鍵に対して複数の高い音を同時に鳴らすものです。混合ストップ（ミクスチャー）と呼ばれる種類にあたります。',
    sections: [
      {
        heading: '倍音を人工的に足す',
        body: '1つの鍵を押すと、基音だけでなくその倍音にあたる高さのパイプが同時に鳴ります。オクターブ上、その上の完全5度、さらに上のオクターブといった具合です。自然倍音列に含まれる音を人工的に加えることで、基音の音色を明るく輝かせます。単独で使うのではなく、基礎となるストップに重ねて用いるのが通例です。',
      },
      {
        heading: 'ブレイクという仕組み',
        body: '高音域まで倍音をそのまま積み上げると、鳴らせる範囲を超えてしまいます。そのため一定の高さに達すると、鳴らす倍音の組み合わせを低いほうへ切り替えます。これをブレイクと呼びます。音階を上がっていくと音色が段階的に変わって聞こえるのは、この切り替えによるものです。',
      },
      {
        heading: '呼び名',
        body: 'フランス語では fourniture、ドイツ語では Mixtur、英語では mixture と呼ばれます。同種のストップに Scharff、Cymbel などがあり、含まれる倍音の高さや数によって区別されます。オルガンごとに構成が異なるため、同じ名前でも響きは同一ではありません。',
      },
    ],
    confusions: [
      { term: 'Organo', slug: 'organo', note: 'オルガン。このストップを備える楽器。' },
      { term: 'Harmonics', slug: 'harmonics', note: '倍音。混合ストップが人工的に加えるもの。' },
      { term: 'Copula', slug: 'copula', note: 'オルガンの鍵盤を連結する装置の語源でもある。' },
    ],
  },

  'copula': {
    lead: 'Copula はラテン語で「結びつけるもの、絆」。中世の音楽理論に現れる語で、複数の意味で用いられてきました。',
    sections: [
      {
        heading: '中世の理論用語として',
        body: '13世紀ごろの多声音楽の理論書に現れる語で、オルガヌムとディスカントゥスという2つの書法のあいだに位置づけられる部分を指すものとされてきました。ただし当時の理論家によって説明が異なり、この語が正確に何を指していたかについては解釈が分かれています。中世音楽の用語には、こうした意味が確定していないものが少なくありません。',
      },
      {
        heading: 'オルガンの用語として',
        body: '別の用法として、オルガンで複数の鍵盤やペダルを連結する装置をカプラー（英語 coupler）と呼びます。これも同じラテン語 copula に由来する語で、一方の鍵盤を弾くと他方の音も同時に鳴るようにする仕組みです。手鍵盤とペダル鍵盤を連結すれば、足で弾いた音に手鍵盤の音色が加わります。',
      },
      {
        heading: '語の広がり',
        body: '英語の couple、copulate も同じ語根です。文法用語の「繋辞（コピュラ）」も、主語と述語を結びつけるものという意味で同じ語を使っています。いずれも「結びつける」という原義から派生しています。',
      },
    ],
    confusions: [
      { term: 'Organo', slug: 'organo', note: 'オルガン。カプラーを備える楽器。' },
      { term: 'Forniture', slug: 'forniture', note: 'オルガンの混合ストップ。' },
      { term: 'Counterpoint', slug: 'counterpoint', note: '対位法。中世の多声書法から発展した。' },
    ],
  },

  'cordale': {
    lead: 'Cordale は「和音の、和声的な」を意味するイタリア語の形容詞です。corda（弦）ではなく accordo（和音）に連なる語です。',
    sections: [
      {
        heading: '和声的であること',
        body: 'ある部分が cordale であるとは、旋律的な線としてではなく、和音の積み重ねとして書かれているということです。各声部が独立した線を描く対位法的な書法に対して、和音が縦に動いていく書法を指します。合唱曲やコラールの多くがこの性質を持ちます。',
      },
      {
        heading: '演奏上の帰結',
        body: '和声的に書かれた箇所では、各声部を独立に聞かせるより、和音全体の響きを整えることが優先されます。声部間の音量のバランス、和音が変わる瞬間のそろい方が問題になります。逆に対位法的な箇所では、各声部の線を追えるように弾き分けることが求められます。同じ曲の中で書法が切り替わることがあり、その切り替えを見分けることが演奏の設計につながります。',
      },
    ],
    confusions: [
      { term: 'Chord', slug: 'chord', note: '和音そのもの。' },
      { term: 'Counterpoint', slug: 'counterpoint', note: '対位法。各声部が独立した線を描く書法。' },
      { term: 'Voicing', slug: 'voicing', note: '和音の音の配置。' },
    ],
  },

  'poi': {
    lead: 'Poi はイタリア語で「その後に」。順序を示す語で、単独ではなく他の指示と組み合わせて使われます。',
    sections: [
      {
        heading: '演奏の順序を指定する',
        body: '最もよく見るのは D.C. al Coda e poi la Coda のような形で、繰り返して戻った後にコーダへ進む順序を示します。また、rallentando poi a tempo（遅くしてから元の速さで）のように、2つの指示の時間的な前後関係を示すこともあります。',
      },
      {
        heading: '同時ではなく順次',
        body: 'この語があるということは、2つのことが同時にではなく順番に起こるという指定です。指示が並記されているだけなら同時に適用される可能性がありますが、poi があれば片方が終わってからもう片方へ移ります。演奏経路や表情の変化を読むときの手がかりになります。',
      },
    ],
    confusions: [
      { term: 'Che', slug: 'che', note: '比較や関係を示す機能語。' },
      { term: 'Coda', slug: 'coda', note: '結尾部。poi la Coda の形で現れる。' },
      { term: 'Da Capo', slug: 'da-capo', note: '冒頭へ戻る指示。poi と組み合わせて経路を作る。' },
    ],
  },

  'che': {
    lead: 'Che はイタリア語の関係詞・接続詞で、単独では音楽用語ではありません。他の語と組み合わさって指示の一部になります。',
    sections: [
      {
        heading: '比較で使われる',
        body: '最も多いのは比較の文脈です。più forte che（〜より強く）、meno mosso che prima（前より動かさずに）のように、比較の対象を導きます。英語の than にあたる働きです。この語が現れたら、何と何を比べているのかを読み取ることになります。',
      },
      {
        heading: '関係詞として',
        body: '「〜するところの」という関係詞としても使われます。楽譜の注記や演奏についての指示文の中で、文をつなぐ役割を果たします。速度標語のような定型句ではなく、作曲者が文として書き込んだ指示に現れることが多い語です。',
      },
      {
        heading: '読むときの扱い',
        body: 'この語自体には演奏上の指示内容がありません。前後の語を正しく結びつけるための手がかりとして読みます。イタリア語の楽譜指示は定型句だけでなく文として書かれることもあるため、こうした機能語を知っておくと読み取れる範囲が広がります。',
      },
    ],
    confusions: [
      { term: 'Poi', slug: 'poi', note: '「その後に」。同じく機能語として使われる。' },
      { term: 'Meno', slug: 'meno', note: '「より少なく」。che と組み合わさることがある。' },
      { term: 'Più', slug: 'più', note: '「より多く」。che と組み合わさることがある。' },
    ],
  },

  'articolazione': {
    lead: 'Articolazione はアーティキュレーションのイタリア語で、一音一音をどう切り、どうつなぐかという扱いを指します。',
    sections: [
      {
        heading: '語源は「関節」',
        body: 'ラテン語の articulus（節、関節）に由来します。骨と骨が関節で分かれているように、音の連なりに節目があることを表しています。英語の article（冠詞、条項）も同じ語根で、区切られた単位という意味を共有しています。',
      },
      {
        heading: '何を指定しているのか',
        body: 'スタッカート、テヌート、レガート、アクセント、マルカートといった記号がこれにあたります。これらが指定しているのは、音の長さ、音と音のつながり方、そして音の立ち上がりの質です。音の高さとリズムは音符が決めますが、それをどう発音するかはアーティキュレーションが決めます。',
      },
      {
        heading: 'フレージングとの違い',
        body: 'アーティキュレーションは一音単位、フレージングは句単位の扱いです。言葉に例えれば、前者が発音、後者が文の区切りと抑揚にあたります。弦楽器の楽譜のスラーは弓の使い方を示していることがあり、それが音楽的なフレーズの区切りと一致するとは限りません。',
      },
      {
        heading: '楽器による実現手段',
        body: '同じスタッカートでも、ピアノでは打鍵と離鍵、弦楽器では弓の使い方、管楽器では舌の動き、声楽では子音の扱いによって実現されます。記号は結果を指定しており、手段は楽器ごとに違います。',
      },
    ],
    confusions: [
      { term: 'Articolato', slug: 'articolato', note: 'はっきりと区切って。指示としての語形。' },
      { term: 'Phrasing', slug: 'phrasing', note: 'フレージング。句単位のまとめ方。' },
      { term: 'Staccato', slug: 'staccato', note: 'アーティキュレーションの代表的な記号。' },
      { term: 'Legato', slug: 'legato', note: '音をつなぐ指示。' },
    ],
  },

  'dissonanza': {
    lead: 'Dissonanza は「不協和」。同時に鳴った音がぶつかり、緊張を生む状態を指します。音楽を前へ進める原動力になります。',
    sections: [
      {
        heading: '不協和は欠陥ではない',
        body: 'ラテン語の dis（離れて）と sonare（響く）から成ります。振動数の比が複雑であるほど波形の重なりが不規則になり、うなりや濁りとして知覚されます。ただしこれは音楽上の欠陥ではありません。不協和が解決を求め、協和へ向かうという運動が、和声の推進力そのものです。不協和がなければ音楽は動く理由を失います。',
      },
      {
        heading: '解決という手続き',
        body: '伝統的な和声法では、不協和音は準備され、鳴らされ、解決されるという手順を踏みます。掛留音がその典型で、前の和音の音を保持して次の和音でぶつけ、その後順次進行で収まります。この手順があるため、不協和は唐突な事故ではなく、聴き手が予期し追える出来事になります。',
      },
      {
        heading: '基準は変化してきた',
        body: '何を不協和とみなすかは歴史的に変わってきました。3度が不協和として扱われた時代があり、三全音は中世に忌避された一方で、後には属七の和音の中核として使われるようになりました。20世紀以降は、解決を伴わない不協和が常態として扱われる作品も多くあります。協和・不協和は物理的な事実に基づきながら、その扱いは様式によって決まります。',
      },
    ],
    confusions: [
      { term: 'Consonante', slug: 'consonante', note: '協和。不協和と対をなす。' },
  ...
  'consonante': {
    lead: 'Consonante は「協和する」。2つ以上の音が同時に鳴ったとき、溶け合って安定して聞こえる状態を指します。',
    sections: [
      {
        heading: '協和の物理的な根拠',
        body: 'ラテン語の con（ともに）と sonare（響く）から成り、原義は「ともに響く」です。2音の振動数の比が単純な整数比であるほど、波形が規則的に重なり、濁りのない一つの響きとして聞こえます。オクターブは1対2、完全5度は2対3、完全4度は3対4、長3度は4対5です。比が単純な順に協和の度合いが高くなります。',
      },
      {
        heading: '完全協和と不完全協和',
        body: '伝統的な理論では、オクターブ・完全5度・完全4度を完全協和音程、長短3度・長短6度を不完全協和音程と分類します。前者は溶け合いが強く、後者は溶け合いながらも色を持ちます。中世には3度が不協和として扱われていた時期があり、協和とされる範囲は歴史的に変化してきました。',
      },
      {
        heading: '協和だけでは音楽にならない',
        body: '協和音のみで構成された音楽は安定しますが、動く理由を持ちません。不協和が生じて解決へ向かうという運動があって初めて、和声に方向が生まれます。協和は不協和との対比の中で機能する概念です。',
      },
    ],
    confusions: [
  ...
  'passing-tone': {
    lead: '経過音は、和音に含まれない音のうち、2つの和声音のあいだを順次進行でつなぐものです。ドからミへ動く途中のレがこれにあたります。',
    sections: [
      {
        heading: '不協和だが自然に聞こえる',
        body: '経過音はその瞬間の和音に属さないため、理屈の上では不協和です。しかし前後が順次進行でつながっており、通り過ぎる音として扱われるため、耳には自然に聞こえます。旋律をなめらかにする役割を持ち、和声を変えずに動きを作れます。',
      },
      {
        heading: '他の非和声音との違い',
        body: '非和声音にはいくつかの型があります。経過音は2つの和声音のあいだを通過するもの、刺繍音（補助音）は和声音から離れてすぐ同じ音へ戻るもの、掛留音は前の和音の音を保持して次の和音でぶつけ、その後解決するものです。倚音は跳躍して入り、順次進行で解決します。どの型かは、入り方と出方の組み合わせで判別できます。',
      },
      {
        heading: '演奏上の扱い',
        body: '経過音は通過する音なので、そこで留まると和声が濁って聞こえます。前後の和声音へ向かう途中として軽く扱うのが基本です。逆に掛留音や倚音は、不協和であること自体が表現の内容なので、そこを目立たせて解決へ向かわせます。同じ非和声音でも扱いが逆になるため、型の判別が演奏の判断に直結します。',
      },
    ],
    confusions: [
      { term: 'Appoggiatura', slug: 'appoggiatura', note: '倚音。跳躍して入り、順次で解決する。' },
  ...
  'voicing': {
    lead: '同じ和音でも、構成音をどの高さにどう配置するかで響きが変わります。この配置のことをヴォイシングと呼びます。',
    sections: [
      {
        heading: '密集と開離',
        body: '構成音を狭い範囲に詰めた配置を密集配置、広く開いた配置を開離配置と呼びます。密集させれば厚く塊のように、広く開けば澄んで見通しの良い響きになります。同じ4つの音でも、この違いだけで印象が変わります。',
      },
      {
        heading: '低音域で3度を狭く重ねない',
        body: '低い音域では倍音の間隔が詰まって聞こえるため、そこに3度を狭く重ねると濁ります。実際の書法では、低音域は広く（オクターブや5度）、高音域へ行くほど狭く配置するのが原則です。これは自然倍音列の並び方に対応しており、経験則ではなく物理に基づいた原則です。',
      },
      {
        heading: '最高音が旋律になる',
        body: '和音の中で最も高い音は、聴き手に旋律として聞こえます。したがって、和音を連ねるときに最高音がどう動くかが、そのまま旋律線になります。和声を選ぶだけでなく、上声部の動きを設計することが必要です。',
      },
      {
        heading: '楽器編成での意味',
        body: 'オーケストラでは、同じ和音を各楽器にどう割り振るかがヴォイシングにあたります。どの楽器がどの音を担当し、どの音域を使うかで、響きの色が決まります。和声の理論だけでは決まらない部分であり、編曲の中心的な作業になります。',
      },
    ],
    confusions: [
      { term: 'Chord', slug: 'chord', note: '和音そのもの。ヴォイシングはその配置。' },
  ...
  'range': {
    lead: '音域は、楽器や声が出せる最低音から最高音までの幅です。同じ楽器でも、音域によって音色や鳴りやすさが大きく変わります。',
    sections: [
      {
        heading: '幅と質は別',
        body: '音域は「出せるかどうか」の範囲を示しますが、その全域が同じように使えるわけではありません。端に近い音は音量が出にくかったり、音程が不安定になったり、音色が変わったりします。作曲や編曲では、出せる範囲ではなく、その楽器がよく鳴る範囲を知っていることが重要になります。',
      },
      {
        heading: '声域の分類',
        body: '声楽ではソプラノ、メゾソプラノ、アルト、テノール、バリトン、バスといった分類があります。これは出せる音の高さだけでなく、どの音域で最も良く響くか、声の質がどうかによっても決まります。同じ音を出せる二人が別の声種に分類されることもあります。',
      },
      {
        heading: 'テッシトゥーラという概念',
        body: '音域とは別に、その曲が主にどの高さに滞在するかを指すテッシトゥーラという語があります。最高音が同じ2つの曲でも、多くの時間を高い位置で歌う曲のほうが負担は大きくなります。歌い手にとっては、音域に収まっているかより、どこに長く留まるかのほうが重要になる場合があります。',
      },
    ],
    confusions: [
      { term: 'Register', slug: 'register', note: '音域の中の区分。音色が変わる境目。' },
  ...
  'pitch': {
    lead: '音の高さのことで、物理的には振動数（Hz）に対応します。振動数が2倍になると1オクターブ上がります。',
    sections: [
      {
        heading: '振動数と高さの関係',
        body: '弦や空気柱が1秒間に何回振動するかが振動数で、単位はヘルツです。振動数が高いほど高い音として知覚されます。この関係は比例ではなく、倍になるごとに1オクターブ上がるという対数的な関係です。440Hz の1オクターブ上は880Hz、そのまた1オクターブ上は1760Hz になります。',
      },
      {
        heading: '基準はA＝440Hzだが固定ではない',
        body: '現代の標準はA＝440Hz とされますが、オーケストラによっては442Hz や443Hz など高めに取ることもあります。時代による変化も大きく、バロック期の演奏では415Hz 前後を用いることが一般的です。これは半音ほど低い高さにあたります。古楽器による演奏で調が違って聞こえるのは、この基準の違いによるものです。',
      },
      {
        heading: '知覚は振動数だけで決まらない',
        body: '同じ振動数でも、音量や音色によって高さの感じ方がわずかに変わることが知られています。また、非常に低い音や高い音では高さの判別が難しくなります。演奏の現場では、測定器の数値と耳で聞いた印象が一致しないことがあり、最終的には合奏の中でどう聞こえるかで判断されます。',
      },
    ],
    confusions: [
  ...
  'first-inversion': {
    lead: '第1転回形は、和音の第3音を最低音に置いた形です。基本形より軽く流動的に響くため、和音が続いていく途中で使われます。',
    sections: [
      {
        heading: '構造',
        body: 'ハ長調の主和音ド・ミ・ソで、ミを最低音に置くとミ・ソ・ドになります。根音のドは上へ移り、最低音は第3音です。低音から見た音程が3度と6度になるため、数字付き低音の表記では「6」と記されます。第5音を最低音に置いた第2転回形は「6/4」です。',
      },
      {
        heading: 'なぜ低音の動きがなめらかになるのか',
        body: '基本形だけで和音を連ねると、低音が根音から根音へ跳躍します。転回形を使えば、低音を順次進行で動かせます。たとえばド・ミ・ソからファ・ラ・ドへ進むとき、後者を第1転回形（ラ・ド・ファ）にすれば、低音はドからラへ3度動くだけで済みます。バスの旋律線を整える目的で選ばれるのは、この実用上の利点があるためです。',
      },
      {
        heading: '演奏上の扱い',
        body: '転回形は経過の性格を持つため、そこで落ち着かせると流れが止まります。低音が次へ向かっていることを意識して、和音を通過点として扱うのが基本です。逆に基本形が現れた箇所は、区切りとして扱えます。',
      },
    ],
    confusions: [
      { term: 'Root position', slug: 'root-position', note: '根音を最低音に置いた形。安定する。' },
  ...
  'root-position': {
    lead: '基本形は、和音の根音が最低音に置かれた形です。最も安定して聞こえるため、曲の終止や重要な区切りで使われます。',
    sections: [
      {
        heading: 'なぜ安定して聞こえるのか',
        body: '根音を最低音に置くと、その上に3度・5度が積まれた形になります。この配置は自然倍音列の並び方に近く、低音が上の音を支える関係が明確です。転回して第3音や第5音を最低音に置くと、この支持関係が崩れ、和音が次へ動きたがるようになります。',
      },
      {
        heading: '終止での使い方',
        body: '完全終止で最も強い決着を得るには、属和音と主和音の両方が基本形である必要があります。転回形で終わると決着の力が弱まり、話が完全には閉じていない印象になります。楽曲の終わりで低音が根音に落ち着くのは、この効果を得るためです。',
      },
      {
        heading: '転回形との使い分け',
        body: '基本形は「決着」、転回形は「経過」の性格を持ちます。和音が続いていく途中では転回形を使うことで低音の動きがなめらかになり、区切りでは基本形に戻して落ち着かせます。低音の線をどう作るかが、この選択を決めます。',
      },
    ],
    confusions: [
  ...
  'augmented-chord': {
    lead: '増三和音は、長3度を2つ積み重ねた和音です。外側の音程が増5度になり、上へ広がっていくような、方向の定まらない浮遊感が生じます。',
    sections: [
      {
        heading: '構造',
        body: 'ド・ミ・ソ♯がその形です。ドとミが長3度、ミとソ♯も長3度、外側のドとソ♯が増5度になります。長三和音の第5音を半音上げた形とも言えます。完全5度の枠が半音広げられているため、内側へ収まる感覚が失われます。',
      },
      {
        heading: '等間隔であることの帰結',
        body: '長3度が2つ等間隔に積まれているため、転回しても同じ構造が保たれます。ド・ミ・ソ♯を転回するとミ・ソ♯・ド（＝ミ・ソ♯・シ♯と読み替え可能）となり、やはり増三和音です。したがってどの音を根音と見なすこともでき、根音が確定しません。これが方向の定まらない響きの理由です。減七の和音と同じ性質を、3音で持っています。',
      },
      {
        heading: '調性をあいまいにする用途',
        body: '根音が確定せず、どの調に属するかも定まらないため、この和音は調性の輪郭をぼかす効果を持ちます。19世紀後半以降の作品で、この効果を狙って多用されました。全音音階に含まれる和音でもあり、印象主義の書法とも結びついています。',
      },
    ],
    confusions: [
      { term: 'Diminished chord', slug: 'diminished-chord', note: '短3度を2つ積んだ和音。外側が減5度。' },
  ...
  'diminished-chord': {
    lead: '減三和音は、短3度を2つ積み重ねた和音です。外側の音程が減5度になるため、宙に浮いたような不安定な響きを持ちます。',
    sections: [
      {
        heading: '構造',
        body: 'ハ長調でシを根音にすればシ・レ・ファです。シとレが短3度、レとファも短3度、そして外側のシとファが減5度になります。減5度は三全音であり、この音程が和音全体の不安定さの源です。長三和音や短三和音が完全5度の枠を持つのに対して、この和音は枠が半音狭められています。',
      },
      {
        heading: 'どこに現れるか',
        body: '長音階の第7音を根音とする和音がこれにあたります。導音を含むため主和音へ向かう性質を持ち、属和音の代わりとして使えます。短調では第2音を根音とする和音も減三和音になります。',
      },
      {
        heading: '減七の和音',
        body: '減三和音にさらに短3度を積むと減七の和音になります。短3度が3つ等間隔に積み重なった形で、外側は減7度です。等間隔であるため転回しても同じ響きの構造が保たれ、どの音を根音と見なすこともできます。この性質から、複数の調へ解決できる便利な和音として、転調の橋渡しに使われます。',
      },
      {
        heading: '演奏上の扱い',
        body: 'この和音は解決を前提として書かれています。そこで音量を落としたりテンポを緩めたりすると、行き先を失って響きだけが濁ります。緊張を保ったまま次の和音へ渡すのが基本です。',
      },
    ],
    confusions: [
  ...
  'seventh-chord': {
    lead: '七の和音は、三和音にさらに3度を積み、根音から7度離れた音を加えた4音の和音です。三和音より色彩が濃くなり、次の和音へ進みたいという方向性が生まれます。',
    sections: [
      {
        heading: '構造',
        body: '根音・第3音・第5音・第7音の4音からなります。ハ長調でドを根音にすればド・ミ・ソ・シです。根音と第7音のあいだが7度離れており、この音程が不協和であるため、和音全体に解決を求める性質が生じます。三和音が安定して留まれるのに対して、七の和音は先へ進む力を持ちます。',
      },
      {
        heading: '種類',
        body: '土台となる三和音の種類と、第7音が長7度か短7度かの組み合わせで、複数の型が生じます。長三和音＋短7度が属七の和音、短三和音＋短7度が短七の和音、長三和音＋長7度が長七の和音、減三和音＋減7度が減七の和音です。それぞれ響きと使われ方が異なります。',
      },
      {
        heading: '第7音の扱い',
        body: '第7音は不協和音であるため、古典的な和声法では次の和音で下行して解決するのが原則です。属七の和音のファがミへ下がるのがその例です。この解決を意識せずに弾くと、和音が宙に浮いたまま次へ進んでしまいます。逆に20世紀以降やジャズでは、解決を伴わない七の和音が常態として使われます。',
      },
      {
        heading: 'ジャズでの位置づけ',
  ...
  'repeat-sign': {
    lead: '反復記号は、囲まれた区間をもう一度演奏することを示します。演奏前に、どこからどこへ戻るのかを必ず確認しておくべき記号です。',
    sections: [
      {
        heading: '点の向きで範囲が決まる',
        body: '複縦線に2つの点を添えた形で書かれます。点が右側にあれば繰り返しの開始、左側にあれば終了です。開始側の記号がない場合は、曲の冒頭から繰り返します。この規則を知らないと、開始位置を見失います。',
      },
      {
        heading: '1番括弧と2番括弧',
        body: '2回目に別の終わり方をする場合、1番括弧と2番括弧が併記されます。1回目は1番括弧を演奏して繰り返しへ戻り、2回目は1番括弧を飛ばして2番括弧へ進みます。括弧が3つ以上になる場合や、1番括弧の中でさらに分岐する場合もあり、複雑な楽譜では事前の確認が欠かせません。',
      },
      {
        heading: 'ダ・カーポやダル・セーニョとの併用',
        body: '反復記号に加えて D.C.（曲の冒頭へ戻る）や D.S.（セーニョ記号へ戻る）が使われる楽譜では、経路が複雑になります。一般的な慣習として、D.C. や D.S. で戻った後は反復記号を無視して進みます。ただし作曲者が明示している場合はそちらに従います。演奏経路を紙に書き出して確認するのが確実です。',
      },
      {
        heading: '繰り返しは同じでなくてよい',
        body: '記譜上は同じ音符でも、2回目を1回目と同じに演奏する必要はありません。バロック期の反復では装飾を加える慣習があり、古典派以降でも音量や音色を変えることで対比を作れます。繰り返しがあるということは、同じ素材を2度提示する機会があるということです。',
      },
    ],
    confusions: [
      { term: 'Da Capo', slug: 'da-capo', note: '曲の冒頭へ戻る指示。' },
      { term: 'Dal Segno', slug: 'dal-segno', note: 'セーニョ記号へ戻る指示。' },
      { term: 'Bis', slug: 'bis', note: '2回繰り返すことを示す語。' },
      { term: 'Coda', slug: 'coda', note: '結尾部。反復の後に進む先になる。' },
    ],
  },

  'simple-meter': {
    lead: '単純拍子は、1拍が2等分される拍子です。4分の4、4分の3、4分の2などが該当します。1拍が3等分される複合拍子と対になる概念です。',
    sections: [
      {
        heading: '分割の仕方で分ける',
        body: '拍子の分類は、1小節に何拍あるかだけでなく、1拍がどう割れるかでも決まります。4分の3拍子では1拍が4分音符で、これは8分音符2つに割れます。8分の6拍子では1拍が付点4分音符で、8分音符3つに割れます。前者が単純拍子、後者が複合拍子です。',
      },
      {
        heading: '拍子記号からの見分け方',
        body: '拍子記号の上の数字が2、3、4なら単純拍子、6、9、12なら複合拍子です。複合拍子では上の数字を3で割った数が実際の拍数になります。8分の6なら2拍、8分の9なら3拍、8分の12なら4拍です。8分の6拍子を8分音符6つの拍子として数えると、本来の拍の感じ方から外れます。',
      },
      {
        heading: '演奏上の意味',
        body: '同じ音符の並びでも、単純拍子か複合拍子かで重心の来る位置が変わります。8分の6拍子を4分の3拍子のように感じると、強拍が3か所になって別の音楽になります。拍子記号を読むことは、1小節をいくつに感じ、各拍をいくつに割るかを確認する作業です。',
      },
    ],
    confusions: [
  ...
  'quarter-rest': {
    lead: '4分休符は4分音符と同じ長さの休みです。休符は音を出さない時間ですが、音楽が止まっている時間ではありません。',
    sections: [
      {
        heading: '休符も音楽の一部',
        body: '休符の長さを正確に数えることと、その間も緊張を保つことが、リズムの精度と音楽の説得力を左右します。休符で気を抜くと、次の音の入りが遅れるだけでなく、フレーズが途切れて聞こえます。とくにフレーズの途中にある休符は、前後をつなぐ役割を持っており、そこで音楽が切れてはいけません。',
      },
      {
        heading: '記号の形',
        body: '4分休符は、稲妻のような形の記号で書かれます。この形は書き手によって崩れやすく、印刷譜と手書き譜で見た目が異なることがあります。8分休符は斜めの線に旗のような形が1つ、16分休符は2つ付きます。音符と同じく、数が増えるほど短くなります。',
      },
      {
        heading: '全休符と2分休符の見分け方',
        body: '全休符は第4線の下にぶら下がる四角、2分休符は第3線の上に乗る四角です。形が同じで位置だけが違うため、慣れないと見分けにくい記号です。「全休符は下がる、2分休符は乗る」と覚えます。なお全休符は、拍子にかかわらず1小節全体の休みを示す用法もあります。',
      },
    ],
    confusions: [
      { term: 'Quarter note', slug: 'quarter-note', note: '同じ長さの音符。' },
  ...
  'sixteenth-note': {
    lead: '16分音符は全音符の16分の1の長さで、4分の4拍子では1拍に4つ入ります。旗が2本、連桁の場合は2本の横線で示されます。',
    sections: [
      {
        heading: '本数で長さが分かる',
        body: '旗や連桁の本数が1本増えるごとに、音符の長さが半分になります。8分音符が1本、16分音符が2本、32分音符が3本です。したがって、細かい音符を読むときは本数を数えれば長さが確定します。速いパッセージでは音符の形を一つずつ判断するより、連桁の本数を見て単位を把握するほうが確実です。',
      },
      {
        heading: '粒をそろえる',
        body: '16分音符が連続する箇所では、4つの音が均等に並んでいることが求められます。実際には、拍の頭の音が強く、指の弱い部分が担当する音が弱くなりがちです。ゆっくり練習して各音の音量と長さをそろえることが、この音符の技術的な課題になります。',
      },
      {
        heading: '付点との組み合わせ',
        body: '付点8分音符＋16分音符という組み合わせは頻出します。この場合、16分音符は拍の4分の1の位置に正確に置く必要があります。16分音符を早く出しすぎると3連符のように聞こえ、遅らせすぎると複付点のリズムに近づきます。付点の音を細かい単位に分解して数えるのが確実な方法です。',
      },
    ],
    confusions: [
      { term: 'Eighth note', slug: 'eighth-note', note: '16分音符の2倍。旗が1本。' },
  ...
  'eighth-note': {
    lead: '8分音符は4分音符の半分の長さです。符幹に旗が1本付き、複数が続く場合は連桁（横線）でつないで書きます。',
    sections: [
      {
        heading: '旗と連桁',
        body: '単独で書くときは符幹の先に旗を1本付けます。複数の8分音符が続く場合は、旗の代わりに符幹の先を1本の横線（連桁）でつなぎます。連桁は見た目を整えるためだけではなく、どこまでが1拍かを示す役割を持ちます。4分の4拍子では、原則として1拍ずつ、あるいは2拍ずつまとめて連桁を掛けます。',
      },
      {
        heading: '連桁の掛け方が拍を伝える',
        body: '同じ8つの8分音符でも、連桁の掛け方が違えば拍の感じ方が変わります。4つずつ2組に掛ければ2拍子的に、3つ・3つ・2つに掛ければ別のリズムとして読めます。楽譜を読むときは、連桁がどう掛かっているかを見ることで、作曲者が意図した拍の分け方が分かります。',
      },
      {
        heading: 'イギリス式の呼び名',
        body: 'イギリスでは quaver と呼びます。「震える」という意味の語で、細かい音の連なりの印象から来ています。16分音符は semiquaver（半分の quaver）、32分音符は demisemiquaver となり、短くなるほど接頭辞が増えていきます。',
      },
    ],
    confusions: [
  ...
  'quarter-note': {
    lead: '4分音符は全音符の4分の1の長さです。黒い符頭に符幹が付いた形で、多くの曲で1拍の基準になります。',
    sections: [
      {
        heading: '拍の基準として',
        body: '4分の4、4分の3、4分の2といった拍子では、拍子記号の下の数字が4であり、4分音符が1拍の単位になります。メトロノーム記号も四分音符＝120のように、この音符を基準に書かれることが多くあります。ただしこれは慣習であり、2分の2拍子なら2分音符が、8分の6拍子なら付点4分音符が拍の単位になります。',
      },
      {
        heading: '旗を持たない最も短い音符',
        body: '4分音符には符幹がありますが、旗（はた）はありません。8分音符から旗が付き始め、16分音符では2本になります。したがって、旗があるかどうかが4分音符と8分音符以下を分ける目印になります。連桁（音符をつなぐ横線）で書かれる場合も、線の本数が旗の本数に対応します。',
      },
      {
        heading: 'イギリス式の呼び名',
        body: 'イギリスでは crotchet と呼びます。フランス語の crochet（かぎ、フック）に由来する語です。ややこしいことに、現在のフランス語で croche は8分音符を指すため、同じ語源の語が国によって別の音符を指しています。英語の文献では、この語が出てきたら4分音符と読みます。',
      },
    ],
    confusions: [
      { term: 'Half note', slug: 'half-note', note: '4分音符の2倍。' },
      { term: 'Eighth note', slug: 'eighth-note', note: '4分音符の半分。旗が1本付く。' },
      { term: 'Quarter rest', slug: 'quarter-rest', note: '4分音符と同じ長さの休み。' },
      { term: 'Time signature', slug: 'time-signature', note: '4分音符が1拍になるかを決める。' },
    ],
  },

  'half-note': {
    lead: '2分音符は全音符の半分の長さです。白い符頭に符幹（棒）が付いた形で書かれ、4分の4拍子では2拍分になります。',
    sections: [
      {
        heading: '符頭の色が長さを分ける',
        body: '2分音符までは符頭が白（中が塗られていない）、4分音符から下は黒（塗りつぶし）です。この境目が、記譜上の大きな区分になっています。白い符頭に符幹が付いていれば2分音符、符幹がなければ全音符、黒い符頭に符幹が付いていれば4分音符です。符頭の色と符幹の有無の組み合わせで、3種類が見分けられます。',
      },
      {
        heading: '符幹の向き',
        body: '符幹は、音符が五線の中央より下にあれば上向き、上にあれば下向きに書きます。中央の線上にある場合はどちらでも書けますが、前後の流れに合わせます。複数の声部が同じ五線にある場合は、声部ごとに向きを固定して書き分けます。この規則は2分音符に限らず、符幹を持つすべての音符に適用されます。',
      },
      {
        heading: 'イギリス式の呼び名',
        body: 'イギリスでは minim と呼びます。ラテン語の minima（最小の）に由来し、かつてこれが最も短い音符だった時代の名残です。現在ではさらに短い音符が多数あるため、名前と実態が合っていない語になっています。',
      },
    ],
    confusions: [
      { term: 'Whole note', slug: 'whole-note', note: '2分音符の2倍の長さ。' },
  ...
  'whole-note': {
    lead: '全音符は、現代の記譜で基準となる長い音符です。符頭だけで書かれ、符幹（棒）も旗も持ちません。4分の4拍子では4拍分になります。',
    sections: [
      {
        heading: '「全」という名前の意味',
        body: '全音符を1として、その半分が2分音符、4分の1が4分音符、8分の1が8分音符と、分数で名前が付いています。日本語と英語（whole / half / quarter / eighth）はこの分数体系を共有しています。長さの関係が名前から直接読み取れるため、計算がしやすい命名法です。',
      },
      {
        heading: 'イギリス式の呼び名',
        body: 'イギリスでは semibreve、minim、crotchet、quaver という別系統の名前を使います。これらは中世の記譜法に由来する語で、分数の関係を示していません。全音符が semibreve（半分の breve）と呼ばれるのは、かつて breve というさらに長い音符が基準だったためです。英語の文献を読むときは、どちらの体系が使われているかを確認する必要があります。',
      },
      {
        heading: '4拍とは限らない',
        body: '全音符が何拍になるかは拍子記号によって決まります。4分の4拍子なら4拍ですが、2分の2拍子なら2拍、8分の6拍子なら基準が違うため単純な対応になりません。「全音符は4拍」と覚えると拍子が変わったときに読み違えます。全音符は4分音符4つ分の長さである、と長さの関係で覚えるほうが確実です。',
      },
    ],
    confusions: [
      { term: 'Half note', slug: 'half-note', note: '全音符の半分。' },
  ...
  'bar-line': {
    lead: '小節線は五線を縦に横切って小節を区切る線です。区切りを示すだけの線に見えますが、拍の重心がどこにあるかを伝える役割を担っています。',
    sections: [
      {
        heading: '何を示している線か',
        body: '小節線の直後の拍が強拍になります。つまりこの線は、次の1拍目がここから始まるという合図です。拍子記号が決めているのは、この線がどれだけの間隔で現れるかという周期です。したがって小節線は、音楽を切り分ける線ではなく、重心の位置を示す線として読むべきものです。',
      },
      {
        heading: 'フレーズの区切りではない',
        body: '多くの曲で、フレーズは小節線をまたいで始まり、小節の途中で終わります。小節ごとに区切って演奏すると音楽が細かく分断されます。小節線を通過点として扱い、フレーズの区切りは和声と旋律の形から判断することになります。',
      },
      {
        heading: '線の種類',
        body: '通常の1本線のほかに、区切りの強さを示す複縦線（2本の細い線）、楽曲や楽章の終わりを示す終止線（細い線と太い線）、反復記号（点を伴う複縦線）があります。破線の小節線は拍節を弱める目的で、点線や部分的な線は複数の拍子が同時に進む楽譜で使われます。',
      },
      {
        heading: '臨時記号との関係',
        body: '臨時記号の効力は小節線を越えると切れます。つまり小節線は、記譜上の規則が区切られる境界でもあります。この規則を忘れると読み間違いが生じるため、実務的にも重要な線です。',
      },
    ],
    confusions: [
      { term: 'Double bar line', slug: 'double-bar-line', note: '複縦線。区切りの強さを示す。' },
      { term: 'Accidental', slug: 'accidental', note: '臨時記号。効力は小節線で切れる。' },
      { term: 'Downbeat', slug: 'downbeat', note: '小節の1拍目。小節線の直後に来る。' },
      { term: 'Time signature', slug: 'time-signature', note: '小節線が現れる周期を決める。' },
    ],
  },

  'ledger-line': {
    lead: '加線は、五線に収まらない高さの音を書くために、五線の上下に短く足す線です。線を足すことで五線を仮想的に延長しています。',
    sections: [
      {
        heading: '読みにくくなる限界',
        body: '加線は1本ずつ数えて位置を判断するため、本数が増えるほど読む時間がかかります。3本を超えると実用的な速さで読めなくなるのが一般的です。そのため実際の楽譜では、加線を増やす代わりに音部記号を変えたり、オクターブ記号を使ったりして読みやすさを保ちます。',
      },
      {
        heading: '回避する方法',
        body: '第一の方法は音部記号の変更です。チェロの高音域でテノール記号やト音記号に切り替えるのはこのためです。第二の方法はオクターブ記号（8va）で、記された音より1オクターブ上または下で演奏することを示します。ピアノの高音域や低音域では、加線を並べるより 8va を使うほうが読みやすくなります。',
      },
      {
        heading: '中央ハの位置',
        body: '大譜表では、中央ハ（C）がヘ音記号の上に1本の加線を足した位置、ト音記号の下に1本の加線を足した位置の両方で書けます。この音は2つの段のちょうど中間にあり、どちらの段に書くかは声部の流れで決まります。',
      },
    ],
    confusions: [
  ...
  'staff': {
    lead: '五線は、音楽を記すための5本の平行線です。線と線のあいだ（間）にも音符を置くため、5本の線で11の高さを表せます。',
    sections: [
      {
        heading: 'なぜ5本なのか',
        body: '線が少なければ加線が増えて読みにくくなり、多ければ何本目かを数える負担が増えます。5本は、一目で位置を判断できる限界に近い数です。中世の記譜では4本の譜表（グレゴリオ聖歌などで使われる）も用いられ、線の数は一定ではありませんでした。5本が標準として定着したのは、多声音楽で必要な音域が広がった後のことです。',
      },
      {
        heading: '線と間',
        body: '下から第1線・第2線と数え、線と線のあいだを第1間・第2間と数えます。線が5本、間が4つで9の位置があり、五線の上下に少し出た位置も加えると11程度の高さを加線なしで書けます。それを超える音には加線を使います。',
      },
      {
        heading: '音部記号が基準を決める',
        body: '五線それ自体は、どの線がどの音かを決めていません。音部記号が置かれて初めて絶対的な高さが確定します。ト音記号なら第2線が G、ヘ音記号なら第4線が F です。同じ五線でも、記号が変われば同じ位置の音符が別の高さを指します。',
      },
      {
        heading: '呼び名',
        body: '英語では staff（複数形 staves）または stave、日本語では五線または譜表と呼びます。2段の五線を組み合わせてピアノなどに使うものを大譜表（grand staff）と呼びます。',
      },
    ],
    confusions: [
      { term: 'Ledger line', slug: 'ledger-line', note: '五線に収まらない音を書くための加線。' },
      { term: 'Treble clef', slug: 'treble-clef', note: 'ト音記号。五線の基準を決める。' },
      { term: 'Bass clef', slug: 'bass-clef', note: 'ヘ音記号。' },
      { term: 'Bar line', slug: 'bar-line', note: '小節を区切る線。五線を縦に横切る。' },
    ],
  },

  'gapped-scale': {
    lead: '特定の音を抜いた音階の総称です。7音の音階から音を除いた形で、五音音階（ペンタトニック）がその代表例にあたります。',
    sections: [
      {
        heading: 'どの音を抜くか',
        body: '長音階から第4音と第7音を抜くと五音音階になります。ハ長調ならド・レ・ミ・ソ・ラです。この2音は長音階で半音の隣接を作っていた音であり、除くと音階の中に半音が一つもなくなります。結果として、どの2音を同時に鳴らしても強い不協和が生じません。',
      },
      {
        heading: 'なぜ「隙間」と呼ぶのか',
        body: 'gapped は「隙間のある」という意味です。7音が順に並んだ全音階を基準として、そこから音が抜けて隙間ができた状態を指しています。ただしこれは西洋の全音階を基準とした見方であり、五音音階を使う文化圏では、それ自体が完結した体系です。呼び名が特定の視点を含んでいる語だと知っておくと、文献を読むときに役立ちます。',
      },
      {
        heading: '演奏上の性質',
        body: '半音を含まないため、この音階の中で音を選べば大きく外れることがありません。一方で導音がないため終止の力が弱く、はっきり終わらせたい場面では音階の外の音が必要になります。',
      },
    ],
    confusions: [
      { term: 'Pentatonic scale', slug: 'pentatonic-scale', note: '五音音階。gapped scale の代表例。' },
  ...
  'parallel-keys': {
    lead: '同主調は、主音が同じ長調と短調の関係です。ハ長調とハ短調がこれにあたります。調号を共有する平行調とは別の関係なので、混同しやすい用語です。',
    sections: [
      {
        heading: '平行調との違い',
        body: '同主調は主音が同じで調号が違います（ハ長調は調号なし、ハ短調は♭3つ）。平行調は調号が同じで主音が違います（ハ長調とイ短調はどちらも調号なし）。日本語の「同主調」「平行調」、英語の parallel keys / relative keys は、それぞれ対応しています。ただしドイツ語では Parallele が平行調（relative keys）を指すため、言語をまたぐと逆になる点に注意が要ります。',
      },
      {
        heading: '転換の効果',
        body: '同主調へ移ると、主音が動かないまま明暗だけが入れ替わります。共通する音が多く、変わるのは主に第3音・第6音・第7音です。土台が動かないため、場面が切り替わったというより、同じ景色の色が変わったように聞こえます。長調の楽曲の途中で同主短調が現れる書法は、この効果を使ったものです。',
      },
      {
        heading: '演奏上の扱い',
        body: '同主調への転換は、和音の変化としては小さくても、性格の変化としては大きい箇所です。第3音が半音動くことで明暗が切り替わるため、その音の扱いが転換を伝えるかどうかを決めます。音色を変えることで、転換が起きたことが聴き手に届きます。',
      },
    ],
    confusions: [
  ...
  'minor-key': {
    lead: '短調は、主和音が短三和音になる調です。長調と違い、短音階には自然・和声・旋律の3つの形があり、曲の中でそれらが使い分けられます。',
    sections: [
      {
        heading: '3つの音階を持つ',
        body: '長調が1つの音階で成立するのに対して、短調は自然短音階・和声的短音階・旋律的短音階という3つの形を持ちます。これは、自然短音階では第7音と主音のあいだが全音離れていて導音がなく、主和音へ帰る力が弱いためです。導音を作るために第7音を半音上げたものが和声的短音階、そこで生じた広い跳躍を解消したものが旋律的短音階です。',
      },
      {
        heading: '楽譜での現れ方',
        body: '短調の曲で臨時記号のシャープが頻繁に現れるのは、多くの場合この第7音を上げているためです。イ短調の楽譜のソ♯は、作曲者の気まぐれではなく、その箇所が属和音を経由していることの表示です。調号には含まれず、必要な箇所ごとに臨時記号で書かれます。',
      },
      {
        heading: '「暗い」だけではない',
        body: '短調は憂いや悲しみと結びつけられますが、それだけの調ではありません。激しさ、緊張、劇的な展開も短調で書かれます。第6音・第7音の扱いによって響きが大きく変わるため、同じ短調の中でも表情の幅は広くなります。',
      },
    ],
    confusions: [
      { term: 'Major key', slug: 'major-key', note: '長調。主和音が長三和音になる。' },
      { term: 'Natural minor', slug: 'natural-minor', note: '自然短音階。導音を持たない。' },
  ...
  'major-key': {
    lead: '長調は、長音階を土台とし、主和音が長三和音になる調です。明るい性格と結びつけられますが、その明るさがどこから来るのかは説明できます。',
    sections: [
      {
        heading: '明るさの根拠は第3音',
        body: '主音から第3音までが長3度（半音4つ）であることが長調の条件です。ハ長調ならド・ミ・ソの主和音で、ドとミのあいだが長3度になります。この第3音を半音下げるだけで短三和音になり、同じ和音が暗く聞こえます。長調と短調を分けているのは、音階の中のこの1音です。',
      },
      {
        heading: '半音の位置',
        body: '長音階では、第3音と第4音のあいだ、第7音と主音のあいだの2か所だけが半音になります。特に第7音は主音の半音下、すなわち導音として働くため、主音へ帰る力が明確です。明るさと帰属感がはっきりしていることが、この調を西洋音楽の基本にしました。',
      },
      {
        heading: '「明るい」は文化的な結びつき',
        body: '長調が明るく、短調が暗いという対応は、西洋音楽の文脈の中で成立しているものです。物理的に長3度が明るい振動をしているわけではありません。実際、長調で書かれた葬送行進曲も、短調で書かれた快活な舞曲も存在します。作曲者が調の性格をどう使っているかは、その曲ごとに読む必要があります。',
      },
    ],
    confusions: [
      { term: 'Minor key', slug: 'minor-key', note: '短調。主和音が短三和音になる。' },
  ...
  'dur': {
    lead: 'Dur はドイツ語で「長調」。ラテン語の durus（硬い）に由来します。この語源は、♭ と ♮ という記号の形の由来にも直結しています。',
    sections: [
      {
        heading: '「硬い」と「柔らかい」',
        body: '中世の音楽理論では、B の音に高いものと低いものの2種類がありました。高いほう（現在の B♮）を b durum（硬い B）、低いほう（現在の B♭）を b molle（柔らかい B）と呼び分けます。durum はラテン語で硬い、molle は柔らかいという意味です。ここから長調を Dur、短調を Moll と呼ぶドイツ語の用語が生まれました。',
      },
      {
        heading: '記号の形の由来',
        body: 'b durum は角ばった b の字で書かれ、これが現在のナチュラル記号（♮）とシャープ記号（♯）の形になりました。b molle は丸い b の字で書かれ、これがフラット記号（♭）になりました。フラット記号が小文字の b に似ているのは偶然ではなく、実際に b の字だったためです。',
      },
      {
        heading: '調名での使い方',
        body: 'ドイツ語では音名と組み合わせて調名を作ります。C-Dur（ハ長調）、G-Dur（ト長調）、Cis-Dur（嬰ハ長調）という形です。短調は Moll を使い、c-Moll（ハ短調）のように書きます。長調は音名を大文字、短調は小文字で始める慣習があります。',
      },
      {
        heading: '英語・イタリア語との対応',
        body: '英語では major / minor、イタリア語では maggiore / minore、フランス語では majeur / mineur を使います。これらはラテン語の major（より大きい）・minor（より小さい）に由来し、3度音程の大小を指しています。ドイツ語だけが硬い・柔らかいという別の系統の語を使っている点が特徴です。',
      },
    ],
    confusions: [
  ...
  'flute': {
    lead: 'Flute（フルート）は木管楽器の一種だが、リードを持たない点でオーボエやクラリネットと大きく異なる。歌口の鋭い縁に息を吹きつけ、空気の流れそのものを振動させて音を出す。',
    sections: [
      {
        heading: '発音の仕組みはエア・リード',
        body: '歌口（アンブシュアホール）の鋭い縁に息の帯を吹き当てると、気流が縁の内側と外側に交互に剥離しながら渦を作り、振動が生まれる。これをエア・リード（air reed）と呼ぶ。リード楽器のように振動する部品が別にあるのではなく、奏者の息の角度と速さそのものが発音源になるため、音色や音程の安定は唇の使い方に大きく依存する。',
      },
      {
        heading: '現代のキー配列はベーム式',
        body: '19世紀にドイツの発明家テオバルト・ベームが、音響的に理想とされる位置に音孔を開け直し、指の届かない孔もリング・キーとロッドの機構で連動して開閉できるように設計し直した。この「ベーム式」機構により均質な音色と正確な音程が得やすくなり、以後の木管楽器全般のキー設計にも影響を与えている。',
      },
    ],
    confusions: [
      { term: 'Recorder', slug: 'recorder', note: '同じ「笛」だが発音の仕組みが違う。フルートは唇でエア・リードを作るのに対し、リコーダーはフィップル（ダクト）という固定された部品が息の向きを自動的に定める。' },
    ],
  },


  'oboe': {
    lead: 'Oboe（オーボエ）は2枚重ねのリード（ダブルリード）を振動させて音を出す木管楽器。名称はフランス語 hautbois の英語なまりで、hautbois は haut（高い）と bois（木）の合成語、直訳すると「高い木の音」。',
    sections: [
      {
        heading: '「高い木」は音域ではなく音量を指す',
        body: 'hautbois の「高い」は音の高低ではなく、当時の木管楽器の中で音量が大きく屋外でも通ったことを意味する。中世からルネサンスにかけて使われたショーム（shawm）という大型の屋外用ダブルリード楽器から発展し、室内で使えるよう改良されたのが今日のオーボエにあたる。',
      },
      {
        heading: 'ダブルリードという発音の仕組み',
        body: '2枚の薄い葦を向かい合わせに束ね、その隙間に息を吹き込むと、2枚のリードが高速で開閉を繰り返して音を作る。リードの隙間がクラリネットの単一リードより狭いため、音の芯が細く、鼻にかかったような独特の音色になる。',
      },
    ],
    confusions: [
      { term: 'Clarinet', slug: 'clarinet', note: 'クラリネットは1枚リード。オーボエは2枚のリードを振動させるダブルリード楽器で、音色の芯の細さが異なる。' },
      { term: 'Bassoon', slug: 'bassoon', note: '同じダブルリードだが、バスーンは低音域を受け持つ。' },
    ],
  },


  'clarinet': {
    lead: 'Clarinet（クラリネット）は1枚のリードをマウスピースに押し当てて振動させる木管楽器。名称はイタリア語 clarino（高音域のトランペット）の縮小形 clarinetto に由来し、「小さなクラリーノ」を意味する。',
    sections: [
      {
        heading: 'なぜトランペットの名を借りたのか',
        body: '開発初期のクラリネットは高音域でトランペットのクラリーノ奏法に似た輝かしい音を出したため、この名がついたとされる。17世紀末にドイツの楽器製作者ヨハン・クリストフ・デンナーが、シャリュモーという単一リードの民俗楽器にレジスター・キーを加えて音域を大きく広げ、独立した楽器としてのクラリネットが成立した。',
      },
      {
        heading: '単一のリードと円筒管',
        body: 'マウスピースに1枚の薄いリードを固定し、息の力でリードをマウスピースの窓に打ち付けるように振動させる。管の内径がほぼ円筒形であることも特徴で、円筒管は奇数次倍音が強く出るため、他の木管より低音域が太く、こもったような独特の音色になる。',
      },
    ],
    confusions: [
      { term: 'Oboe', slug: 'oboe', note: 'オーボエは2枚リードの円錐管。クラリネットは1枚リードの円筒管で、音色の傾向が対照的。' },
      { term: 'Saxophone', slug: 'saxophone', note: '同じ単一リードだが、サックスは金属製で円錐管。クラリネットは円筒管であることが音色の違いの主な理由。' },
    ],
  },


  'bassoon': {
    lead: 'Bassoon（バスーン）は低音域を受け持つダブルリードの木管楽器。イタリア語の呼び名 fagotto は「薪の束」を意味し、折り畳まれた管の見た目に由来する。',
    sections: [
      {
        heading: '「薪の束」という名前の由来',
        body: 'バスーンは全長がおよそ2.5メートルにもなる管を、U字に折り返してコンパクトにまとめている。この折りたたまれた管の外見が薪を束ねた姿に似ていたことから、イタリア語で fagotto（束）と呼ばれるようになったとされる。英語・フランス語では bassoon、ドイツ語では Fagott と、由来の異なる2系統の呼び名が並立している。',
      },
      {
        heading: '長い息の通り道と2枚リード',
        body: 'ダブルリードで発音する点はオーボエと同じだが、管が長い分、息の通り道（ボーカル管）を介してリードと本体をつなぐ構造になっている。低音になるほど倍音が豊かでユーモラスな音色になり、高音域では張り詰めたような緊張感のある音になる。',
      },
    ],
    confusions: [
      { term: 'Oboe', slug: 'oboe', note: '同じダブルリードだが、バスーンは低音域用に管が2倍以上長い。' },
    ],
  },


  'saxophone': {
    lead: 'Saxophone（サクソフォーン）はベルギー人アドルフ・サックスが考案した楽器で、単一リードの発音方式と円錐形の金属管を組み合わせている。',
    sections: [
      {
        heading: '木管と金管の特徴を併せ持つ',
        body: '素材は真鍮などの金属だが、発音の仕組みはクラリネットと同じ単一リード式であるため、分類上は木管楽器に含まれる。管の内径はオーボエと同様に円錐形（先に向かって太くなる）で、円錐管は偶数次倍音を含む豊かな倍音構成になりやすく、これが太く輝かしい音色を生む一因になっている。',
      },
      {
        heading: 'なぜ多くの調性がそろっているのか',
        body: 'サックスは移調楽器で、ソプラノ・アルト・テナー・バリトンなど複数の大きさが標準化されており、同じ運指のまま音域だけが変わる。この統一された運指設計により、奏者は楽器を持ち替えても指づかいを覚え直す必要がない。',
      },
    ],
    confusions: [
      { term: 'Clarinet', slug: 'clarinet', note: '発音の仕組みは同じ単一リードだが、クラリネットは木製で円筒管、サックスは金属製で円錐管という違いがある。' },
    ],
  },


  'recorder': {
    lead: 'Recorder（リコーダー）は縦に構える木管楽器で、フルートと違い奏者の唇で音を作る必要がない、フィップル（ダクト）式の笛。',
    sections: [
      {
        heading: 'フィップルが息の向きを固定する',
        body: '頭部管の中に息の通り道（ダクト）と、そこから出た息を当てるエッジ（ラビウム）があらかじめ加工されている。奏者は決まった角度で息を吹き込むだけでよく、フルートのように唇の形で音の立ち上がりを調整する必要がない。この構造は、パイプオルガンのフルー管と原理的に同じである。',
      },
      {
        heading: '名前の由来には別の意味がある',
        body: '英語の record には、かつて「（鳥のように）節をつけてさえずる、旋律を練習する」という意味があり、recorder はその名詞形にあたる。現在の「記録する」という意味とは別の、古い語義に由来する名称である。',
      },
    ],
    confusions: [
      { term: 'Flute', slug: 'flute', note: 'フルートは唇でエア・リードを作る横笛。リコーダーはフィップルが息の向きを固定する縦笛で、発音の仕組みが根本的に異なる。' },
    ],
  },


  'horn': {
    lead: 'Horn（ホルン）は円錐管を渦巻き状に巻いた金管楽器で、正式名称 French horn の通り、もとは狩猟用の角笛から発展した。',
    sections: [
      {
        heading: '手を使って音を作る楽器',
        body: 'ベルに右手を入れてふさぎ具合を変えるハンド・ストッピングという奏法は、バルブが発明される以前、自然倍音しか出せなかった時代に半音を作り出す方法だった。現在もこの奏法は残っており、手の入れ方によって音色を明るくしたり、こもらせたり（ゲシュトップフト）することができる。',
      },
      {
        heading: '円錐管が生む柔らかい音色',
        body: '管の大部分が徐々に太くなる円錐形であることが、トランペットなど円筒管の金管楽器に比べて音色が柔らかく丸みを帯びる理由になっている。ベルが後ろ向きに大きく開いているため、直接音と反射音が混ざり合い、オーケストラの中では他のどの楽器とも溶け合いやすい。',
      },
    ],
    confusions: [
      { term: 'Mute', slug: 'mute', note: 'ミュートは器具をベルに挿して音色を変える奏法。ホルンでは手だけでも同様の効果（ストップ奏法）が得られる点が独特。' },
    ],
  },


  'trumpet': {
    lead: 'Trumpet（トランペット）は金管楽器の中で最も管が細く、円筒形の管が主体の楽器。',
    sections: [
      {
        heading: '円筒管が生む鋭い音色',
        body: '管のほとんどの部分が同じ太さのまま伸びる円筒管であることが、明るく鋭い音色の主な理由になっている。円筒管は奇数次倍音が強く出やすく、これが金属的な輝きを持つ音の芯を作る。',
      },
      {
        heading: 'バルブが半音階を可能にした',
        body: 'バルブが実用化される以前のトランペット（ナチュラル・トランペット）は、管の長さを変えられず、自然倍音列にある音しか出せなかった。バルブは追加の管を経路に組み込んで管の長さを瞬時に変える仕組みで、これにより全ての半音が演奏可能になった。',
      },
    ],
    confusions: [
      { term: 'Trombone', slug: 'trombone', note: 'トロンボーンはスライドで管の長さを連続的に変える。トランペットはバルブで段階的に切り替える点が異なる。' },
    ],
  },


  'trombone': {
    lead: 'Trombone（トロンボーン）はスライドによって管の長さを連続的に変えられる金管楽器。名称はイタリア語 tromba（トランペット）の拡大形で、「大きなトランペット」を意味する。',
    sections: [
      {
        heading: '唯一無二のスライド機構',
        body: 'バルブ楽器が管の経路を段階的に切り替えるのに対し、トロンボーンは向かい合う2本の管（インナースライドとアウタースライド）を伸縮させて管の長さそのものを連続的に変化させる。これにより、音と音の間を途切れなくつなぐ真のグリッサンドが可能な、数少ない金管楽器の一つになっている。',
      },
      {
        heading: '7つのポジション',
        body: 'スライドの位置は一般に第1〜第7ポジションに分けられ、隣り合うポジション間は半音の差にあたる。同じ音でも複数のポジションで出せる場合があり、フレーズの滑らかさに応じてポジションを選ぶ。',
      },
    ],
    confusions: [
      { term: 'Euphonium', slug: 'euphonium', note: 'ユーフォニアムはバルブ式で音域が近いが、スライドによる連続的な音程変化はできない。' },
    ],
  },


  'tuba': {
    lead: 'Tuba（チューバ）は金管楽器の中で最も大きく、最も低い音域を受け持つ楽器。名称は古代ローマで使われていた直管の金属製ラッパ tuba（ラテン語で「管」）からそのまま受け継がれている。',
    sections: [
      {
        heading: '古代の名前と現代の楽器は別物',
        body: '古代ローマの tuba は長さ1メートルほどのまっすぐな金属管で、バルブも持たない信号用の楽器だった。現代のチューバはバルブ機構とともに新しく作られた楽器で、古代の tuba とは構造も音域も異なるが、低く力強い金属音という共通点から同じ名前が再利用された。',
      },
      {
        heading: '円錐管とバルブの数',
        body: '管の大部分が緩やかに広がる円錐形で、これが太く柔らかい低音を生む。低音域では自然倍音の間隔が広くなるため、バルブを追加して音域の隙間を埋める設計になっている。',
      },
    ],
    confusions: [
      { term: 'Euphonium', slug: 'euphonium', note: 'ユーフォニアムはチューバより1オクターブ高い音域を受け持つ、テノール〜バリトン域の同系統の楽器。' },
    ],
  },


  'timpani': {
    lead: 'Timpani（ティンパニ）は皮を張った太鼓の一種でありながら、明確な音程を持つ数少ない打楽器。名称はギリシャ語 tympanon（打つことで音を出す膜鳴楽器）に由来し、動詞 typtein（打つ）から派生している。',
    sections: [
      {
        heading: 'なぜ音程が出るのか',
        body: '半球形の胴の上に円形の膜を張ることで、膜の振動が胴の中の空気と共鳴し、特定の高さの音程として知覚されやすくなる。平らな胴に張った太鼓では倍音が不規則に混ざり合い、明確な音程として聞こえない。',
      },
      {
        heading: 'ペダルで調律する',
        body: '現代のオーケストラ用ティンパニの多くは、足元のペダルで膜の張力を変え、演奏中でも音程を変えられる。1台で1音を受け持つため、通常4〜5台を組にして使う。',
      },
    ],
    confusions: [
      { term: 'Snare drum', slug: 'snare-drum', note: 'スネアドラムは音程を持たない太鼓。ティンパニは胴の形状により明確な音程を持つ点が異なる。' },
    ],
  },


  'snare-drum': {
    lead: 'Snare drum（スネアドラム）は、裏面に張った金属のワイヤー（響き線、スナッピー）が、鋭く乾いた音の正体になっている太鼓。',
    sections: [
      {
        heading: '響き線が音の芯を作る',
        body: '表面（バッターヘッド）を打つと膜の振動が胴を通じて裏面に伝わり、そこに張られた響き線が膜に対して細かく振動しながら打ち付けられる。この響き線とヘッドの接触が、スネアドラム特有のジャリッとした鋭い倍音を生んでいる。響き線を外すと、音程感のある柔らかい音になる。',
      },
    ],
    confusions: [
      { term: 'Timpani', slug: 'timpani', note: 'ティンパニは明確な音程を持つが、スネアドラムは響き線によって音程の判別しにくい鋭い音になる。' },
    ],
  },


  'bass-drum': {
    lead: 'Bass drum（バスドラム）はオーケストラや吹奏楽で使われる打楽器の中で最も大きく、最も低い音域を持つ太鼓。',
    sections: [
      {
        heading: '大きな膜が低い基音を作る',
        body: '太鼓の基音の高さは主に膜の直径と張力で決まり、直径が大きいほど基音は低くなる。バスドラムは打楽器の中でも特に膜の面積が大きく、そのぶん低く、輪郭のぼやけた重低音が出る。両面に膜を張った構造が一般的で、両方の膜の振動が干渉し合うことで独特の余韻が生まれる。',
      },
    ],
    confusions: [
      { term: 'Timpani', slug: 'timpani', note: 'ティンパニは半球形の胴で音程を持つが、バスドラムは音程を持たない低音効果に特化している。' },
    ],
  },


  'cymbals': {
    lead: 'Cymbals（シンバル）は皿状の金属板を打ち合わせる、または単体で打つ打楽器。名称はギリシャ語 kymbalon に遡り、その語根 kymbos は「盃、くぼんだ器」を意味する。',
    sections: [
      {
        heading: '「くぼんだ器」という語源',
        body: '古代の cymbala は文字通り小さな椀や盃に似た形をしており、そのくぼみの形状が名前の由来になったとされる。現代のオーケストラ用シンバルも、中央が盛り上がったカップ状の部分と平らな部分から構成され、打つ位置によって音色が変わる。',
      },
      {
        heading: '不規則な倍音が「爆発音」を作る',
        body: 'シンバルは金属板全体が複雑に振動するため、倍音同士が整数比にならず、明確な音程を持たない。この倍音の不規則さが、金属的で持続する輝かしいノイズ音として知覚され、劇的な瞬間のアクセントに使われる理由になっている。',
      },
    ],
  },
  ...
  'harp': {
    lead: 'Harp（ハープ）は多数の弦を、1本ずつ異なる音高に調律して張った撥弦楽器。指で弦の長さを変えて音高を作る楽器ではなく、弦の数だけ音がある点が根本的に異なる。',
    sections: [
      {
        heading: 'なぜ弦を押さえないのか',
        body: '弦楽器の多くは指板を指で押さえて弦の振動する長さを変え、1本の弦から複数の音を出す。ハープにはこの指板がなく、その代わりに音の数だけ弦を張ることで対応している。オーケストラで使われるペダルハープは47本前後の弦を持つ。',
      },
      {
        heading: 'ペダルで半音を作る',
        body: '各弦はあらかじめ特定の音階に調律されており、足元の7本のペダルを踏むと、弦の途中にある円盤が回転して弦を挟み込み、実質的な弦長を変えて半音上げる。7本のペダルはそれぞれ音名の1音ずつに対応し、3段階に踏み分けられる。',
      },
    ],
  },
  ...
  'violin': {
    lead: 'Violin（ヴァイオリン）は弦楽器の中で最も高い音域を受け持つ楽器で、G・D・A・Eの4弦を完全5度の間隔で調律する。',
    sections: [
      {
        heading: '5度調律という設計',
        body: '隣り合う弦の音の差を完全5度にそろえることで、指の同じ形をわずかにずらすだけで異なる弦に対応でき、運指の合理性と音域の広さを両立させている。ヴィオラ・チェロも同じく5度調律だが、コントラバスだけは4度調律という例外になっている。',
      },
      {
        heading: 'f字孔の役割',
        body: '表板に開けられたf字形の穴は、単なる装飾ではなく、表板の振動を妨げずに内部の空気を効率よく外へ逃がすための音響上の設計である。f字孔の形と位置は、楽器の音量と音色を左右する重要な要素として、製作の歴史の中で洗練されてきた。',
      },
    ],
    confusions: [
      { term: 'Viola', slug: 'viola', note: 'ヴィオラはヴァイオリンと同じ調律法（5度）だが、完全5度低く調律され、本体も一回り大きい。' },
    ],
  },


  'viola': {
    lead: 'Viola（ヴィオラ）はヴァイオリンより完全5度低く調律される弦楽器で、C・G・D・Aの4弦を持つ。ヴァイオリン属の中で唯一、ハ音記号（アルト記号）を主に使う楽器でもある。',
    sections: [
      {
        heading: 'なぜ専用の記号（アルト記号）を使うのか',
        body: 'ヴィオラの音域はヴァイオリン用のト音記号では低すぎ、チェロ用のヘ音記号では高すぎる、ちょうど中間に位置する。この音域を五線の枠内に収めるため、ハ音（ド）を五線の中央に置くハ音記号（アルト記号）が専用に用いられる。',
      },
      {
        heading: '「理想の大きさ」が存在しない楽器',
        body: 'ヴァイオリンやチェロには音響的にほぼ確立された標準寸法があるが、ヴィオラは低い音域に見合う理論上の胴の大きさで作ると人が構えられないほど大きくなってしまう。そのため実際の製作寸法には幅があり、演奏のしやすさと音響上の理想の間で妥協した設計になっている。',
      },
    ],
    confusions: [
      { term: 'Violin', slug: 'violin', note: 'ヴィオラの方が完全5度低く、本体も一回り大きい。使用する記号もヴァイオリンのト音記号に対しアルト記号が基本。' },
      { term: 'Cello', slug: 'cello', note: 'チェロはヴィオラと同じ調律（C・G・D・A）をちょうど1オクターブ低くしたもの。' },
    ],
  },


  'cello': {
    lead: 'Cello（チェロ、正式名 Violoncello）は、ヴィオラと同じC・G・D・Aの調律をちょうど1オクターブ低くした弦楽器。',
    sections: [
      {
        heading: '名前の中に「小さい」が入っている',
        body: 'Violoncello はイタリア語 violone（大型の低音弦楽器）に、小さいことを表す縮小辞 -cello を組み合わせた語で、直訳すると「小さなヴィオローネ」。かつて存在した、より大型の低音楽器 violone に対して、それより小型の楽器として名付けられたことが分かる。',
      },
      {
        heading: 'エンドピンが支える演奏姿勢',
        body: '現在は床に突き刺す金属の脚（エンドピン）で楽器を支えて演奏するが、これが一般化したのは19世紀以降で、それ以前は奏者が両脚で楽器を挟んで支えていた。エンドピンの普及により、体格に応じて楽器の高さを自由に調整できるようになった。',
      },
    ],
    confusions: [
      { term: 'Viola da gamba', slug: 'viola-da-gamba', note: '見た目は似ているが別系統の楽器。ヴィオラ・ダ・ガンバはフレットがあり6〜7弦、チェロはフレットがなく4弦という違いがある。' },
    ],
  },


  'double-bass': {
    lead: 'Double bass（コントラバス）は弦楽器の中で最大の楽器でありながら、ヴァイオリン属の他の楽器とは異なり4度調律（E・A・D・G）を用いる。',
    sections: [
      {
        heading: 'なぜ1本だけ4度調律なのか',
        body: 'ヴァイオリン・ヴィオラ・チェロが5度調律なのに対し、コントラバスだけが4度調律なのは、これほど太く長い弦を5度間隔に広げると、指で押さえる際の指の間隔が広がりすぎて現実的でなくなるためである。4度にすることで指の間隔を狭め、演奏を可能にしている。',
      },
      {
        heading: '出自はヴィオール属',
        body: 'コントラバスは形状や調律法の点で、ヴァイオリン属よりもむしろヴィオール属（ヴィオラ・ダ・ガンバの仲間）に近い特徴を残している。なで肩の形状や、個体によっては5弦であることも、この出自と関係がある。',
      },
    ],
    confusions: [
      { term: 'Cello', slug: 'cello', note: 'チェロは5度調律だが、コントラバスは弦の太さゆえに4度調律を用いる、ヴァイオリン属の中で唯一の例外。' },
    ],
  },


  'organ': {
    lead: 'Organ（オルガン）は、鍵盤で開閉する弁を通じて風をパイプに送り込み、音を出す楽器。1本のパイプは基本的に1つの音高・音色しか出せない。',
    sections: [
      {
        heading: 'フルー管とリード管',
        body: '音を出すパイプには大きく2種類あり、リコーダーと同じ原理でエッジに風を当てて鳴らすフルー管と、金属の薄い舌（リード）を振動させて鳴らすリード管がある。両者は音色が大きく異なり、同じ鍵盤でもどちらの列を選ぶかで全く違う音色になる。',
      },
      {
        heading: 'ストップが音色を切り替える',
        body: 'ストップは、特定の音色・音高を持つパイプの列（レジスター）を送風経路に加えるか外すかを選ぶ操作子で、これを組み合わせることで1台のオルガンが多彩な音色を持つ。複数の鍵盤（マニュアル）と足鍵盤（ペダル鍵盤）を持つのも特徴で、ペダル鍵盤は低音を受け持つ。',
      },
    ],
  },
  ...
  'clavichord': {
    lead: 'Clavichord（クラヴィコード）は、鍵盤楽器の中で唯一、発音後も音の高さを揺らすビブラートをかけられる楽器。',
    sections: [
      {
        heading: 'タンジェントが弦に触れ続ける',
        body: '鍵盤を押すと、金属の小片（タンジェント）が弦を下から突き上げ、そのまま弦に接触し続けることで音を出す。ハープシコードのように弦を弾いて離れるのでも、ピアノのようにハンマーで叩いて跳ね返るのでもなく、発音後も鍵盤とタンジェントが弦に触れたままになる、数少ない鍵盤楽器の機構である。',
      },
      {
        heading: 'ベーブンクという固有の奏法',
        body: 'タンジェントが弦に触れ続けていることを利用し、鍵盤を押した指の圧力を細かく揺らすことで、弦の張力をわずかに変化させてビブラートをかける奏法をベーブンク（Bebung）と呼ぶ。音量は非常に小さく、大きなホールでの演奏には向かないが、この繊細な表現力ゆえに家庭用の楽器として愛好された。',
      },
    ],
    confusions: [
      { term: 'Harpsichord', slug: 'harpsichord', note: 'ハープシコードは弦を弾く方式で音量の強弱がつけにくい。クラヴィコードは打鍵の強さで音量を変えられる点が異なる。' },
    ],
  },


  'viola-da-gamba': {
    lead: 'Viola da gamba（ヴィオラ・ダ・ガンバ）はヴィオール属の弦楽器で、名称はイタリア語で「脚のヴィオラ」を意味し、脚に挟んで構える奏法から来ている。',
    sections: [
      {
        heading: 'ヴァイオリン属とは別系統の楽器',
        body: '見た目はチェロに似るが、フレットを持つ、弦は6〜7本、弦の間隔は4度中心（1か所だけ3度）というリュートに近い調律、なで肩で平らな背面、C字形の響孔など、多くの点でヴァイオリン属（フレットなし・4本弦・5度調律・f字孔・盛り上がった背面）と異なる。',
      },
      {
        heading: 'なぜ廃れたのか',
        body: 'フレットのある構造は音程が取りやすい反面、音量や表現の幅ではヴァイオリン属に劣るとされ、大きなホールでの演奏機会の増加とともに、オーケストラの標準低音楽器の座をチェロに譲っていった。',
      },
    ],
    confusions: [
      { term: 'Cello', slug: 'cello', note: 'チェロはフレットがなく4弦、5度調律。ヴィオラ・ダ・ガンバはフレットがあり6〜7弦、4度中心の調律という点で系統が異なる。' },
    ],
  },


  'lute': {
    lead: 'Lute（リュート）は、洋梨形の胴を持つ撥弦楽器で、名称はアラビア語 al-ʿūd（「その木」の意）が、古フランス語などを経て英語に入ったものとされる。',
    sections: [
      {
        heading: 'アラビア語起源の語源',
        body: 'al-ʿūd は中東の撥弦楽器ウードを指す言葉で、定冠詞 al が取れた ʿūd の部分がヨーロッパの諸言語に取り入れられ、フランス語 luth、英語 lute、イタリア語 liuto などになったとされる。',
      },
      {
        heading: '折れ曲がったペグボックス',
        body: 'リュートの特徴の一つに、ネックの先端で大きく後方に折れ曲がったペグボックス（糸巻き部分）がある。この角度により、多数の弦を効率よく張りながら、演奏中に糸巻きへ手が届きやすい設計になっている。フレットはガット弦を指板に巻きつけたもので、位置を調整できた。',
      },
    ],
    confusions: [
      { term: 'Theorbo', slug: 'theorbo', note: 'テオルボはリュートをさらに大型化し、低音弦専用の長いネックを追加した楽器。' },
    ],
  },


  'theorbo': {
    lead: 'Theorbo（テオルボ）は、リュート属の中でも特に大きく、低音弦専用の延長ネックを持つ撥弦楽器。',
    sections: [
      {
        heading: '2つのペグボックスを持つ構造',
        body: '通常のリュートと同様、指で押さえて音程を変える弦のためのペグボックスに加え、指板の外側に張られ開放弦のまま鳴らす低音弦専用の、さらに長いネックとペグボックスを持つ。この延長ネックが、テオルボの持つ深く豊かな低音の源になっている。',
      },
      {
        heading: '通奏低音の担い手',
        body: 'バロック時代のオペラや合奏では、テオルボが鍵盤楽器と並んで通奏低音を担う楽器として重用された。単独の低音弦を鳴らしながら上部の弦で和音を添えることができるため、少人数の編成でも十分な低音の支えを提供できた。',
      },
    ],
    confusions: [
      { term: 'Lute', slug: 'lute', note: 'リュートより大型で、低音弦専用の延長ネックを持つ点が異なる。' },
      { term: 'Basso continuo', slug: 'basso-continuo', note: 'テオルボが実際に担う役割。通奏低音の担当楽器の一つ。' },
    ],
  },


  'sereno': {
    lead: 'Sereno は「晴れやかに、澄み切って」。ラテン語 serenus（空が晴れている）に由来し、英語 serene と同じ語根を持つ。',
    sections: [
      {
        heading: '天候の語がそのまま心理の語になった',
        body: 'serenus はもともと文字通り「空に雲がなく晴れている」状態を指すラテン語の形容詞で、そこから比喩的に「心が晴れやかで乱れがない」という精神状態を表すようになった。英語 serene, serenity、フランス語 serein も同じ語根を継承している。',
      },
    ],
    confusions: [
      { term: 'Placido', slug: 'placido', note: 'Placido は静けさそのものに重心がある。Sereno はそこに曇りのない明るさが加わる点が異なる。' },
    ],
  },

  'placido': {
    lead: 'Placido は「静かに、落ち着いて」。ラテン語 placidus（穏やかな）、動詞 placere（喜ばせる、気に入る）に由来する。',
    sections: [
      {
        heading: 'placere から派生した語族',
        body: '英語 please, pleasant、そしてイタリア語 piacevole（心地よく）も同じラテン語根 placere を共有する。「相手の気に入るようにする」という語の芯が、「相手を乱さない穏やかさ」という現在の意味につながっている。',
      },
    ],
    confusions: [
      { term: 'Sereno', slug: 'sereno', note: 'Sereno は曇りのない明るさを伴う静けさ。Placido はより受動的で動きの少ない落ち着きに重心がある。' },
      { term: 'Piacevole', slug: 'piacevole', note: '同じラテン語根 placere を共有する語。Piacevole は「心地よさ」、Placido は「静けさ」に重心がある。' },
    ],
  },

  'lugubre': {
    lead: 'Lugubre は「葬送の、悲痛な、陰気な」。ラテン語 lugubris、動詞 lugere（嘆き悲しむ、喪に服す）に由来する。',
    sections: [
      {
        heading: '「喪に服す」が語の芯',
        body: 'lugere は文字通り死者を悼み喪に服す行為を指す動詞で、そこから「喪服のような重苦しさ」を表す形容詞 lugubris が生まれた。フランス語 lugubre もそのまま同じラテン語根を継承しており、暗く重々しい葬送的な雰囲気を表す点で共通する。',
      },
    ],
    confusions: [
      { term: 'Mesto', slug: 'mesto', note: 'Mesto は悲しげな様子全般を指す。Lugubre はその中でも葬送を連想させる重苦しさに寄る。' },
    ],
  },

  'luminoso': {
    lead: 'Luminoso は「光り輝いて、明るく、透明な」。ラテン語 lumen（光）、動詞 lucere（輝く）に由来する語族に属する。',
    sections: [
      {
        heading: 'lumen の語族',
        body: '英語 illuminate, luminous, luminary はすべて同じラテン語根 lumen / lucere から派生しており、「光を放つ」という物理的なイメージがそのまま音楽の輝かしい音色や透明感を表す比喩に転用されている。',
      },
    ],
    confusions: [
      { term: 'Oscuro', slug: 'oscuro', note: '反意語にあたる。Oscuro は暗く不透明な音色を指す。' },
    ],
  },

  'oscuro': {
    lead: 'Oscuro は「暗く、不透明な」。ラテン語 obscurus（暗い、覆われた）に由来し、英語 obscure と同じ語根を持つ。',
    sections: [
      {
        heading: '「覆われて見えない」という語の芯',
        body: 'obscurus は光が遮られて見えない状態を指すラテン語の形容詞で、英語 obscure（不明瞭な、覆い隠す）も同じ語根から。音楽での oscuro は、音色がこもって不透明な質感を求める指示として使われる。',
      },
    ],
    confusions: [
      { term: 'Luminoso', slug: 'luminoso', note: '反意語にあたる。Luminoso は光り輝く透明な音色を指す。' },
    ],
  },

  'sonore': {
    lead: 'Sonore は「朗々と、響き豊かに」。ラテン語 sonus（音）、動詞 sonare（鳴る、響く）に由来する。',
    sections: [
      {
        heading: 'sonare の語族',
        body: '英語 sound, resonance（re＋sonare「再び鳴り響く」）はすべて同じラテン語根から派生している。sonore は「音を鳴らす」という最も基本的な語根に、「豊かに響く」という質感を加えた形容詞にあたる。',
      },
    ],
  },

  'pastorale': {
    lead: 'Pastorale は「田園的な、牧歌的な」。ラテン語 pastor（羊飼い）、動詞 pascere（放牧する、養う）に由来する。',
    sections: [
      {
        heading: '「羊飼い」から「牧歌」へ',
        body: 'pastor はもともと文字通り羊飼いを指す語で、英語 pastor（牧師）、pasture（牧草地）も同じ語根を共有する。音楽での pastorale は、羊飼いの笛や田園風景を連想させる、ゆったりとした様式を指すようになった。',
      },
      {
        heading: '複合拍子との結びつき',
        body: 'パストラーレ様式の曲は、8分音符が3つずつまとまる複合拍子（6/8や12/8）で書かれることが多く、ゆるやかに揺れるリズムが牧歌的な雰囲気を強調する。',
      },
    ],
    confusions: [
      { term: 'Alla siciliana', slug: 'alla-siciliana', note: '同じ田園的な複合拍子を用いる舞曲様式。パストラーレより舞曲としての性格が強い。' },
    ],
  },

  'lirico': {
    lead: 'Lirico は「叙情的な」。ギリシャ語 lyra（竪琴）に由来し、古代ギリシャで竪琴の伴奏によって歌われた詩を「叙情詩」と呼んだことに遡る。',
    sections: [
      {
        heading: '楽器の名前が詩のジャンル名になった',
        body: '竪琴の伴奏で歌われる個人的な感情を歌う詩を指した語が、英語 lyric、イタリア語 lirico として受け継がれ、現在では楽器の種類を離れて「歌うような、感情に満ちた旋律的な性格」全般を指す言葉になっている。',
      },
    ],
  },

  'soave': {
    lead: 'Soave は「甘美な、柔らかな」。ラテン語 suavis（甘い、心地よい）に由来し、英語 suave（洗練された、なめらかな）と同じ語根を持つ。',
    sections: [
      {
        heading: 'dolce とは別の語根',
        body: 'suave は dolce（イタリア語で「甘く」、ラテン語 dulcis に由来）とは意味が近いものの、語源上は無関係の語である。suave は「心地よさ」に重心があり、dolce の「甘さ」とはニュアンスがわずかに異なる。',
      },
    ],
    confusions: [
      { term: 'Dolce', slug: 'dolce', note: '意味は近いが語源は別。Dolce はラテン語 dulcis（甘い）に由来する。' },
    ],
  },

  'innocente': {
    lead: 'Innocente は「無邪気に、清純に」。ラテン語 innocens、in（否定）＋nocere（害する）が組み合わさった語で、直訳すると「害を与えない」。',
    sections: [
      {
        heading: '「無害」から「無邪気」へ',
        body: 'innocens はもともと道徳的・法的に「罪がない、有害でない」ことを指すラテン語の形容詞で、英語 innocent もそのまま同じ意味を継承している。音楽用語としての innocente は、この「無害さ」が「飾り気のない、子供のような素直さ」という表現上のニュアンスに転じたものにあたる。',
      },
    ],
    confusions: [
      { term: 'Semplice', slug: 'semplice', note: 'Semplice は素朴さ・単純さに重心がある。Innocente は無邪気さ、飾り気のなさに重心がある。' },
    ],
  },

  'silenzio': {
    lead: 'Silenzio は「静寂、沈黙」。ラテン語 silentium、動詞 silere（黙っている、静かにしている）に由来する。',
    sections: [
      {
        heading: '音がないこと自体を指す語',
        body: '英語 silence も同じ語根から。強弱記号としての pp や pianissimo が「小さな音」を指すのに対し、silenzio は音そのものがない状態、すなわち休符の質感を強調する言葉として使われる。',
      },
    ],
  },

  'spirito': {
    lead: 'Spirito は「精神、活気」。ラテン語 spiritus（息、呼吸、霊）、動詞 spirare（息をする）に由来する。',
    sections: [
      {
        heading: '「息」が「精神」になった経緯',
        body: 'spiritus はもともと文字通り「呼吸、息」を意味し、そこから「生命を吹き込むもの」すなわち「魂・活力」を指す語に転じた。英語 spirit, inspire（in＋spirare「息を吹き込む」）、respire（息をする）もすべて同じ語根を共有する。con spirito（活気を持って）という形でしばしば使われる。',
      },
    ],
  },

  'gentile': {
    lead: 'Gentile は「優しく、親切に、穏やかに」。ラテン語 gentilis、gens（氏族、一族）に由来する語で、原義は「同じ一族に属する、生まれの良い」という意味だった。',
    sections: [
      {
        heading: '「生まれの良さ」から「上品さ」へ',
        body: 'gentilis はもともと血統・出自を表す語だったが、そこから「育ちの良さ」「礼儀正しさ」を意味するようになり、さらに「優しさ、穏やかさ」という現在の意味に転じた。英語 gentle, gentleman, genteel もすべて同じ語根を共有している。',
      },
    ],
  },

  'rigoroso': {
    lead: 'Rigoroso は「厳格に、正確に」。ラテン語 rigor（硬さ、こわばり）、動詞 rigere（硬直する）に由来する。',
    sections: [
      {
        heading: '「体の硬直」が「厳格さ」になった',
        body: 'rigor はもともと寒さなどで体が硬くこわばる物理的な状態を指す語で、英語 rigor, rigid, rigor mortis（死後硬直）も同じ語根から。音楽での rigoroso は、テンポやリズムを一切緩めない厳格さを求める指示にあたる。',
      },
    ],
  },

  'precipitoso': {
    lead: 'Precipitoso は「真っさかさまに、急いで、せっかちに」。ラテン語 praeceps（頭から真っ逆さまの）、praecipitare（真っ逆さまに落ちる）に由来する。',
    sections: [
      {
        heading: '「崖から落ちる」勢いを指す語',
        body: 'praeceps は prae（前へ）と caput（頭）が組み合わさり、「頭から先に落ちる」様子を表す。英語 precipice（絶壁）、precipitate（性急な、沈殿させる）も同じ語根を共有し、precipitoso はこの「制御を失った落下」のイメージをテンポの性急さに転用している。',
      },
    ],
  },

  'scintillante': {
    lead: 'Scintillante は「火花を発して、きらめく」。ラテン語 scintilla（火花）に由来し、英語 scintillate, scintillation と同じ語根を持つ。',
    sections: [
      {
        heading: '「火花」という語の芯',
        body: 'scintilla はごく小さな火の粒を指すラテン語で、そこから転じて「一瞬ごとにきらめく光」の比喩として使われるようになった。音楽での scintillante は、高音域での細かい音の連なりが光の粒のようにきらめく効果を求める指示として使われる。',
      },
    ],
  },

  'sensibile': {
    lead: 'Sensibile は「感受性豊かに、敏感に」。ラテン語 sentire（感じる）に由来し、英語 sense, sensitive, sensible と同じ語根を持つ。',
    sections: [
      {
        heading: 'sentire の語族',
        body: '英語では sensible（分別のある）と sensitive（敏感な）で意味が分かれているが、イタリア語 sensibile はこの両方のニュアンス、すなわち「感じ取る力が鋭く、それゆえに表現も豊か」という意味を併せ持つ。',
      },
    ],
  },

  'lieve': {
    lead: 'Lieve は「軽い、わずかな、優しく」。ラテン語 levis（軽い）に由来し、英語 levity（軽さ）、alleviate（軽くする、和らげる）と同じ語根を持つ。',
    sections: [
      {
        heading: 'levis の語族',
        body: '英語 lever（てこ、軽くして持ち上げる道具）も同じ語根 levis / levare（持ち上げる、軽くする）から派生している。音楽での lieve は、音量よりもタッチの軽さ・重さの感覚を指す言葉として使われる。',
      },
    ],
    confusions: [
      { term: 'Léger', slug: 'léger', note: '同じラテン語根 levis を共有するフランス語。意味もほぼ重なる。' },
    ],
  },

  'rauco': {
    lead: 'Rauco は「しわがれた、枯れた」。ラテン語 raucus（しわがれ声の、耳障りな）に由来し、英語 raucous（かん高く耳障りな）と同じ語根を持つ。',
    sections: [
      {
        heading: '声の質感を表す古い語',
        body: 'raucus は澄んだ美しい声とは対照的な、かすれてざらついた音質を指す語。楽器の音についても、意図的に濁らせたような音色を求める指示として転用される。',
      },
    ],
  },

  'angoscia': {
    lead: 'Angoscia は「苦悩して、苦しげに」。ラテン語 angustia（狭さ、窮屈さ）に由来し、締めつけられて逃げ場のない状態を指す。',
    sections: [
      {
        heading: '「狭さ」が「苦悩」になった',
        body: 'angustia はもともと物理的な空間の狭さを表す語で、英語 anguish, anxiety もすべて同じ語根 angere（締めつける、絞る）から派生している。「息苦しいほど狭い」という感覚がそのまま精神的な苦悩の比喩に転じている。',
      },
    ],
    confusions: [
      { term: 'Con dolore', slug: 'con-dolore', note: 'Con dolore は悲しみそのものを指す。Angoscia は逃げ場のない締めつけられるような苦しさに重心がある。' },
    ],
  },

  'rustico': {
    lead: 'Rustico は「田舎風の、素朴な」。ラテン語 rusticus、rus（田舎、田園）に由来し、英語 rural, rustic と同じ語根を持つ。',
    sections: [
      {
        heading: 'rus の語族',
        body: 'ラテン語 rus は「都市（urbs）」と対をなす語で、そこから「洗練されていない、飾り気のない」という意味が生まれた。音楽での rustico は、都会的な優雅さとは対照的な、素朴でざらついた質感の演奏を求める指示にあたる。',
      },
    ],
    confusions: [
      { term: 'Pastorale', slug: 'pastorale', note: '田園的な性格を指す点は近いが、Pastorale は牧歌的な穏やかさ、Rustico は飾り気のなさに重心がある。' },
    ],
  },

  'timoroso': {
    lead: 'Timoroso は「おずおずと、臆病な」。ラテン語 timor（恐れ）、動詞 timere（恐れる）に由来する。',
    sections: [
      {
        heading: 'timere の語族',
        body: '英語 timid, timorous も同じ語根から。音楽での timoroso は、大きな音を出すことを恐れているかのような、控えめでためらいがちな演奏を求める指示として使われる。',
      },
    ],
  },

  'pacifico': {
    lead: 'Pacifico は「穏やかな、平和な」。ラテン語 pax（平和）と facere（作る）が組み合わさった語で、直訳すると「平和を作る」。',
    sections: [
      {
        heading: 'pax の語族',
        body: '英語 pacify（なだめる、平和にする）、pacifist もすべて同じ語根 pax / pacare から派生している。音楽での pacifico は、対立や緊張のない、争いのなさそのものを感じさせる穏やかさを求める。',
      },
    ],
  },

  'zeloso': {
    lead: 'Zeloso は「熱心な、熱のこもった」。ギリシャ語 zelos（熱意、競争心）がラテン語 zelus を経てイタリア語に入った語。',
    sections: [
      {
        heading: 'zelos の語族',
        body: '英語 zeal, zealous、そして jealous（もとは zelos に由来し、「熱心さ」が「独占欲・嫉妬」の意味に転じた語）もすべて同じ語根を共有する。音楽での zeloso は、対象に向かって注がれる強い熱意・意気込みを表す。',
      },
    ],
  },

  'alla-turca': {
    lead: 'Alla turca は「トルコ風に」。18世紀ヨーロッパで流行した、オスマン帝国の軍楽隊を模した音楽様式を指す。',
    sections: [
      {
        heading: 'ジャニサリー・バンドという実在の楽団',
        body: 'オスマン帝国のイェニチェリ（親衛歩兵）に付随した軍楽隊は、大太鼓・シンバル・トライアングルなどの打楽器を多用した力強い音楽で知られ、その響きがヨーロッパの宮廷や作曲家たちの間で異国趣味として模倣された。',
      },
      {
        heading: '実際に模倣された特徴',
        body: '大太鼓やシンバル、トライアングルによる強い拍打ち、単純で行進曲的なリズムが典型的な特徴で、モーツァルトのピアノソナタの終楽章「トルコ行進曲」などがこの様式の代表例として知られる。',
      },
    ],
  },

  'alla-siciliana': {
    lead: 'Alla siciliana は「シチリア舞曲風に」。シチリアーナと呼ばれる、ゆるやかな6/8または12/8拍子の田園的な舞曲様式を指す。',
    sections: [
      {
        heading: '複合拍子と付点リズムが特徴',
        body: '8分音符が3つずつまとまる複合拍子に、付点リズムを組み合わせた、ゆったりと揺れるようなリズムが特徴で、しばしば牧歌的・哀愁を帯びた性格を伴う。',
      },
    ],
    confusions: [
      { term: 'Pastorale', slug: 'pastorale', note: '同じ田園的な性格を持つが、Pastorale はより広く牧歌的な様式全般を指し、siciliana は特定の付点リズムを伴う舞曲を指す点が異なる。' },
    ],
  },

  'alla-polacca': {
    lead: 'Alla polacca は「ポロネーズ風に」。ポーランド起源の、荘重な3拍子の行列舞曲であるポロネーズの様式を指す。',
    sections: [
      {
        heading: '3拍子の特徴的なリズム型',
        body: 'ポロネーズは、1拍目にアクセントを置きつつ2拍目や3拍目に細かい音符を配置する特徴的なリズム型を持ち、行進するような荘重さと気品を併せ持つ舞曲として知られる。',
      },
    ],
    confusions: [
      { term: 'Polonaise', slug: 'polonaise', note: 'Alla polacca は「ポロネーズ風に」という様式指示。Polonaise はその舞曲・楽曲形式そのものを指す名詞。' },
    ],
  },

  'alla-zingara': {
    lead: 'Alla zingara は「ジプシー（ロマ）風に」。ロマの音楽に特徴的とされる、自由なテンポの揺れや装飾的な旋律を模した様式を指す。',
    sections: [
      {
        heading: '「様式」であり出自の主張ではない',
        body: 'alla zingara は、ヨーロッパの作曲家たちが自分たちの耳に映ったロマ音楽の特徴、すなわち急激なテンポの変化、即興的な装飾、劇的な強弱の対比を取り入れた様式的な指示であり、実際のロマ音楽そのものを厳密に再現したものとは異なる。',
      },
    ],
  },

  'triste': {
    lead: 'Triste は「悲しい」。フランス語およびイタリア語で用いられ、ラテン語 tristis（悲しい、陰気な）に由来する。',
    sections: [
      {
        heading: 'tristis の語族',
        body: '英語には直接の同語源の日常語はないが、tristesse（悲しみ）という名詞形がフランス語にあり、感情のジャンルとして「悲しみ」そのものを指す最も基本的な語の一つになっている。',
      },
    ],
    confusions: [
      { term: 'Mesto', slug: 'mesto', note: 'Mesto は悲しみに沈んだ様子を指すイタリア語で、Triste とほぼ同義だが、より控えめで内省的な陰りを伴う。' },
    ],
  },

  'gracieux': {
    lead: 'Gracieux は「優雅に」。フランス語で、ラテン語 gratia（恵み、魅力、感謝）に由来し、英語 grace, gracious と同じ語根を持つ。',
    sections: [
      {
        heading: 'gratia の語族',
        body: '英語 grace（優雅さ、神の恵み）、gratitude（感謝）、gratis（無料の）もすべて同じラテン語根 gratia から派生している。「相手を喜ばせる魅力」という語の芯が、音楽表現における優雅で心地よい身のこなしの比喩に転用されている。',
      },
    ],
    confusions: [
      { term: 'Grazioso', slug: 'grazioso', note: 'イタリア語での同義語。同じラテン語根 gratia を共有する。' },
    ],
  },

  'doux': {
    lead: 'Doux は「心地よい、甘い、静かな」。フランス語で、ラテン語 dulcis（甘い）に由来し、イタリア語 dolce と同じ語根を持つ。',
    sections: [
      {
        heading: 'dulcis の語族',
        body: '英語 dulcet（甘美な）も同じ語根から。イタリア語圏では dolce、フランス語圏では doux と、ロマンス諸語のそれぞれで独自の音変化を遂げながら、同じラテン語根が受け継がれている。',
      },
    ],
    confusions: [
      { term: 'Dolce', slug: 'dolce', note: '同じラテン語根 dulcis を共有するイタリア語。ほぼ同義。' },
    ],
  },

  'léger': {
    lead: 'Léger は「軽やかに」。フランス語で、ラテン語 levis（軽い）に由来し、イタリア語 lieve と同じ語根を持つ。',
    sections: [
      {
        heading: 'levis の語族',
        body: 'ラテン語 levis から、俗ラテン語を経てフランス語 léger が生まれている。イタリア語 lieve、leggero も同じラテン語根 levis の子孫にあたり、ロマンス諸語それぞれの音変化を経て今の形になった。',
      },
    ],
    confusions: [
      { term: 'Lieve', slug: 'lieve', note: '同じラテン語根 levis を共有するイタリア語。ほぼ同義。' },
    ],
  },

  'ausdruck': {
    lead: 'Ausdruck は「表現」。ドイツ語で、aus（外へ）と Druck（圧力、押すこと）が組み合わさった語で、直訳すると「外へ押し出されたもの」。',
    sections: [
      {
        heading: 'ラテン語 expressio と同じ発想',
        body: '英語・イタリア語などで使われる expression（表現）も、ラテン語 ex（外へ）＋ premere（押す）という、Ausdruck とまったく同じ構造を持つ語である。「内側にあるものを外へ押し出す」という比喩を、ドイツ語とラテン語系の言語がそれぞれ独自に同じ発想で作り上げている。',
      },
    ],
    confusions: [
      { term: 'Ausdrucksvoll', slug: 'ausdrucksvoll', note: 'Ausdruck に「〜に満ちた」を意味する接尾辞 -voll を付けた形容詞形。' },
      { term: 'Mit Ausdruck', slug: 'mit-ausdruck', note: 'Ausdruck を前置詞 mit（〜と共に）で修飾した指示句。' },
      { term: 'Espressivo', slug: 'espressivo', note: 'イタリア語での同義語。同じラテン語 expressio の発想を共有する。' },
    ],
  },

  'ausdrucksvoll': {
    lead: 'Ausdrucksvoll は「表情たっぷりに」。Ausdruck（表現）に、「〜に満ちた」を意味する接尾辞 -voll を付けた語。',
    sections: [
      {
        heading: '-voll という接尾辞',
        body: 'voll は「いっぱいの」を意味するドイツ語の形容詞で、名詞に付いて「その性質に満ちている」ことを表す接尾辞として働く。英語の -ful に近い役割を持つ。',
      },
    ],
    confusions: [
      { term: 'Ausdruck', slug: 'ausdruck', note: '名詞形。「表現」そのものを指す語。' },
      { term: 'Mit Ausdruck', slug: 'mit-ausdruck', note: '同じ Ausdruck を使うが、前置詞 mit（〜と共に）による指示句。' },
    ],
  },

  'mit-ausdruck': {
    lead: 'Mit Ausdruck は「表現をもって、表情豊かに」。前置詞 mit（〜と共に）と Ausdruck（表現）を組み合わせた、そのまま読み下せる指示。',
    sections: [
      {
        heading: 'イタリア語 con espressione と同じ構文',
        body: 'mit（〜と共に）＋名詞という組み立ては、イタリア語の con（〜を持って）＋名詞（con espressione「表情を持って」など）とまったく同じ発想の構文で、ドイツ語圏の作曲家がイタリア語の伝統的な発想表示の型をそのまま自国語に置き換えたものと考えられる。',
      },
    ],
    confusions: [
      { term: 'Con espressione', slug: 'con-espressione', note: 'イタリア語での同じ構文の指示。mit＋名詞とcon＋名詞は同じ発想でできている。' },
      { term: 'Ausdruck', slug: 'ausdruck', note: '名詞形。「表現」そのものを指す語。' },
    ],
  },

  'feierlich': {
    lead: 'Feierlich は「おごそかに、祝典的に」。ドイツ語 Feier（祝祭、祝典）に、形容詞を作る接尾辞 -lich を付けた語。',
    sections: [
      {
        heading: 'Feier の語族',
        body: 'Feier はラテン語 feriae（祝祭日、休日）に由来するとされ、英語 fair（見本市、もとは「祝祭・市」を意味した語）も同じ語根を共有するという説がある。宗教的・儀式的な厳かさを伴う場面で使われる。',
      },
    ],
  },

  'lebhaft': {
    lead: 'Lebhaft は「快活に、生き生きと」。ドイツ語 Leben（生命、生活）に、「〜を持った、〜に満ちた」を意味する接尾辞 -haft を付けた語。',
    sections: [
      {
        heading: '-haft という接尾辞',
        body: '-haft は英語の -like や -ful に近い働きをする接尾辞で、名詞にその性質を帯びていることを表す。Lebhaft は文字通り「生命を帯びた」、つまり生き生きとした活発さを意味する。',
      },
    ],
    confusions: [
      { term: 'Vivace', slug: 'vivace', note: 'イタリア語での近い意味の語。ラテン語 vivax（生命力のある）に由来し、Lebhaft とは異なる語根から同じような意味に到達している。' },
    ],
  },

  'kräftig': {
    lead: 'Kräftig は「力強く、精力的に」。ドイツ語 Kraft（力、エネルギー）に、形容詞を作る接尾辞 -ig を付けた語。',
    sections: [
      {
        heading: 'Kraft という基本語',
        body: 'Kraft はドイツ語の中核的な語彙の一つで、英語 craft（もとは「力、技能」を意味した語で、現在の「工芸・技術」という意味はそこから派生した）と同じ語根を共有するとされる。',
      },
    ],
  },

  'innig': {
    lead: 'Innig は「心の底から、親密に、深く」。ドイツ語 inne（内側に、内部で）に、形容詞を作る接尾辞 -ig を付けた語。',
    sections: [
      {
        heading: '「内側」が語の芯',
        body: 'inne は英語 in / inner と同じ語根を共有し、Innig は「表面的でなく、内側から湧き出るような深さ」を表す。シューマンの作品にしばしば見られる指示で、感情の内面的な深さを強調する。',
      },
    ],
  },

  'augmentation': {
    lead: 'Augmentation（拡大）は、動機や主題を構成する音符の長さをすべて一定の倍率（多くは2倍）に引き伸ばして提示する対位法の技法。英語 augmentation はラテン語 augmentare（増やす）に由来する。',
    sections: [
      {
        heading: '音程はそのまま、時間軸だけを引き伸ばす',
        body: '主題の音の並びと音程関係は保ったまま、音符の長さだけを均等に拡大する。8分音符は4分音符に、4分音符は2分音符になり、旋律の輪郭は変わらないまま、動きはゆっくりと重々しくなる。速く提示された主題を後から拡大形で再提示すると、同じ素材が別の性格で現れたように聞こえる。',
      },
      {
        heading: 'フーガでの重ね合わせ',
        body: '対位法作品では、主題を通常の速さで提示する声部と、拡大形で提示する声部を同時に鳴らすことがある。バッハ「フーガの技法」の Contrapunctus VII a 4, per Augmentationem et Diminutionem は、拡大と縮小の両方を同時に用いた対位法の代表例として知られる。',
      },
    ],
    confusions: [
      { term: 'Diminution', slug: 'diminution', note: '逆に音価を短縮する技法。拡大と対で使われることが多い。' },
      { term: 'Inversion', slug: 'inversion', note: '音価ではなく音程の上下を反転させる技法。' },
    ],
    works: [
      { title: 'バッハ「フーガの技法」Contrapunctus VII', note: '同じ主題の拡大形と縮小形を同時に重ねる楽章。' },
    ],
  },

  'diminution': {
    lead: 'Diminution（縮小）は Augmentation の逆で、主題の音価を一定の倍率（多くは1/2）に短縮して提示する技法。初期音楽ではこれとは別に、単純な旋律を細かい音符で装飾する実践も同じ語で呼ばれた。',
    sections: [
      {
        heading: '対位法における縮小',
        body: '主題を構成する音符の長さを均等に半分へ圧縮する。音の並びと音程関係は保たれるが、動きは速くなり、切迫した性格を帯びる。フーガでは、通常の速さの主題と縮小形の主題を同時に重ねることで緊張を高める書法が使われる。',
      },
      {
        heading: 'もう一つの意味：即興的な装飾',
        body: 'ルネサンスから初期バロックの独奏・声楽の実践では、書かれた単純な旋律を、演奏者がその場で多くの細かい音符へ分解して弾く技術も diminution（division）と呼ばれた。シルヴェストロ・ガナッシの教則本 Fontegara（1535年）や、ディエゴ・オルティスの Tratado de glosas（1553年）が、この装飾実践を伝える資料として知られている。',
      },
    ],
    confusions: [
      { term: 'Augmentation', slug: 'augmentation', note: '逆に音価を拡大する技法。縮小と対で使われることが多い。' },
    ],
    works: [
      { title: 'バッハ「フーガの技法」Contrapunctus VII', note: '同じ主題の拡大形と縮小形を同時に重ねる楽章。' },
    ],
  ...
  'inversion': {
    lead: 'Inversion（反行）は、旋律を構成する音程の上下を反転させる技法。上行していた音程は同じ幅だけ下行させ、下行していた音程は同じ幅だけ上行させる。「鏡に映した旋律」と説明されることがある。',
    sections: [
      {
        heading: '音程の幅を保ったまま向きだけを変える',
        body: '元の旋律である音から次の音へ長3度上がっていたなら、反行形では同じ音から長3度下がる。すべての音程の幅は保存され、向きだけが逆になる。なお、二声の旋律を上下反転する melodic inversion と、二声の役割（上声と下声）を入れ替えられるように書く invertible counterpoint（転回対位法）は、名前は似ているが別の概念である。',
      },
      {
        heading: '十二音技法の基本形の一つ',
  ...
  'retrograde': {
    lead: 'Retrograde（逆行）は、旋律を最後の音から最初の音へ向かって、記譜の順序を丸ごと逆転させて奏する技法。「カニの進行（canon cancrizans）」の名でも呼ばれる。',
    sections: [
      {
        heading: '音の順序をそのまま反転する',
        body: '音高とリズムの並びを後ろから前へ並べ直す。音程の向きは変えず、順序だけが逆になるため、元の旋律とは輪郭がまったく異なって聞こえることが多い。耳だけで元の旋律との関係を認識するのは難しく、楽譜を見て初めて分かる構造上の仕掛けであることが多い。',
      },
      {
        heading: 'バッハ「音楽の捧げもの」の蟹のカノン',
        body: 'バッハ「音楽の捧げもの」BWV 1079 に収められた Canon cancrizans（蟹のカノン）は、1段の旋律をそのまま弾く声部と、同じ譜面を後ろから弾く声部を同時に重ねることで完成する。逆行技法をそのまま音楽の構造にした代表例として知られる。',
      },
    ],
    confusions: [
      { term: 'Inversion', slug: 'inversion', note: '順序ではなく音程の上下を反転させる技法。' },
      { term: 'Retrograde inversion', slug: 'retrograde-inversion', note: '逆行と反行を両方重ねた形。' },
    ],
    works: [
      { title: 'バッハ「音楽の捧げもの」蟹のカノン', note: '同じ譜面を前から弾く声部と後ろから弾く声部が同時に鳴る。' },
    ],
  },

  'retrograde-inversion': {
    lead: 'Retrograde inversion（逆行反行）は、旋律を反行させたうえでさらに逆行させる（あるいは逆行させたうえで反行させる）技法。どちらの順で行っても結果は同じになる。',
    sections: [
      {
        heading: '二つの操作を重ねる',
        body: 'まず全ての音程の上下を反転し（inversion）、その反転後の旋律をさらに最後の音から最初の音へ並べ直す（retrograde）。この二つの操作は可換で、順序を入れ替えても同一の結果になる。',
      },
      {
        heading: '十二音技法の4形態のうち最も知覚しにくい変形',
        body: 'シェーンベルクの十二音技法では、音列を原形・逆行・反行・逆行反行の4つの基本形で扱う。逆行反行は2つの変形を重ねているぶん、原形との関係を耳で聴き取ることが最も難しい形とされる。',
      },
    ],
    confusions: [
      { term: 'Inversion', slug: 'inversion', note: '反行のみを行う操作。' },
      { term: 'Retrograde', slug: 'retrograde', note: '逆行のみを行う操作。' },
    ],
  },

  'sequence': {
    lead: 'Sequence（同型反復）は、同じ音型やパターンを異なる高さで繰り返しながら進行させる技法。旋律だけでなく、和声進行にも同様の反復が使われる。',
    sections: [
      {
        heading: '相対的な形を保ったまま移調する',
        body: 'ある音型を構成する音程関係とリズムはそのまま保ち、開始音の高さだけを一定の幅（多くは2度ずつ）でずらして繰り返す。上行させれば緊張感が高まり、下行させれば徐々に落ち着いていく効果を持つ。',
      },
      {
        heading: '旋律的反復と和声的反復',
        body: '単一の声部の音型を繰り返す「旋律的シーケンス」のほかに、同じ和声進行のパターンを異なる調域で繰り返す「和声的シーケンス」もある。通奏低音を伴うバロック音楽では、後者が楽曲を前へ進める推進力としてよく使われる。',
      },
    ],
  },

  'pedal-point': {
    lead: 'Pedal point（ペダル・ポイント）は、低声部で一つの音を長く保持したまま、その上でほかの声部の和声が変化していく技法。名称はオルガンの足鍵盤（ペダル）に由来する。',
    sections: [
      {
        heading: '足で保持する音が語源',
        body: 'パイプオルガンの奏者は足鍵盤で低音を持続させながら、両手で上声部の和声を自由に変化させることができる。この演奏習慣が、鍵盤の種類を問わず「持続する低音の上で和声が動く」書法全般を指す名称として定着した。',
      },
      {
        heading: '緊張から解決へ',
        body: '保持される低音に対して上声部の和声が変化すると、理論上の不協和が生まれることが多い。この緊張は、上声部の和声が保持音と再び協和する和音に落ち着くことで解決される。属音を保持するドミナント・ペダルは、終止へ向かう緊張を長く引き伸ばす効果でよく使われる。',
      },
    ],
    confusions: [
      { term: 'Organ point', slug: 'organ-point', note: 'ドイツ語 Orgelpunkt に対応する呼び方。指す現象は同じ。' },
    ],
  },

  'organ-point': {
    lead: 'Organ point（オルゲルプンクト）は Pedal point のドイツ語 Orgelpunkt に対応する呼び方で、意味はまったく同じ。低声部で一音を保持したまま上声部の和声を進行させる技法を指す。',
    sections: [
      {
        heading: 'なぜ二つの呼び方があるのか',
        body: 'pedal point が「足鍵盤（ペダル）」という演奏動作に着目した名称であるのに対し、organ point は「オルガンという楽器」そのものに着目した名称。同じ現象を、別の角度から言い表しているにすぎない。',
      },
    ],
    confusions: [
      { term: 'Pedal point', slug: 'pedal-point', note: '英語での呼び方。指す現象は同じ。' },
    ],
  },

  'syncopation': {
    lead: 'Syncopation（シンコペーション）は、拍節上本来アクセントのない位置に強勢を置き、規則的な拍の流れをずらす技法。語源はギリシャ語 synkope（切断、まとめて断つ）で、医学用語の失神（syncope）と同じ語根を持つ。',
    sections: [
      {
        heading: '「切断する」が語の芯',
        body: 'ギリシャ語 synkope は syn（共に）と koptein（切る）から成り、「切り落とす」「中断する」という意味を持つ。医学ではこの語が、心拍や意識が急に途絶える失神を指す言葉として今も使われている。音楽では、規則的な拍の流れが本来ない場所へアクセントの重心が移ることで、拍節が「途切れた」ように感じられる現象を指す。',
      },
      {
        heading: '記譜上の主な作り方',
        body: '拍の頭を休符にして弱拍側にアクセントを移す、拍をまたいでタイで音を伸ばす、拍の裏にアクセント記号を付けるなど、複数の方法で同じ効果を作れる。いずれも、聴き手が予測する拍の重心と、実際に強調される瞬間とのずれが生み出す効果である。',
      },
    ],
    confusions: [
      { term: 'Hemiola', slug: 'hemiola', note: '拍の重心をずらす点は似るが、こちらは拍の単位そのものを組み替える技法。' },
    ],
  },

  'hemiola': {
    lead: 'Hemiola（ヘミオラ）は、3拍子の中に2拍子相当のまとまりを感じさせる、あるいはその逆を感じさせるリズム技法。語源はギリシャ語 hemiolios「全体と半分（3対2の比）」。',
    sections: [
      {
        heading: '3対2の比という語源',
        body: 'ギリシャ語 hemiolios は hemi（半分）と holos（全体）の組み合わせで、「全体に半分を足した量」＝3対2の比を意味する。古代ギリシャの音楽理論では、この比は完全5度の周波数比（3:2）を表す用語として使われていた。リズム用語としての hemiola は、その3対2という比の考え方をリズムの領域に転用したもの。',
      },
      {
        heading: '拍の単位を組み替える',
        body: '例えば4分の3拍子が2小節続く場面で、本来は「強弱弱｜強弱弱」と感じられるところを、アクセントの置き方によって「強弱｜強弱｜強弱」という2拍子的な3つのまとまりに聞こえるように変える。バロック舞曲の終止直前や、ブラームスの室内楽で好んで使われる技法。',
      },
    ],
    confusions: [
      { term: 'Syncopation', slug: 'syncopation', note: '拍の重心をずらす点は似るが、こちらは1つの拍の中でアクセントを移動させる技法。' },
    ],
  },

  'arpa': {
    lead: 'Arpa はイタリア語で「ハープ」を意味する語。楽器そのものを指すほか、楽譜では奏法や書法の性格を示す語としても使われる。',
    sections: [
      {
        heading: 'Arpeggio の語源そのもの',
        body: '分散和音を意味するイタリア語 arpeggio は、arpa（ハープ）に動詞語尾を付けた派生語 arpeggiare（ハープのように弾く）から作られた名詞。arpeggio は文字通り「ハープのように弾くこと」を意味する語であり、arpa という楽器名がそのまま奏法用語の語源になっている。',
      },
    ],
    confusions: [
      { term: 'Arpeggio', slug: 'arpeggio', note: 'arpa から派生した、分散和音そのものを指す語。' },
      { term: 'Arpeggiato', slug: 'arpeggiato', note: '同じ語根を持つ過去分詞形。「ハープ風に弾かれた」という指示。' },
    ],
  },

  'coloratura': {
    lead: 'Coloratura（コロラトゥーラ）はイタリア語で「彩色、色付け」を意味する語。急速な音階やトリル、跳躍を多用した、技巧的で華麗な装飾を伴う歌唱様式を指す。',
    sections: [
      {
        heading: '「色を付ける」という語の芯',
        body: '動詞 colorare（色を付ける）の名詞形で、単純な旋律線に速いパッセージや装飾音を加え、聴覚的な「彩り」を添える発想がそのまま語になっている。ソプラノの高音域で歌われることが多いが、本来は声域を指す語ではなく、装飾的な歌い回しそのものを指す語である。',
      },
      {
        heading: 'オペラでの役割',
        body: '感情が高揚し、言葉だけでは表現しきれない場面で、装飾的な旋律が代わりに心情の激しさや華やかさを表す。狂乱の場面や祝祭的な場面など、劇的な頂点でコロラトゥーラの技巧が求められることが多い。',
      },
    ],
    confusions: [
      { term: 'Melisma', slug: 'melisma', note: '一音節に複数の音を当てる歌い方全般。コロラトゥーラはその中でも特に技巧的で華麗なものを指す。' },
    ],
  },

  'falsetto': {
    lead: 'Falsetto（ファルセット）はイタリア語で falso（偽りの）の縮小形で、「小さな偽りの声」の意。声帯全体ではなく縁の部分だけを振動させて出す、地声（モーダルボイス）とは発声機構の異なる高い声域を指す。',
    sections: [
      {
        heading: '声帯の使い方が地声と異なる',
        body: '通常の地声（モーダルボイス）では声帯全体が厚みを保ったまま振動するのに対し、ファルセットでは声帯の縁だけが薄く振動し、声帯全体はしっかり閉じきらない。このため地声より息が多く混じり、細く軽い音色になる。「偽り」という呼び名は、地声と異なる発声機構で出るこの声を、本来の声ではないと捉えた歴史的な見方に由来する。',
      },
      {
        heading: '男声で特に意識される切り替え',
        body: '地声とファルセットの境目（passaggio と呼ばれる移行域）をどう滑らかに越えるかは、男声にとって重要な技術的課題になる。ポップスやカウンターテナーの歌唱では、この切り替えを目立たせず地声のように扱う技術（ヘッドボイスとの融合）が磨かれてきた。',
      },
    ],
  },

  'melisma': {
    lead: 'Melisma（メリスマ）はギリシャ語で「歌、旋律」を意味する melos に由来する語で、一つの音節に複数の音をあてて歌う様式を指す。',
    sections: [
      {
        heading: '一音節に旋律を委ねる',
        body: '通常の歌唱では一音節に一つの音を対応させるが、メリスマでは一音節の母音の上で旋律が自由に展開する。歌詞の意味の伝達よりも、旋律そのものの流麗さや感情の高まりを表すことに重心が置かれる。',
      },
      {
        heading: 'グレゴリオ聖歌から現代ポップスまで',
        body: '中世のグレゴリオ聖歌ではアレルヤ唱などにメリスマが多用され、宗教的な陶酔感を表す手段となった。ルネサンス以降のポリフォニー声楽曲、バロックのオペラのアリア、そして現代のR&Bやポップスのボーカルアドリブに至るまで、時代と様式を超えて使われ続けている技法である。',
      },
    ],
    confusions: [
      { term: 'Syllabic', slug: 'syllabic', note: '一音節に一音を対応させる、メリスマとは正反対の様式。' },
      { term: 'Coloratura', slug: 'coloratura', note: 'メリスマの中でも特に技巧的で華麗なものを指すイタリア語の語。' },
    ],
  },

  'melismatic': {
    lead: 'Melismatic は Melisma の形容詞形で、「メリスマ的な、一音節に多くの音をあてる様式の」という意味。',
    sections: [
      {
        heading: 'Syllabic との対比で使われる語',
        body: 'ある旋律や様式を分類するとき、一音節に一音を対応させる syllabic な書法と、一音節に複数の音をあてる melismatic な書法は対の概念として並べて説明されることが多い。実際の楽曲の多くは、この二つの書法を場面によって使い分けている。',
      },
    ],
    confusions: [
      { term: 'Melisma', slug: 'melisma', note: '名詞形。装飾的な旋律のまとまりそのものを指す。' },
      { term: 'Syllabic', slug: 'syllabic', note: '一音節に一音を対応させる、正反対の様式。' },
    ],
  },

  'syllabic': {
    lead: 'Syllabic（シラビック）は、一つの音節に一つの音符を対応させる歌唱様式を指す語。ラテン語 syllaba（音節）に由来する。',
    sections: [
      {
        heading: '言葉の伝達を優先する書法',
        body: 'メリスマが旋律の流麗さを優先するのに対し、シラビックな書法は歌詞の一語一語がはっきり聞き取れることを優先する。賛美歌や会衆全体で歌う聖歌、レチタティーヴォなど、言葉の意味や物語の進行が重要な場面でよく使われる。',
      },
    ],
    confusions: [
      { term: 'Melismatic', slug: 'melismatic', note: '一音節に複数の音をあてる、正反対の様式。' },
      { term: 'Recitativo', slug: 'recitativo', note: '言葉の抑揚を重視するシラビックな歌唱様式の代表例。' },
    ],
  },

  'recitativo': {
    lead: 'Recitativo（レチタティーヴォ）はイタリア語 recitare（語る、朗読する）に由来する語で、話し言葉のように歌う、オペラやオラトリオの様式。物語や台詞を前へ進める役割を担う。',
    sections: [
      {
        heading: '言葉のリズムが音楽のリズムに優先する',
        body: 'アリアが感情をじっくり歌い上げる場面であるのに対し、レチタティーヴォは会話や状況説明を進めるための様式で、旋律的な美しさよりも言葉の抑揚と自然な話し方のリズムが優先される。',
      },
      {
        heading: '伴奏の厚さによる二つの種類',
        body: '通奏低音（チェンバロと低音楽器）だけで伴奏される簡素な形は recitativo secco（乾いたレチタティーヴォ）と呼ばれ、会話的な場面で多用される。オーケストラ伴奏を伴う劇的な形は recitativo accompagnato（伴奏付きレチタティーヴォ）または recitativo stromentato と呼ばれ、感情が高ぶる場面でアリアへの橋渡しとして使われる。',
      },
    ],
    confusions: [
      { term: 'Parlando', slug: 'parlando', note: '話すように歌う指示。レチタティーヴォという様式全体ではなく、歌い方そのものを指す語。' },
    ],
  },

  'bel-canto': {
    lead: 'Bel canto はイタリア語で「美しい歌」を意味し、無理のない発声と滑らかなレガート、音域を通じた音色の均一さを重視する、19世紀イタリア・オペラの歌唱伝統を指す。',
    sections: [
      {
        heading: '滑らかさと均一さを重視する発声',
        body: 'ベルカントの理想は、力任せに声を張り上げることではなく、息の流れを絶やさず、低音から高音まで音色の質感を変えずに歌うことにある。装飾的なパッセージも、力ではなく息のコントロールで軽やかにこなすことが求められる。',
      },
      {
        heading: 'ベッリーニ、ドニゼッティ、初期ロッシーニ',
        body: 'ベルカントという様式名は、ヴィンチェンツォ・ベッリーニやガエターノ・ドニゼッティ、初期のジョアキーノ・ロッシーニのオペラに代表される、旋律の美しさと歌唱技巧を前面に出した作風と結び付けて語られることが多い。',
      },
    ],
  },

  'vocalise': {
    lead: 'Vocalise（ヴォカリーズ）はフランス語で、歌詞を用いず母音だけで歌う練習曲、または演奏会用の楽曲を指す。',
    sections: [
      {
        heading: '言葉を持たない歌',
        body: '歌詞がないため、言葉の意味に頼らず、声そのものの音色や息の流れ、フレーズの作り方に集中して聴くことになる。声を楽器のように扱う発想から生まれた形式で、発声練習として作られたものから、演奏会用の独立した作品として書かれたものまで幅がある。',
      },
      {
        heading: 'ラフマニノフの「ヴォカリーズ」',
        body: 'ラフマニノフが1912年に作曲した歌曲集 作品34の最後を飾る「ヴォカリーズ」（作品34の14）は、歌詞を持たない演奏会用作品として特に有名で、ソプラノ歌手アントニーナ・ネジダーノヴァに献呈された。器楽版に編曲されて演奏される機会も多い。',
      },
    ],
    works: [
      { title: 'ラフマニノフ「ヴォカリーズ」作品34の14', note: '歌詞を持たない演奏会用ヴォカリーズの代表作。' },
    ],
  },

  'parlando': {
    lead: 'Parlando（パルランド）はイタリア語で「話すように」を意味する語。持続する響きよりも、言葉を話すときの自然な抑揚とリズムを優先して歌う（あるいは弾く）よう求める指示。',
    sections: [
      {
        heading: '旋律よりも語りを優先する',
        body: '通常の歌唱がなめらかな音の持続を大切にするのに対し、parlando は音価やアクセントを話し言葉に近づけ、内容を伝えることを優先する。オペラのセリフに近い場面や、性格的な表現を求める場面で使われる。',
      },
      {
        heading: 'バルトークの「パルランド・ルバート」',
        body: '民族音楽学者でもあった作曲家バルトーク・ベーラは、ハンガリーの民謡に見られる、話し言葉のリズムに沿って自由に伸び縮みする歌い方を parlando rubato と呼び、自身の作品にもこの様式の要素を取り入れた。',
      },
    ],
  },

  'yodel': {
    lead: 'Yodel（ヨーデル）はドイツ語 jodeln に由来する語で、地声（モーダルボイス）とファルセットを急速に切り替えながら歌う、アルプス地方の民俗的な歌唱技法。',
    sections: [
      {
        heading: '声区の切れ目をあえて聞かせる',
        body: '通常の歌唱では地声とファルセットの切り替え（パッサッジョ）をなめらかに隠すことが目指されるのに対し、ヨーデルはその切り替えをあえて速く、はっきりと繰り返すことで、独特の弾むような音色の変化を作り出す。大きな音程の跳躍を伴うことが多い。',
      },
      {
        heading: 'スイス・オーストリア・バイエルンの民俗音楽',
        body: 'スイスやオーストリア、南部ドイツ（バイエルン）のアルプス地方の民俗音楽に伝わる歌唱様式で、山あいでの合図や呼びかけに由来する発声と結び付けて語られることが多い。',
      },
    ],
  },

  'just-intonation': {
    lead: 'Just intonation（純正律）は、音程を単純な整数比の周波数比で調律する方式。完全5度を3:2、長3度を5:4のように、倍音同士がうなりなく溶け合う比率に合わせる。',
    sections: [
      {
        heading: '整数比が生むうなりのない響き',
        body: '二つの音の周波数が単純な整数比にあると、両者の倍音列の多くが重なり合い、うなり（干渉による音量の周期的な揺れ）がほとんど生じない。純正律はこの原理に基づき、各音程を可能な限り単純な整数比に合わせて調律する。',
      },
      {
        heading: '平均律との違いと制約',
        body: '現在広く使われる12平均律は、1オクターブを周波数比で等しい12個の半音に機械的に分割するため、多くの音程がわずかに純正な比からずれている。純正律はある一つの調では極めて美しい響きが得られる一方、比率が調ごとに異なるため、転調や移調を伴う音楽には適さない。合唱や弦楽アンサンブルでは、和音の響きを合わせる際に奏者が耳で純正律に近づけて演奏することがある。',
      },
    ],
    confusions: [
      { term: 'Intonation', slug: 'intonation', note: '音程を正確に合わせる行為・技術全般を指す語。純正律はその調律方式の一つ。' },
    ],
  },

  'intonation': {
    lead: 'Intonation（イントネーション）はラテン語 intonare（大きく響かせる、in＋tonare「鳴る」）に由来する語で、音程を正確に演奏・調整する行為や、その正確さそのものを指す。',
    sections: [
      {
        heading: '二つの使われ方',
        body: '一つは、演奏中に音程がどれだけ正確に合っているかという意味。ピッチが高すぎる、低すぎるといった評価はこの意味での intonation を指す。もう一つは、演奏を始める前に楽器全体の基準となる音の高さを整える行為（管楽器なら管の抜き差し、弦楽器なら調弦）を指す用法で、こちらは楽器を「合わせる」作業そのものを意味する。',
      },
      {
        heading: '固定ピッチと可変ピッチの楽器',
        body: 'ピアノやハープのように音程があらかじめ固定される楽器と異なり、弦楽器や管楽器、声楽は演奏中に音程を微調整できる。これらの楽器では、和音の中でどの音をどちらへ寄せるかという判断が、intonation の質を左右する。',
      },
    ],
    confusions: [
      { term: 'Just intonation', slug: 'just-intonation', note: '整数比に基づく特定の調律方式。intonation は音程の正確さ全般を指すより広い語。' },
    ],
  },

  'tessitura': {
    lead: 'Tessitura（テッシトゥーラ）はイタリア語で「織物、質感」を意味する tessere（織る）に由来する語で、ある声部や楽曲の中で、音がもっとも多く使われている音域を指す。',
    sections: [
      {
        heading: '最高音・最低音とは別の指標',
        body: '楽曲や声部が実際に到達する最高音と最低音の幅は ambitus（音域）と呼ばれるのに対し、tessitura はその中でどのあたりの高さに音が「織り込まれ」て集中しているかを指す。まれに高音や低音へ跳躍しても、大半の音がその声にとって歌いやすい範囲にあれば、その部分がテッシトゥーラとなる。',
      },
      {
        heading: '声のタイプを選ぶ基準',
        body: '同じ最高音まで届く歌手同士でも、日常的に楽に響かせられる音域（テッシトゥーラ）は人によって異なる。オペラの配役では、最高音に到達できるかどうかだけでなく、その役の音がどの高さに集中しているかが、声のタイプに合っているかを判断する重要な基準になる。',
      },
    ],
  },

  'scordatura': {
    lead: 'Scordatura（スコルダトゥーラ）はイタリア語 scordare（調子を狂わせる、dis＋corda「弦」）に由来する語で、弦楽器の弦を標準とは異なる音高に調弦する技法を指す。',
    sections: [
      {
        heading: '通常の運指では出せない響きを得る',
        body: '弦の調弦を変えることで、開放弦を使った特定の和音や重音が弾きやすくなったり、楽器全体の共鳴の仕方が変わって音色に独特の性格が生まれたりする。運指自体は通常どおりでも、実際に鳴る音は記譜されたものと異なるため、演奏者は移調読みを求められることが多い。',
      },
      {
        heading: '歴史的な使用例',
        body: 'ハインリヒ・イグナーツ・フランツ・ビーバーの「ロザリオのソナタ（神秘のソナタ）」は、曲ごとに異なるスコルダトゥーラを用いることで知られる17世紀の代表作。サン＝サーンス「死の舞踏」では、独奏ヴァイオリンのE線を半音下げてE♭に調弦し、悪魔の弾く不気味なヴァイオリンの響きを表している。',
      },
    ],
    works: [
      { title: 'ビーバー「ロザリオのソナタ」', note: '曲ごとに異なる調弦を用いる、スコルダトゥーラの歴史的代表作。' },
      { title: 'サン＝サーンス「死の舞踏」', note: '独奏ヴァイオリンのE線をE♭に下げ、不気味な響きを作る。' },
    ],
  },

  'flageolet': {
    lead: 'Flageolet（フラジオレット）はフランス語で、弦楽器のハーモニクス（倍音奏法）を指す語。もとは同名の小さな縦笛（フラジオレット）の、細く澄んだ音色になぞらえた呼び名である。',
    sections: [
      {
        heading: '楽器名がそのまま奏法名になった',
        body: 'フラジオレットは、バロック期に広く使われた、リコーダーに近い小型の縦笛。この笛の細く軽やかな音色が、弦を軽く触れて出す倍音（ハーモニクス）の澄んだ音色と似ていたことから、弦楽器の倍音奏法そのものが flageolet と呼ばれるようになった。',
      },
    ],
    confusions: [
      { term: 'Harmonics', slug: 'harmonics', note: '英語での呼び方。指す奏法は同じ。' },
      { term: 'Flagelletto', slug: 'flagelletto', note: 'イタリア語での表記違い。' },
    ],
  },

  'flagelletto': {
    lead: 'Flagelletto（フラジェレット）は、フランス語 flageolet のイタリア語表記で、弦楽器のハーモニクス（倍音奏法）を指す語。',
    sections: [
      {
        heading: '同じ楽器名に由来する語',
        body: 'フランス語形と同様、バロック期の小型の縦笛フラジオレットの、細く澄んだ音色になぞらえた呼び名で、指す奏法そのものはフランス語形やイタリア語の harmonics と変わらない。',
      },
    ],
    confusions: [
      { term: 'Flageolet', slug: 'flageolet', note: 'フランス語での表記。指す奏法は同じ。' },
      { term: 'Harmonics', slug: 'harmonics', note: '英語での呼び方。指す奏法は同じ。' },
    ],
  },

  'bridge-glissando': {
    lead: 'Bridge glissando（ブリッジ・グリッサンド）は、弦楽器で弓を駒（ブリッジ）の上、またはごく近くで滑らせるように動かし、ノイズを含んだ不安定な高音を出す特殊奏法。',
    sections: [
      {
        heading: '駒の位置が音色を決める',
        body: '通常のボウイングは駒と指板の間の、弦がもっとも豊かに振動する範囲で行われる。駒の上やすぐ近くで弓を動かすと、弦の規則的な振動が乱れ、倍音成分の多い、きしむようなノイズ寄りの音になる。弦の張力や弓の圧力によって、出てくる音の高さや質感が不安定に変化するのも特徴である。',
      },
      {
        heading: '20世紀以降の特殊奏法として',
        body: '通常の美しい音色を求める書法とは対照的に、緊張感や不気味さ、非現実的な質感を表現する手段として、20世紀以降の現代音楽の弦楽器書法でしばしば使われる。',
      },
    ],
    confusions: [
      { term: 'Sul ponticello', slug: 'sul-ponticello', note: '駒の近くで弾く点は共通するが、こちらは駒には触れず、金属的な倍音を強調する奏法。' },
    ],
  },

  'scrape': {
    lead: 'Scrape（スクレイプ）は英語で「こする」を意味する語で、楽器の一部を弓や別の道具でこすり、摩擦によるノイズ的な音を出す奏法の総称。',
    sections: [
      {
        heading: '摩擦そのものを音にする',
        body: '弦楽器で弦を爪や道具でこすったり、シンバルの縁を撥の柄や硬貨でこすったりすることで、通常の打撃音や擦弦音とは異なる、金属的・砂のような質感の持続音が得られる。楽器本来の音程を出す奏法ではなく、音色そのものを目的とした特殊奏法である。',
      },
    ],
    confusions: [
      { term: 'Bridge glissando', slug: 'bridge-glissando', note: '弦楽器で駒の上を滑らせる奏法。こちらもノイズ寄りの音色を作るが、駒の位置に特化した奏法。' },
    ],
  },

  'battements': {
    lead: 'Battements（バットマン）はフランス語で「拍動、揺らぎ」を意味する語で、二つの音がわずかに周波数の異なる状態で同時に鳴るときに生じる、音量が周期的に強弱する現象（うなり）を利用した奏法や効果を指す。',
    sections: [
      {
        heading: 'うなりが生まれる仕組み',
        body: '周波数のわずかに異なる二つの音を同時に鳴らすと、二つの波が重なり合う位置によって強め合ったり弱め合ったりを繰り返し、音量が周期的に脈打つように聞こえる。この脈動の速さは、二つの音の周波数の差に等しい。純正な協和音ではこのうなりがほとんど消えるため、battements は意図的にわずかな音程差を作って独特の陰影を生み出す技法として使われる。',
      },
    ],
  },

  'arpeggiato': {
    lead: 'Arpeggiato（アルペジアート）はイタリア語の動詞 arpeggiare（ハープのように弾く）の過去分詞で、「ハープ風に弾かれた」の意。和音を同時に鳴らさず、下から上へ（またはその逆に）ずらして弾くことを指示する。',
    sections: [
      {
        heading: 'arpa（ハープ）が語源',
        body: 'arpeggiare はイタリア語で「ハープ」を意味する arpa に、動詞を作る語尾を付けた語。ハープは構造上、和音の各音を同時にではなく指を使って順に鳴らすため、この楽器特有の弾き方が、和音を分散させて弾く奏法全般の名称になった。',
      },
      {
        heading: '記譜と実際の速さ',
        body: '楽譜上では和音の左に波線を添えて指示されることが多く、下から上へ弾く場合は矢印なし、上から下へ弾く場合は下向きの矢印が波線に添えられる。分散させる速さの指定は厳密でないことが多く、曲の性格や強弱に応じて演奏者が判断する。',
      },
    ],
    confusions: [
      { term: 'Arpeggio', slug: 'arpeggio', note: '分散和音という現象・技法そのものを指す名詞形。arpeggiato はその過去分詞（形容詞的な指示）。' },
      { term: 'Arpa', slug: 'arpa', note: '語源であるイタリア語のハープ。' },
    ],
  },

  'glissato': {
    lead: 'Glissato（グリッサート）は Glissando の異形で、意味・用法はほぼ同じ。ある音から別の音へ滑らかに滑らせて奏することを指示する。',
    sections: [
      {
        heading: 'Glissando との違い',
        body: '語源はフランス語 glisser（滑る）で共通しており、glissato は語尾をイタリア語の過去分詞的な形に合わせた表記のゆれにあたる。指示される奏法そのものに違いはない。',
      },
    ],
    confusions: [
      { term: 'Glissando', slug: 'glissando', note: 'より一般的に使われる表記。指す奏法は同じ。' },
    ],
  },

  'glissandando': {
    lead: 'Glissandando（グリッサンダンド）は Glissando から作られた進行形的な語形で、「滑らせながら」の意。ある音から別の音へ滑らかに移りながら演奏することを指示する。',
    sections: [
      {
        heading: 'Glissando との違い',
        body: '指示する奏法自体は Glissando と変わらないが、-ando という語尾は「〜しながら」という継続・進行の意味合いを添える。滑らせる動作が持続していることを強調したいときに、この語形が選ばれることがある。',
      },
    ],
    confusions: [
      { term: 'Glissando', slug: 'glissando', note: 'より一般的に使われる表記。指す奏法は同じ。' },
  ...
  'bow': {
    lead: 'Bow（弓）は、弦楽器の弦を擦って音を出すための道具、およびそれを使う奏法を指す英語。弦楽器の表現の大部分は、この道具の使い方に左右される。',
    sections: [
      {
        heading: '摩擦が振動を生み出す仕組み',
        body: '弓の毛（多くは馬の尾の毛）には松脂が塗られており、この摩擦力によって弦をわずかに引っかけては離す動作（スティック・スリップ現象）を高速で繰り返し、弦を規則的に振動させる。松脂がなければ毛は弦の上を滑るだけで、音はほとんど出ない。',
      },
      {
        heading: '弓の構造と各部の役割',
        body: '弓は、しなりを生む木製（あるいはカーボン製）の棹（スティック）と、毛を張る先端の「ヘッド」、毛の張力を調整する手元の「フロッグ」から成る。棹の材にはブラジルボクやペルナンブコが伝統的に使われ、その弾力が弓圧の伝わり方を左右する。',
      },
      {
        heading: '速度・重さ・位置という3つの変数',
        body: '同じ音の長さでも、弓を動かす速さ、弦にかける重さ、弦のどこ（駒寄りか指板寄りか）を弾くかという3つの要素の組み合わせで、音量・音色・アタックの質感が大きく変わる。演奏者はこの3変数を意識的に組み合わせて表現を作る。',
      },
    ],
    confusions: [
      { term: 'Arco', slug: 'arco', note: 'イタリア語で「弓」を意味し、pizzicato から弓奏に戻る指示として使われる語。' },
    ],
  },

  'bras': {
    lead: 'Bras はフランス語で「腕」を意味する語。弦楽器の教則やボウイングの指導で、手首だけでなく腕全体を使う動きを指す際に使われることがある。',
    sections: [
      {
        heading: '手首と腕の使い分け',
        body: '弓を動かす際、短く繊細な動きは主に手首と指で、大きく長いストロークは腕全体の動きで支える必要がある。bras という語が指導や楽譜の注記に現れる場合、手首だけでなく腕全体の動きを意識するよう促す指示として使われる。',
      },
    ],
  },

  'col-pollice': {
    lead: 'Col pollice はイタリア語で「親指で」の意。col は con il（〜を用いて）の縮約形、pollice は「親指」を意味する。',
    sections: [
      {
        heading: 'チェロのサムポジション',
        body: 'チェロでは高いポジションを弾く際、親指を指板に横向きに置いて弦を押さえる「サムポジション」が使われる。col pollice はこの親指を使う奏法を指示する語で、通常の指使いでは届かない高音域や、和音を押さえる際に用いられる。',
      },
    ],
  },

  'colla-destra': {
    lead: 'Colla destra はイタリア語で「右手で」の意。colla は con la（〜を用いて、女性形）の縮約形、destra は「右（の手）」を意味する。',
    sections: [
      {
        heading: '両手の役割を指定する指示',
        body: '鍵盤楽器やハープなど両手を使う楽器の楽譜で、ある声部やパッセージをどちらの手で弾くべきかを明示するために使われる。指定がないと弾きにくい、あるいは音色が変わってしまう箇所で指示されることが多い。',
      },
    ],
    confusions: [
      { term: 'Main droite', slug: 'main-droite', note: 'フランス語での同じ意味の指示。' },
    ],
  },

  'main-droite': {
    lead: 'Main droite はフランス語で「右手」を意味する語。楽譜では「右手で」という指示として使われる。',
    sections: [
      {
        heading: 'Colla destra との違い',
        body: '意味も用法もイタリア語 colla destra と変わらない。使われる言語が、楽譜の出版地や作曲家の言語圏によって異なるだけである。',
      },
    ],
    confusions: [
      { term: 'Colla destra', slug: 'colla-destra', note: 'イタリア語での同じ意味の指示。' },
      { term: 'Main gauche', slug: 'main-gauche', note: '同じフランス語の対で使われる「左手で」の指示。' },
    ],
  },

  'gaucher': {
    lead: 'Gaucher はフランス語で本来「左利きの（人）」を意味する語だが、楽譜の注記では「左手で」というニュアンスで使われることがある。',
    sections: [
      {
        heading: '本来の意味と楽譜での使われ方',
        body: 'フランス語として厳密には、「左手で」を表す通常の言い回しは main gauche である。gaucher は形容詞・名詞として「左利きの（人）」を指す語だが、楽譜の注記の中には、左手を使うパッセージを示す目的でこの語が用いられている例がある。',
      },
    ],
    confusions: [
      { term: 'Main gauche', slug: 'main-gauche', note: '「左手で」を表す、より一般的なフランス語の言い回し。' },
    ],
  },

  'main-gauche': {
    lead: 'Main gauche はフランス語で「左手」を意味する語。楽譜では「左手で」という指示として使われる。',
    sections: [
      {
        heading: 'Main droite と対で使われる',
        body: '鍵盤楽器やハープの楽譜で、main droite（右手で）と対になって現れ、声部やパッセージをどちらの手で弾くかを指定する。指定がないと不自然な運指になる箇所や、両手の受け渡しを明確にしたい箇所で使われる。',
      },
    ],
    confusions: [
      { term: 'Main droite', slug: 'main-droite', note: '対で使われる「右手で」の指示。' },
    ],
  },

  'alzamano': {
    lead: 'Alzamano はイタリア語 alzare（上げる）と mano（手）を組み合わせた語で、文字どおりには「手を上げること」。演奏を短く区切って手を離し、間を取ることを指示する。',
    sections: [
      {
        heading: '複合語としての成り立ち',
        body: 'alzare（上げる）＋ mano（手）という単純な合成で、鍵盤楽器を中心に、手を鍵盤から一瞬持ち上げて音を完全に切り、次のフレーズとの間に小さな区切り（一種のブレスやカエスーラ）を作ることを指す語として使われる。',
      },
    ],
  },

  'battitacco': {
    lead: 'Battitacco はイタリア語 battere（打つ）と tacco（かかと）を組み合わせた語で、文字どおりには「かかとで打つこと」。靴のかかとで拍子を刻む奏法を指す。',
    sections: [
      {
        heading: '複合語としての成り立ち',
        body: 'battere（打つ）＋ tacco（かかと）という単純な合成語で、フラメンコギターなど、演奏者自身が靴のかかとで床を打ち鳴らしてリズムを刻む奏法を指す。楽器の音とは別に、身体そのものを打楽器として使う点が特徴である。',
      },
    ],
  },

  'gestopft': {
    lead: 'Gestopft はドイツ語の動詞 stopfen（詰める、塞ぐ）の過去分詞で、「塞がれた」の意。ホルンで右手をベルの中に深く入れ、開口部をほぼ完全に塞いで音色を変える特殊奏法（ストップ奏法）を指す。',
    sections: [
      {
        heading: '手でベルを塞ぐと何が起こるか',
        body: 'ホルンは右手をベルの内側に添えて音色を調整する楽器だが、gestopft ではその手をさらに深く入れてベルの開口部をほぼ完全に塞ぐ。これにより実際に鳴る音の高さが半音上がるため、演奏者はその分を見込んで運指を変える必要がある。音色は開口時よりも鼻にかかったような、金属的で緊張感のある響きに変わる。',
      },
      {
        heading: '各国語での呼び方',
        body: 'イタリア語では chiuso（閉じられた）、フランス語では bouché（塞がれた）と呼ばれ、いずれも同じストップ奏法を指す。楽譜がどの言語で書かれているかによって、同じ奏法が異なる語で指示される。',
      },
    ],
    confusions: [
      { term: 'Chiuso', slug: 'chiuso', note: 'イタリア語での同じ奏法の呼び方。' },
      { term: 'Stopped', slug: 'stopped', note: '英語での同じ奏法の呼び方。' },
      { term: 'Bouche', slug: 'bouche', note: 'フランス語での同じ奏法の呼び方（正しい綴りは bouché）。' },
    ],
  },

  'bouche': {
    lead: 'Bouche はフランス語 bouché（塞がれた、閉じられた）の楽譜表記で、ホルンで右手を深くベルに入れて音色を変えるストップ奏法を指す。正しい綴りはアクセント記号付きの bouché。',
    sections: [
      {
        heading: 'Gestopft・Chiuso と同じ奏法',
        body: 'ドイツ語 gestopft、イタリア語 chiuso と指す奏法はまったく同じで、右手でベルの開口部をほぼ完全に塞ぐことで、実音を半音上げつつ、金属的で緊張感のある音色を得る。楽譜の出版された言語圏によって呼び方が異なるだけである。',
      },
    ],
    confusions: [
      { term: 'Gestopft', slug: 'gestopft', note: 'ドイツ語での同じ奏法の呼び方。' },
      { term: 'Chiuso', slug: 'chiuso', note: 'イタリア語での同じ奏法の呼び方。' },
    ],
  },

  'senza-sordino': {
    lead: 'Senza sordino はイタリア語で「弱音器なしで」の意。con sordino（弱音器を付けて）で装着した弱音器を外し、楽器本来の響きに戻すことを指示する。',
    sections: [
      {
        heading: 'con sordino と対で使われる指示',
        body: 'senza（〜なしで）と sordino（弱音器）の組み合わせで、意味は文字どおり。弱音器によって抑えられていた倍音や音量の制約が解かれ、楽器本来の輝きや響きの豊かさが戻る。ピアノでは、ダンパーペダルを踏み続けて弦の響きを止めない状態を指す場合にも使われる。',
      },
    ],
    confusions: [
      { term: 'Con sordino', slug: 'con-sordino', note: '弱音器を付ける指示。senza sordino はこれを解除する。' },
    ],
  },

  'coperto': {
    lead: 'Coperto はイタリア語で「覆われた」の意。打楽器では、皮の面を布などで覆って響きを抑えることを指す語として使われる。',
    sections: [
      {
        heading: '布で覆って響きを抑える',
        body: 'ティンパニやスネアドラムなどの打楽器で、皮の面（あるいは共鳴させたくない部分）に布をかぶせることで、倍音を抑えた、こもった鈍い音を出す。弦楽器や管楽器の弱音器（sordino）が音量や音色を機構的に抑えるのに対し、coperto は布という物理的な覆いによって響きを変える点が異なる。',
      },
    ],
  },
  ...
  'dampfer-auf': {
    ...
    sections: [
      {
        heading: 'Con sordino のドイツ語表記',
        body: 'auf は「上に、取り付けて」を意味する前置詞・副詞で、Dämpfer（弱音器）と組み合わさり「弱音器を装着せよ」という指示になる。指す動作はイタリア語 con sordino と変わらない。',
      },
    ],
    confusions: [
      { term: 'Con sordino', slug: 'con-sordino', note: 'イタリア語での同じ指示。' },
      { term: 'Dampfer ab', slug: 'dampfer-ab', note: '対になる「弱音器を外して」の指示。' },
    ],
  },

  'dampfer-ab': {
    lead: 'Dämpfer ab（楽譜では Dampfer ab とも表記される）はドイツ語で「弱音器を外して」の意。senza sordino のドイツ語表記にあたる。',
    sections: [
      {
        heading: 'Senza sordino のドイツ語表記',
        body: 'ab は「離れて、外して」を意味する前置詞・副詞で、Dämpfer（弱音器）と組み合わさり「弱音器を外せ」という指示になる。指す動作はイタリア語 senza sordino と変わらない。',
      },
    ],
    confusions: [
      { term: 'Senza sordino', slug: 'senza-sordino', note: 'イタリア語での同じ指示。' },
      { term: 'Dampfer auf', slug: 'dampfer-auf', note: '対になる「弱音器を付けて」の指示。' },
    ],
  },

  'cuivre': {
    lead: 'Cuivre はフランス語で「銅、真鍮」を意味する語。金管楽器の楽譜では、正しくは形容詞形 cuivré（真鍮のような、金属的な）として使われ、意図的に荒々しく金属的な音を出す奏法を指示する。',
    sections: [
      {
        heading: '楽器の材質そのものを音の性格にする',
        body: '金管楽器は cuivre（銅・真鍮系合金）で作られることが多く、cuivré はその材質が持つ本来の金属的な鋭さを、あえて過剰に引き出すように演奏することを求める。ホルンでは、ストップ奏法（gestopft）と組み合わせて、荒々しく突き刺すような強奏を指示する場合に使われることが多い。',
      },
    ],
    confusions: [
      { term: 'Gestopft', slug: 'gestopft', note: 'ホルンのストップ奏法。cuivré はこれと組み合わせて荒々しい音色を作ることが多い。' },
    ],
  },

  'mannheim-rocket': {
    lead: 'Mannheim rocket（マンハイム・ロケット）は、和音の構成音を低音から高音へ一気に駆け上がる急速な分散和音の音型を指す、音楽史上の呼び名。18世紀半ば、マンハイムの宮廷楽団で好んで使われたことに由来する。',
    sections: [
      {
        heading: 'マンハイム楽派という背景',
        body: '18世紀半ば、ヨハン・シュターミッツが率いたマンハイムの宮廷楽団は、当時のオーケストラとして際立った統率力と表現力を持つことで知られ、急激なクレッシェンド（マンハイム・クレッシェンド）や、この駆け上がる分散和音の音型など、劇的な効果を生む書法をいち早く体系的に用いた。',
      },
      {
        heading: '効果の作り方',
        body: '和音を低い音から順に、速いテンポで一息に上へ駆け上がらせることで、聴き手の緊張を一気に高める効果を作る。しばしばクレッシェンドを伴い、フレーズの冒頭やクライマックスの直前に置かれることが多い。',
      },
    ],
    confusions: [
      { term: 'Arpeggio', slug: 'arpeggio', note: '分散和音という現象そのものを指す一般語。マンハイム・ロケットはその中でも急速に上昇する特定の型を指す呼び名。' },
    ],
  },

  'inequality': {
    lead: 'Inequality（不等奏、notes inégales）は、楽譜上は等しい長さで書かれた音符を、長短交互の不均等なリズムで演奏する、17〜18世紀フランスの演奏習慣。',
    sections: [
      {
        heading: '書かれた音符と実際の演奏の乖離',
        body: 'フランス・バロックの器楽曲や声楽曲では、連続する同じ長さの音符（多くは8分音符）を、実際には「長・短・長・短」というジャズのスウィングに近い不均等なリズムで演奏する慣習があった。この慣習は当時の演奏論書、たとえばクープランの「クラヴサン奏法」などに記述が残っている。',
      },
      {
        heading: '適用範囲をめぐる議論',
        body: 'この慣習をどこまで厳密に適用すべきか、また同時代のイタリアやドイツの音楽（バッハを含む）にどこまで応用してよいかについては、20世紀の演奏習慣研究者の間でも意見が分かれ、現在も議論が続いている。',
      },
    ],
    confusions: [
      { term: 'Swing', slug: 'swing', note: '書かれた均等な音符を長短不均等に演奏する点で似た発想を持つ、ジャズのリズム様式。' },
    ],
  },

  'double-dotting': {
    lead: 'Double dotting（複付点、二重付点）は、音符に付点を二つ重ねて記譜する、あるいは記譜以上に鋭く付点を強調して演奏する技法・慣習を指す。',
    sections: [
      {
        heading: '付点が加える長さの計算',
        body: '付点は直前の音符の長さの半分を加える記号で、二つ目の付点はさらにその半分（元の音符の4分の1）を加える。したがって二重付点の付いた音符は、元の音符の1.75倍の長さになる。単純な足し算ではなく、付点ごとに前の付点分の半分が加わっていく仕組みである。',
      },
      {
        heading: 'フランス風序曲様式での慣習的な誇張',
        body: 'バロック期、とくにフランス風序曲の様式で書かれた楽曲では、楽譜には単純な付点で記されていても、実際には複付点に近い、より鋭く跳ねるリズムで演奏する慣習があったとされる。この慣習をどこまで適用すべきかは、学者の間で議論が続いている点である。',
      },
    ],
    confusions: [
      { term: 'Inequality', slug: 'inequality', note: '書かれたリズムを演奏習慣として誇張・変形する点で共通するフランス・バロックの慣習。' },
    ],
  },

  'swing': {
    lead: 'Swing（スウィング）は、楽譜上は均等な8分音符を、長短交互の弾むようなリズムで演奏する、ジャズに特徴的なリズム様式。',
    sections: [
      {
        heading: '長短の比率は固定されない',
        body: '書かれた8分音符を「長・短」の不均等なリズムに崩して演奏するが、その長短の比率は演奏者やテンポ、曲想によって幅があり、フランス・バロックの notes inégales のように決まった規則があるわけではない。速いテンポではほぼ均等に近づき、遅いテンポでは長短の差がはっきりする傾向がある。',
      },
      {
        heading: '楽譜には書ききれない感覚',
        body: 'スウィングの質感は微妙なタイミングのずれや強弱の配分を含むため、記譜だけで正確に伝えることが難しく、演奏を耳で聴いて体得する部分が大きい奏法とされる。',
      },
    ],
    confusions: [
      { term: 'Inequality', slug: 'inequality', note: '均等な音符を長短不均等に演奏する点で似た発想を持つ、フランス・バロックの演奏慣習。' },
    ],
  },

  'improvisation': {
    lead: 'Improvisation（即興演奏）は、あらかじめ楽譜に書かれていない旋律や和声、リズムを、演奏のその場で作り出しながら弾く行為を指す。',
    sections: [
      {
        heading: '書かれた音楽の周辺で常に行われてきた',
        body: 'バロック期の通奏低音の演奏や、装飾音・カデンツァの創作、教会のオルガン奏者による前奏・間奏の即興は、いずれも楽譜化された部分の周辺で演奏者自身が音楽を作り出す行為であり、即興は特定の様式に限らず、時代を通じて音楽実践の一部であり続けてきた。',
      },
      {
        heading: 'ジャズにおける中心的な位置づけ',
        body: 'ジャズでは、決められた和声進行（コード進行）を土台にしながら、その場で旋律線を作り出す即興演奏が様式の中心に置かれている。同じ和声進行の上でも、演奏するたびに異なる旋律が生まれる点が、あらかじめ全てが記譜されるクラシック音楽の多くの演奏習慣と対照的である。',
      },
    ],
  },

  'idiomatic': {
    lead: 'Idiomatic（イディオマティック）は、ある楽器の構造や身体の使い方に自然に合った書き方・弾き方を指す語。',
    sections: [
      {
        heading: '楽器の特性に沿った書法',
        body: '弦楽器であれば開放弦の響きや弓の返しやすさ、ピアノであれば手の自然な形と鍵盤配置に沿った運指、管楽器であれば運指と息継ぎの位置など、それぞれの楽器が持つ物理的な制約や得意な動きに沿って書かれた（あるいは演奏された）パッセージを idiomatic と呼ぶ。',
      },
      {
        heading: '反対の状態',
        body: '楽器の構造を無視して書かれ、技術的に不自然で弾きにくい、あるいは楽器の音響的な特性を活かせていない書き方は un-idiomatic（イディオマティックでない）と表現される。作曲家がその楽器の奏者出身であるかどうかが、書法の idiomatic さに影響することがある。',
      },
    ],
  },

  'jam-session': {
    lead: 'Jam session（ジャム・セッション）は、事前に取り決めをせず、演奏者どうしがその場で音を聴き合いながら即興的に音楽を作り上げる、非公式な合同演奏の場を指す。',
    sections: [
      {
        heading: '楽譜も指揮者も介さない音楽づくり',
        body: '通常のアンサンブル演奏が事前に決められた楽譜や指揮に従うのに対し、ジャム・セッションでは曲や和声進行の大枠だけを共有し、細部は演奏者どうしの即興的な掛け合いでその場に組み立てられていく。ジャズやブルースの文化の中で発達し、練習や交流、新しいアイデアを試す場としても機能してきた。',
      },
    ],
    confusions: [
      { term: 'Improvisation', slug: 'improvisation', note: 'その場で音楽を作り出す行為そのもの。ジャム・セッションは、複数人がそれを合同で行う場を指す語。' },
    ],
  },

  'klavier': {
    lead: 'Klavier（クラヴィーア）はドイツ語で「鍵盤楽器」を意味する総称。特定の楽器を指すのではなく、鍵盤を持つ楽器全般を広くまとめて呼ぶ語である。',
    sections: [
      {
        heading: 'ラテン語 clavis（鍵）に由来',
        body: 'Klavier はラテン語 clavis（鍵、かぎ）に由来する語で、フランス語 clavier、英語 clavichord・harpsichord などの keyboard 関連語と同じ語根を共有する。「鍵（キー）を押して音を出す楽器」という発想が、そのまま楽器の総称になっている。',
      },
      {
        heading: 'バッハ「平均律クラヴィーア曲集」の Klavier',
        body: 'バッハの「平均律クラヴィーア曲集（Das Wohltemperierte Klavier）」の Klavier は、チェンバロ・クラヴィコード・オルガンなど、当時存在した複数の鍵盤楽器のどれで弾いてもよいという含みを持つ総称として使われている。特定の楽器名ではなく総称であることが、この曲集のタイトルの解釈に関わる重要な点である。',
      },
    ],
    confusions: [
      { term: 'Keyboard', slug: 'keyboard', note: '英語での同様の総称。ゲルマン語系の複合語である点が Klavier と異なる。' },
    ],
  },

  'keyboard': {
    lead: 'Keyboard（鍵盤）は英語で、key（鍵）と board（板）を組み合わせた複合語。鍵盤を持つ楽器全般、またはその鍵盤の部分そのものを指す。',
    sections: [
      {
        heading: 'ゲルマン語の複合語という成り立ち',
        body: 'ラテン語 clavis に由来するロマンス語系の Klavier・clavier に対し、英語の keyboard は key と board という日常語を組み合わせた、ゲルマン語らしい直接的な複合語である。同じ「鍵盤楽器」という概念を、語の作り方の異なる二つの言語がそれぞれの方法で表している。',
      },
      {
        heading: '楽器名としての現代的用法',
        body: '現代では、ピアノ・オルガン・チェンバロなどの総称としてだけでなく、電子鍵盤楽器（シンセサイザーなど）そのものを指す楽器名としても keyboard が単独で使われる。',
      },
    ],
    confusions: [
      { term: 'Klavier', slug: 'klavier', note: 'ドイツ語での同様の総称。ラテン語 clavis に由来する語根を持つ。' },
    ],
  },

  'grand-piano': {
    lead: 'Grand piano（グランドピアノ）は英語で、フレームと弦を水平に配置した大型のピアノを指す。grand はフランス語由来で「大きい」の意。',
    sections: [
      {
        heading: '水平配置がもたらす構造上の利点',
        body: 'グランドピアノは弦とフレームを鍵盤から奥へ水平に伸ばす構造を持つため、アップライトピアノより弦を長く、響板を大きく取ることができる。ハンマーは重力の助けを借りて鍵盤へ戻るため、連続した打鍵に対する反応（アクションの俊敏さ）もアップライトより優れているとされる。',
      },
      {
        heading: '大きさによる分類',
        body: '全長によって、コンサートグランド（演奏会用の最大サイズ）、パーラーグランド、ベビーグランドなど複数の呼び名で分類される。全長が長いほど弦が長くなり、低音の響きがより豊かになる。',
      },
    ],
    confusions: [
      { term: 'Fortepiano', slug: 'fortepiano', note: 'グランドピアノの前身にあたる初期のピアノ。フレームや弦の張力が弱く、音量・音色ともに現代のグランドピアノとは大きく異なる。' },
    ],
  },

  'neck': {
    lead: 'Neck（ネック、首）は英語で、弦楽器の胴体から伸び、指板を支える細長い部分を指す。',
    sections: [
      {
        heading: 'フレットの有無による違い',
        body: 'ギターやリュートなど撥弦楽器のネックには、音程の目安となるフレット（金属の仕切り）が指板に埋め込まれていることが多く、決まった位置を押さえれば正確な音程が得られる。一方、ヴァイオリン属の弦楽器のネックにフレットはなく、演奏者は指の位置の感覚だけで音程を作る必要がある。',
      },
      {
        heading: '反りと調整',
        body: '弦の張力は常にネックを引っ張るように働くため、多くの楽器のネックには反りを調整するための機構（トラスロッドなど）が仕込まれていたり、木材の選定や補強によって反りに耐える構造が作られている。',
      },
    ],
  },

  'xylophone-style': {
    lead: 'Xylophone style（シロフォン・スタイル）は、木琴（シロフォン）が持つ乾いた短い音の質感を模して演奏することを求める指示。',
    sections: [
      {
        heading: '音を伸ばさず短く区切る',
        body: '木琴の音は硬い撥で木片を叩いて出すため、余韻がほとんど残らず、一音一音が乾いてはっきり区切られる。この質感を他の楽器で模す場合、音を意図的に短く切り、響きを残さないように弾くことで、打楽器的でユーモラスな効果を作り出す。',
      },
    ],
  },

  'overdrive': {
    lead: 'Overdrive（オーバードライブ）は英語で「駆動しすぎ」の意。電気信号を増幅する回路に許容量以上の信号を送り込み、波形をわずかに歪ませて生まれる、比較的穏やかな歪み効果を指す。',
    sections: [
      {
        heading: '波形が丸くつぶれる仕組み',
        body: '増幅回路（真空管やトランジスタ）は入力信号がある大きさを超えると、出力波形の頂点をなだらかに切り詰めるように歪ませる（ソフトクリッピング）。この軽い歪みが、倍音を豊かに加えた温かみのある音色として知覚される。真空管アンプを音量を上げて使うと自然に生じる現象で、エレキギターの音作りに古くから利用されてきた。',
      },
      {
        heading: 'Distortion との違い',
        body: 'overdrive が波形をなだらかに丸く切り詰めるのに対し、distortion はより急激に、波形の頂点を平らに切り詰める（ハードクリッピング）ことで、より攻撃的で歪みの強い音色を作る。歪みの量と質の両方に違いがある。',
      },
    ],
    confusions: [
      { term: 'Distortion', slug: 'distortion', note: 'より強く急激な歪みを加える効果。overdrive はより穏やかな歪み。' },
    ],
  },

  'distortion': {
    lead: 'Distortion（ディストーション）は英語で「歪み」の意。電気信号の波形を大きく変形させ、荒々しく強烈な歪み効果を生む。',
    sections: [
      {
        heading: '波形が急激に切り詰められる',
        body: 'overdrive が波形の頂点をなだらかに丸めるのに対し、distortion は波形の頂点をほぼ平らに切り詰める（ハードクリッピング）。これにより倍音成分が大量に加わり、より攻撃的でざらついた音色になる。専用のディストーション・ペダルやアンプの高ゲイン設定によって作られることが多い。',
      },
    ],
    confusions: [
      { term: 'Overdrive', slug: 'overdrive', note: 'より穏やかな歪みを加える効果。distortion はより強く急激な歪み。' },
    ],
  },

  'reverb': {
    lead: 'Reverb（残響）は英語 reverberation の略で、音が発せられたあとも、壁や天井などで反射を繰り返しながら空間に漂い続ける現象、およびそれを人工的に加える効果を指す。',
    sections: [
      {
        heading: '無数の反射が積み重なって聞こえる',
        body: '音源から出た音は、壁・天井・床など様々な面で反射しながら耳に届く。反射の経路は無数にあり、それぞれ届くまでの時間がわずかに異なるため、個々の反射が判別できないほど密に重なり合い、音が滑らかに減衰しながら尾を引くように聞こえる。この密な重なりが reverb の特徴で、単発の反射がはっきり分離して聞こえる echo（やまびこ）とは区別される。',
      },
      {
        heading: '録音・演奏での使われ方',
        body: 'コンサートホールの響きの豊かさは、このリバーブの量と質によって大きく左右される。録音やライブ音響では、実際の空間の響きが足りない場合に、リバーブ装置やソフトウェアで人工的に残響を付け加えることが一般的に行われている。',
      },
    ],
    confusions: [
      { term: 'Delay', slug: 'delay', note: '単発の反射音がはっきり分離して聞こえる効果。reverb は無数の反射が密に重なる効果。' },
    ],
  },

  'delay': {
    lead: 'Delay（ディレイ）は英語で「遅延」の意。原音から一定時間遅れて、はっきりと分離した反復音を加える効果を指す。',
    sections: [
      {
        heading: 'Reverb との違い',
        body: 'reverb が無数の反射音が密に重なって尾を引くように聞こえるのに対し、delay は一定の時間間隔を空けて、はっきりと聞き取れる単発（または複数回）の反復音を加える。反復の間隔や回数、音量の減衰の度合いを装置で調整することで、単純なやまびこ効果から、リズミカルな反復効果まで幅広い表現が作れる。',
      },
    ],
    confusions: [
      { term: 'Reverb', slug: 'reverb', note: '無数の反射音が密に重なって尾を引く効果。delay ははっきり分離した反復音を加える効果。' },
    ],
  },

  'sustain': {
    lead: 'Sustain（サステイン）は英語で「持続」の意。音が鳴り始めてから消えるまでの、音量が保たれている持続部分、またはそれを長く保つ操作を指す。',
    sections: [
      {
        heading: 'ピアノのサステインペダル',
        body: 'ピアノの弦は、鍵盤を離すとダンパー（弱音装置）が弦に触れて振動を止める仕組みになっている。サステインペダルを踏むと全弦のダンパーが一斉に持ち上がり、鍵盤を離しても弦が振動し続けるだけでなく、弾いていない他の弦もその振動につられて共鳴する（共鳴現象）。この共鳴が加わることで、ペダルを踏んだときの響きは単に音が伸びるだけでなく、音色そのものが豊かになる。',
      },
      {
        heading: 'シンセサイザーのADSR',
        body: 'シンセサイザーの音作りでは、音量の時間変化を Attack（立ち上がり）・Decay（減衰）・Sustain（持続）・Release（減衰の終わり）の4段階で設計する ADSR という考え方が使われる。ここでの sustain は、鍵盤を押し続けている間、音量がどの高さで保たれるかを示す値を指す。',
      },
    ],
  },

  'beatboxing': {
    lead: 'Beatboxing（ビートボクシング）は、口・唇・舌・喉を使い、ドラムやベースなど打楽器的な音を声で模倣する技法。',
    sections: [
      {
        heading: '身体そのものを打楽器にする',
        body: '専用の楽器を使わず、破裂音・摩擦音・鼻から抜く音など、発声器官が作り出せる様々な音を組み合わせて、バスドラムやスネアドラム、シンバルに似た音色を作り出す。複数の音を途切れなく組み合わせることで、ドラムセット全体のリズムパターンを一人の声だけで表現できる。',
      },
      {
        heading: 'ヒップホップ文化との結び付き',
        body: 'ヒップホップの文化的要素の一つとして発展し、アカペラ・グループやソロパフォーマンスの中でリズムを支える手段として広く使われている。',
      },
    ],
  },

  'ossia': {
    lead: 'Ossia はイタリア語で「あるいは、または」を意味する語。楽譜の一部に、本来のパッセージと並べて演奏しやすい代替の弾き方（代奏）を示すときに使われる。',
    sections: [
      {
        heading: '選択肢としてのもう一つの譜面',
        body: '技術的に難しいパッセージの上や下に、小さな五線で ossia として簡易版・代替版が添えられることがある。演奏者はどちらを弾いても構わないという前提のもとに書かれており、作曲家自身が書いた代替であることも、後の校訂者が実用のために加えたものであることもある。',
      },
      {
        heading: 'どちらを弾くかの判断',
        body: 'ossia は難易度を下げた版であることが多いが、単に易しいだけでなく、楽器や奏者の手の大きさの違いに対応するための代替運指として示されることもある。演奏者は、原典版の意図と自身の技術・楽器の条件を踏まえて選ぶ必要がある。',
      },
    ],
  },

  'attaccare': {
    lead: 'Attaccare はイタリア語で「つなぐ、取り掛かる」を意味する動詞の原形。楽譜で使われる Attacca は、この動詞から作られた指示形にあたる。',
    sections: [
      {
        heading: 'Attacca との関係',
        body: '楽譜上でよく見る Attacca は、attaccare の三人称単数・命令的な用法にあたる形で、「（間を置かず）つなげ」という指示として機能する。Attaccare 自体が単独で楽譜に現れる場合も、意味するところは同じで、楽章や場面の間を空けずに続けることを求めている。',
      },
    ],
    confusions: [
      { term: 'Attacca', slug: 'attacca', note: '同じ動詞から作られた、楽譜でより一般的に使われる指示形。' },
    ],
  },

  'a-due': {
    lead: 'A due はイタリア語で「二人で、二つで」の意。1段の譜表に二つの楽器（多くは同じ楽器の1プルト）のパートがまとめて書かれているとき、両方が同じ音を一緒に演奏することを指示する。',
    sections: [
      {
        heading: '1段の譜面を二人で分けない',
        body: 'オーケストラの管楽器などでは、同じ楽器の複数の奏者のパートを1段の譜表にまとめて記譜し、和音になる箇所だけ音符を上下に分けて書くことがある。a due は、そこで分かれずに全員が同じ音を一緒に演奏すべき箇所を示す語で、和音に分かれる指示（divisi や a2/a1 の書き分け）と対になって使われる。',
      },
    ],
    confusions: [
      { term: 'Divisi', slug: 'divisi', note: '同じ譜表のパートを複数の音に分けて演奏する指示。a due はその逆で、全員が同じ音を演奏することを示す。' },
    ],
  },

  'muta-in...': {
    lead: 'Muta in... はイタリア語で「〜に持ち替えよ」の意。動詞 mutare（変える）の命令形に、持ち替える先の調や楽器を続けて記す形で使われる。',
    sections: [
      {
        heading: 'ホルンやティンパニの調律変更',
        body: '19世紀以前のバルブを持たないホルンや、当時のティンパニは、決まった調の音しか自然に出せなかった。曲の途中で違う調の音が必要になると、奏者は管を差し替えたり、皮の張力を変えて調律を変更したりする必要があり、その指示として Muta in D（ニ調に持ち替えよ）のように調名を続けて書かれた。',
      },
      {
        heading: '持ち替えの時間を確保する',
        body: 'この指示が出た箇所の前後には、実際に楽器の設定を変える時間が必要になる。作曲家は休符を十分に取ることでこの作業時間を確保するのが通例で、演奏者はその間に確実に持ち替えを終える必要がある。',
      },
    ],
  },

  'all’-ottava': {
    lead: 'All’ ottava はイタリア語で「オクターブで」の意。1オクターブ高く（まれに低く）演奏することを指示する Ottava（8va）の、別の書き方にあたる。',
    sections: [
      {
        heading: 'Ottava と同じ指示',
        body: '記譜されている音より1オクターブ高い（あるいは低い）音で演奏する、という指示そのものは Ottava（記号 8va）と変わらない。all’ という前置詞を伴った、より説明的な書き方の一つである。',
      },
    ],
    confusions: [
      { term: 'Ottava', slug: 'ottava', note: 'より簡潔な記号 8va で示される、同じ指示のもう一つの書き方。' },
    ],
  },
  ...
  'aumentando': {
    lead: 'Aumentando は「増しながら」。crescendo とほぼ同じ内容ですが、語源が示す動きの質が違います。',
    sections: [
      {
        heading: '「育つ」と「増える」',
        body: 'crescendo はラテン語の crescere（成長する、育つ）に由来し、生物が育つような自然な増大を含みます。aumentando は augere（増す、加える）に由来し、量が加算されていく物理的な増大を指します。英語の augment、auction（せり上げる）も同じ語根です。',
      },
      {
        heading: '使われる頻度',
        body: '楽譜では crescendo とその略記 cresc.、あるいは開いていく三角の記号が圧倒的に多く、aumentando は少数です。作曲者がこの語を選んでいる箇所では、何らかの意図がある可能性がありますが、演奏上の区別として定まった規則はありません。増大の指示として読むのが確実です。',
      },
      {
        heading: '増大の設計',
        body: 'どちらの語であっても、増大の指示で問題になるのは終点の設計です。始めから大きくすると頂点で行き場がなくなります。区間を分けて、どこでどの程度まで到達するかを決めてから弾くのが確実な方法です。',
      },
    ],
    confusions: [
      { term: 'Crescendo', slug: 'crescendo', note: 'だんだん強く。こちらが一般的な表記。' },
      { term: 'Rinforzando', slug: 'rinforzando', note: '数音にわたって強めていく指示。' },
      { term: 'Diminuendo', slug: 'diminuendo', note: 'だんだん弱く。反対方向。' },
    ],
  },

  'dynamics': {
    lead: '強弱法は、音量とその変化の扱い全体を指す語です。個々の記号ではなく、それらが作る設計を指します。',
    sections: [
      {
        heading: '語源は「力」',
        body: 'ギリシャ語の dynamis（力）に由来し、英語の dynamic、dynamo、dynamite も同じ語根です。音量ではなく力を語源とする点が示すとおり、この語が扱っているのは物理的な音の大きさだけではありません。どこに重みを置き、どこを引くかという力の配分です。',
      },
      {
        heading: '記号の体系',
        body: 'pp・p・mp・mf・f・ff という段階を基本とし、さらに ppp、fff と拡張されます。これらは絶対的な音量ではなく、その曲・その楽器・その会場における相対的な位置です。同じ f でも、独奏曲とオーケストラでは実際の音量がまったく違います。変化を示す記号としてクレッシェンド・デクレッシェンドの三角があります。',
      },
      {
        heading: '設計としての強弱',
        body: '個々の記号に反応するだけでは、音量が上下するだけで構造が伝わりません。曲全体でどこが最大でどこが最小かを先に決め、そこへ向かって配分することで、記号が意味を持ちます。とくにクレッシェンドは終点を決めずに始めると頂点で行き場を失います。',
      },
      {
        heading: '歴史的な変化',
  ...
  'leise': {
    lead: 'Leise はドイツ語で「静かに、弱く」。イタリア語の piano に相当しますが、音量だけでなく静けさという質も含む語です。',
    sections: [
      {
        heading: '「静か」と「小さい」',
        body: 'ドイツ語の leise は、音量が小さいことと、物音がなく静かであることの両方を意味します。日常語では「小声で」「そっと」という意味でも使われます。したがってこの指示は、単に音量を下げることではなく、その場を静める方向の質を求めていると読めます。',
      },
      {
        heading: '反対語との対',
        body: 'laut（大きく、うるさく）が反対にあたります。leise / laut の対は、イタリア語の piano / forte とほぼ対応しますが、後者が音量の段階を示す記号体系に組み込まれているのに対して、前者は日常語のままで使われます。段階を示す ppp や fff のような体系はドイツ語の語彙には存在せず、必要な場合はイタリア語の記号が併用されます。',
      },
      {
        heading: '演奏上の扱い',
        body: '静けさは、音量を落とすだけでは作れません。音の立ち上がりが鋭ければ、小さくても落ち着きが失われます。打鍵や弓の当たりを穏やかにし、テンポを安定させることが、この語の求める質に近づく方法です。',
      },
    ],
    confusions: [
      { term: 'Piano', slug: 'piano', note: '対応するイタリア語の音量記号。' },
      { term: 'Abnehmend', slug: 'abnehmend', note: 'だんだん弱く。leise へ向かう過程。' },
      { term: 'Sotto voce', slug: 'sotto-voce', note: '押し殺した声。抑制の質を指す。' },
    ],
  },

  'fort': {
    lead: 'Fort はフランス語で「強く」。イタリア語の forte と同じラテン語 fortis（強い）に由来する同源の語です。',
    sections: [
      {
        heading: 'イタリア語 forte との関係',
        body: 'どちらもラテン語の fortis を語源とし、英語の force、fortify、fort（砦）も同じ語根です。イタリア語の forte が国際的な音量記号として定着したのに対して、fort はフランス語で書かれた楽譜に現れる形です。意味に違いはありません。',
      },
      {
        heading: 'フランス語の強弱語彙',
        body: 'フランス語で指示を書く作曲家の楽譜では、doux（柔らかく）、fort（強く）、léger（軽く）といった語が現れます。ただし音量記号としては f や p といったイタリア語由来の略記が用いられるのが通例で、フランス語の語は性格の指示として添えられることが多くなります。',
      },
      {
        heading: '読むときの注意',
  ...
  'sotto-piano': {
    lead: 'Sotto piano は、piano よりさらに抑えた弱音を指す語です。sotto は「下に」を意味し、piano の下という位置づけを表しています。',
    sections: [
      {
        heading: 'sotto という語',
        body: 'イタリア語の sotto は「下に、〜の下で」を意味します。sotto voce（声の下で＝押し殺した声で）が同じ構造の語です。ラテン語の subtus に由来し、英語の接頭辞 sub- と同じ語根を持ちます。したがって sotto piano は「piano の下」、すなわち piano より抑えた状態を指します。',
      },
      {
        heading: 'pianissimo との違い',
        body: 'pianissimo は piano の最上級で、音量の段階として体系に組み込まれた記号です。sotto piano は段階を示す記号ではなく、位置関係を述べた表現です。したがって pp と同じ量を指すとは限らず、その箇所の文脈で判断することになります。楽譜での使用頻度は pp のほうが圧倒的に高く、この語は限られた場面で現れます。',
      },
      {
        heading: '弱音の作り方',
  ...
  'diluendo': {
    lead: 'Diluendo は「薄めながら」。音が薄れて溶けていくように減衰させる指示です。',
    sections: [
      {
        heading: '「薄める」という語源',
        body: 'イタリア語の diluire（薄める、希釈する）の現在分詞です。ラテン語の diluere（洗い流す、薄める）に由来し、英語の dilute（希釈する）と同じ語根です。示しているのは音量の減少というより、濃度が下がって溶けていく状態です。',
      },
      {
        heading: '他の減衰の語との違い',
        body: '減衰を示す語は多数あり、それぞれ含みが違います。diminuendo は「小さくする」という量の操作、morendo は「死んでいく」という消滅、smorzando は「消す、鎮める」、perdendosi は「見失う」です。diluendo は「薄まる」で、輪郭が保たれたまま濃度だけが下がるという方向にあります。',
      },
      {
        heading: '演奏上の扱い',
  ...
  'estinto': {
    lead: 'Estinto は「絶え入るように」。原義は「消された、絶滅した」で、減衰の指示の中で最も極端な部類にあたります。',
    sections: [
      {
        heading: '過去分詞であること',
        body: 'イタリア語の estinguere（消す、絶やす）の過去分詞です。英語の extinct（絶滅した）、extinguish（消す）と同じ語根です。過去分詞であるという点が重要で、これは「消えていく過程」ではなく「消えてしまった状態」を指します。morendo（死んでいく）が現在分詞で過程を示すのに対して、estinto は結果を示します。',
      },
      {
        heading: '求められる状態',
        body: '消えてしまった状態を指すため、この語が付いた箇所は、聞こえるかどうかの境目に置かれます。音があるのかないのか判別できない、というところまで持っていくことが求められます。al niente（無になるまで）と近い領域ですが、後者が到達点を明示するのに対して、estinto は状態そのものを述べています。',
      },
      {
        heading: '演奏上の扱い',
  ...
  'expansion': {
    lead: '拡張は、素材や構造を引き伸ばして規模を広げることを指します。音量の増大ではなく、時間や空間の広がりを指す語です。',
    sections: [
      {
        heading: '楽曲構造における拡張',
        body: '4小節で完結するはずのフレーズが6小節や8小節に引き伸ばされる、終止に達する直前で解決が遅らされる、といった操作が拡張にあたります。予想される長さより長くなることで、聴き手の期待が引き延ばされ、到達したときの効果が強まります。古典派の楽曲でも、終結部が繰り返し引き伸ばされる書法が見られます。',
      },
      {
        heading: '音響的な広がりとして',
        body: '別の用法として、響きの空間的な広がりを指す場合があります。音域を上下に広げる、声部を増やす、開離配置にするといった手段で、同じ和音でも空間が広がって聞こえます。この意味では、音量を上げることとは別の操作です。',
      },
      {
        heading: '演奏上の扱い',
        body: '拡張された箇所は、本来の長さより長くなっているところです。したがって、そこを均等に進めると冗長に感じられます。引き伸ばされている理由（到達を遅らせている、期待を高めている）を踏まえ、緊張を保ったまま進めることが求められます。',
      },
    ],
    confusions: [
      { term: 'Development', slug: 'development', note: '展開部。素材を変形して進める部分。' },
      { term: 'Coda', slug: 'coda', note: '結尾部。拡張が行われる典型的な場所。' },
      { term: 'Voicing', slug: 'voicing', note: '和音の配置。音響的な広がりに関わる。' },
    ],
  },

  'abnehmend': {
    lead: 'Abnehmend はドイツ語で「だんだん弱く」。イタリア語の diminuendo に相当します。',
    sections: [
      {
        heading: '語の成り立ち',
        body: '動詞 abnehmen（減る、取り去る）の現在分詞です。ab-（離れて、去って）と nehmen（取る）から成り、原義は「取り去られていく」です。現在分詞であるため、減っていく過程が進行中であることを示します。イタリア語の diminuendo も現在分詞であり、両者は文法的な形も対応しています。',
      },
      {
        heading: 'ドイツ語の強弱語彙',
        body: 'ドイツ語圏の作曲家が自国語で指示を書く場合、laut（大きく）、leise（静かに）、stark（強く）、schwach（弱く）といった語が使われます。変化を示す語としては、zunehmend（増していく）が abnehmend の反対にあたります。イタリア語の定型を使う作曲家と、自国語で書く作曲家が混在しているため、楽譜によって語彙が変わります。',
      },
      {
        heading: '演奏上の扱い',
        body: '減少の指示では、どこまで落とすかを先に決めることが要点です。早く落としすぎると終点の手前で音が失われ、遅すぎると指示が実行されないまま区間が終わります。区間を分けて到達点を設計するのは、増大の場合と同じです。',
      },
    ],
    confusions: [
      { term: 'Diminuendo', slug: 'diminuendo', note: '対応するイタリア語。' },
      { term: 'Decrescendo', slug: 'decrescendo', note: 'だんだん弱く。同じ内容のイタリア語。' },
      { term: 'Leise', slug: 'leise', note: 'ドイツ語で静かに。到達点を示す語。' },
    ],
  },
  'allemande': {
  ...
  'compound-meter': {
    lead: 'Compound meter（複合拍子）は、1拍がさらに3等分される拍子を指す。8分の6拍子、8分の9拍子、8分の12拍子などが代表例である。',
    sections: [
      {
        heading: '拍子記号の上の数字は「拍の数」ではない',
        body: '複合拍子でもっとも誤解されやすいのは、拍子記号の分子が拍の数を示していない点である。8分の6拍子は「6拍子」ではなく、実際には2拍子で、1拍がそれぞれ3つの8分音符に分かれている。8分の9拍子は3拍子、8分の12拍子は4拍子として感じるのが基本であり、分子を3で割った数が実際の拍の数になる。',
      },
      {
        heading: '単純拍子との対応',
        body: '複合拍子は、対応する単純拍子の1拍を、付点音符に置き換えて3等分したものと考えられる。単純拍子の4分の2拍子（1拍＝4分音符が2つ）に対して、複合拍子の8分の6拍子は1拍＝付点4分音符が2つという対応関係にある。両者は拍の数は同じでも、1拍の内部の割れ方が2等分か3等分かで違う。',
      },
    ],
    confusions: [
      { term: 'Simple meter', slug: 'simple-meter', note: '1拍が2等分される拍子。複合拍子（1拍が3等分）と対になる概念。' },
      { term: 'Irregular meter', slug: 'irregular-meter', note: '単純拍子・複合拍子のどちらにも整然と当てはまらない拍子。2と3の組み合わせで説明されることが多い。' },
    ],
  },

  'irregular-meter': {
    lead: 'Irregular meter（不規則拍子）は、単純拍子・複合拍子のようにすべての拍が均等な単位で割れない拍子の総称で、変拍子とも呼ばれる。4分の5拍子、8分の7拍子などが代表例である。',
    sections: [
      {
        heading: '「2＋3」のような組み合わせで捉える',
        body: '4分の5拍子は、それ自体が1つの均等な単位ではなく、2拍＋3拍、あるいは3拍＋2拍という不均等なグループの組み合わせとして感じられることが多い。8分の7拍子であれば3＋2＋2や2＋2＋3のように分割される。演奏者はこの内部のグループ分けを把握しないと、拍の重心がどこにあるか掴みにくい。',
      },
      {
        heading: '20世紀以降に広く使われるようになった',
        body: '不規則拍子は民俗舞曲の一部にも古くから見られるが、西洋の芸術音楽で広く使われるようになったのは20世紀以降である。ストラヴィンスキーの『春の祭典』は、拍子が小節ごとに頻繁に変化する書法で知られ、不規則拍子を大規模な作品の中心的な語法として用いた代表例とされる。',
      },
    ],
    confusions: [
      { term: 'Compound meter', slug: 'compound-meter', note: '1拍が3等分される拍子。不規則拍子とは異なり、すべての拍が均等な単位で割れる。' },
    ],
  },

  'kyrie': {
    lead: 'Kyrie（キリエ）は、カトリックのミサ曲の中で最初に置かれる部分で、ギリシャ語 Kyrie eleison（主よ、憐れみたまえ）に由来する。',
    sections: [
      {
        heading: 'ラテン語のミサの中で唯一のギリシャ語',
        body: 'ミサの通常文（毎回のミサで共通して歌われる部分）は基本的にラテン語で書かれているが、Kyrie はギリシャ語のまま残された唯一の部分である。これは初期キリスト教の礼拝で使われていたギリシャ語の祈りの言葉が、ラテン語化の進んだ後もそのままの形で受け継がれたことによる。',
      },
      {
        heading: '3行×3回という構造',
        body: 'テキストは「Kyrie eleison（主よ、憐れみたまえ）」「Christe eleison（キリストよ、憐れみたまえ）」「Kyrie eleison」という3つの句からなり、それぞれ3回ずつ、合計9回繰り返されるのが伝統的な形である。作曲家はこの短く反復的なテキストに、ミサ曲全体の性格を決める最初の音楽を付けることになる。',
      },
    ],
    confusions: [
      { term: 'Mass', slug: 'mass', note: 'キリエを含む、ミサ曲全体の呼び名。キリエはそのうち最初に置かれる1部分にすぎない。' },
    ],
  },

  'gloria': {
    lead: 'Gloria（グローリア）は、カトリックのミサ曲でキリエに続く部分で、ラテン語のテキストは「Gloria in excelsis Deo（いと高きところには神に栄光）」で始まる。',
    sections: [
      {
        heading: '天使の言葉から始まる長いテキスト',
        body: '冒頭の一節は、新約聖書ルカ福音書に記された、キリスト降誕の場面で天使が歌う言葉に由来する。そこから神への賛美と感謝の言葉が続き、ミサの通常文の中でも比較的長いテキストを持つ部分になる。テキストが長いため、作曲家はしばしば内部をいくつかの楽章や場面に分けて作曲する。',
      },
      {
        heading: '荘厳な性格を持つことが多い',
        body: '内容が神への賛美であることから、Gloria はミサ曲の中でも壮麗で華やかな音楽が付けられることが多い。合唱や独唱、オーケストラを大きく用いて、キリエの静かな祈りとは対照的な性格を作ることも少なくない。',
      },
    ],
    confusions: [
      { term: 'Kyrie', slug: 'kyrie', note: 'グローリアの直前に置かれる部分。祈りと嘆願の性格を持ち、賛美が中心のグローリアとは対照的である。' },
    ],
  },

  'sanctus': {
    lead: 'Sanctus（サンクトゥス）は、カトリックのミサ曲でグローリア・クレドに続く部分で、テキストは「Sanctus, Sanctus, Sanctus（聖なるかな、聖なるかな、聖なるかな）」という3度の反復で始まる。',
    sections: [
      {
        heading: '旧約聖書に由来する言葉',
        body: '冒頭の「聖なるかな」の3度の反復は、旧約聖書イザヤ書に記された、天使が神を讃える言葉に由来する。後半には「Benedictus qui venit（来られる者は祝福される）」という一節が続くが、この部分は独立して Benedictus として別に扱われることも多い。',
      },
      {
        heading: 'しばしば分割して作曲される',
        body: 'Sanctus と Benedictus は、ミサ全体の式次第の中で歌われる位置がわずかに異なることもあり、多くの作曲家がこの2つを別々の楽章として作曲する。同じ Sanctus のテキストの中でも「Sanctus」の部分と「Benedictus」の部分では、性格の異なる音楽が付けられることが多い。',
      },
    ],
    confusions: [
      { term: 'Benedictus', slug: 'benedictus', note: 'サンクトゥスの後半部分。多くの作曲家がここを独立した楽章として扱う。' },
    ],
  },

  'benedictus': {
    lead: 'Benedictus（ベネディクトゥス）は、ミサ曲の Sanctus に続くテキスト「Benedictus qui venit in nomine Domini（主の名によって来られる者は祝福される）」を指す。',
    sections: [
      {
        heading: 'Sanctus の後半として、独立して扱われることも',
        body: '本来 Sanctus と一続きのテキストだが、内容と性格がやや異なるため、多くのミサ曲でこの部分だけ独立した楽章として作曲される。Sanctus の力強い賛美に対して、Benedictus はより静かで内省的な音楽が付けられることが多い。',
      },
    ],
    confusions: [
      { term: 'Sanctus', slug: 'sanctus', note: 'ベネディクトゥスの直前に置かれる部分。同じテキストの前半にあたる。' },
    ],
  },

  'agnus-dei': {
    lead: 'Agnus Dei（アニュス・デイ）は、ミサ曲の最後に置かれる部分で、テキストは「Agnus Dei, qui tollis peccata mundi（世の罪を除きたもう神の子羊）」で始まる。',
    sections: [
      {
        heading: '「神の子羊」というたとえ',
        body: '「神の子羊」という表現は、新約聖書でキリストを犠牲の子羊にたとえた言い方に由来する。テキストは「憐れみたまえ（miserere nobis）」を2回、最後に「平安を与えたまえ（dona nobis pacem）」という祈りで結ばれる3つの句からなる。',
      },
      {
        heading: 'ミサの終わりを静かに収める',
        body: 'キリエの祈りが再び形を変えて現れるような構成を持ち、ミサ曲全体を締めくくる部分として、静かに、あるいは深い祈りを込めて作曲されることが多い。最後の「平安を与えたまえ」の一句に、それまでの音楽的な緊張を解く役割を持たせる作曲家も少なくない。',
      },
    ],
    confusions: [
      { term: 'Kyrie', slug: 'kyrie', note: 'ミサの最初に置かれる祈り。憐れみを求める言葉が、アニュス・デイの終わりに再び形を変えて現れる。' },
    ],
  },

  'requiem': {
    lead: 'Requiem（レクイエム）は、死者のためのミサ曲を指す言葉で、ラテン語のミサ曲テキストの冒頭「Requiem aeternam dona eis（永遠の安息を彼らに与えたまえ）」の最初の語に由来する。',
    sections: [
      {
        heading: '通常のミサとテキストが一部異なる',
        body: 'レクイエムは通常のミサの構成（キリエ、グローリア、サンクトゥスなど）をおおむね踏襲するが、死者のためという性格上、グローリアやクレドを省く、あるいは死と審判を描いた Dies irae（怒りの日）などの独自のテキストを加えることが多い。どの部分を含めるかは作曲家や時代によって異同がある。',
      },
      {
        heading: '演奏会用に書かれた作品も多い',
        body: 'レクイエムは本来教会の儀式のための音楽だが、19世紀以降は実際の葬儀を離れ、演奏会作品として書かれる例も増えていった。同じ「レクイエム」という名前でも、典礼をそのまま音楽化したものから、独自の構成やテキストを持つ作品まで幅がある。',
      },
    ],
    confusions: [
      { term: 'Kyrie', slug: 'kyrie', note: '通常のミサ曲の最初の部分。レクイエムもこの部分を含むのが一般的である。' },
      { term: 'Mass', slug: 'mass', note: 'ミサ曲全般を指す語。レクイエムはそのうち死者のためのミサという特定の種類を指す。' },
    ],
  },
